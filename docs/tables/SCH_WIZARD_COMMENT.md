...
| 9 | `SUB_TEXT_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the scheduling sub text type. The sub text types allow for multiple set of text within a text type (prep, post, guidelines, etc.) |
| 10 | `SUB_TEXT_MEANING` | VARCHAR(12) |  |  | The 12-character string corresponding to the scheduling text sub-type. |
| 11 | `TEXT_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier used to store the actual test on the LONG_TEXT table. |
| 12 | `TEXT_TYPE_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the scheduling text type. |
| 13 | `TEXT_TYPE_MEANING` | VARCHAR(12) |  |  | The 12-character string corresponding to the scheduling text type. |
...
| 20 | `WIZ_OPTION_CD` | DOUBLE | NOT NULL | FK→ | The unique identifier for the wizard option. |
| 21 | `WIZ_OPTION_MEANING` | VARCHAR(12) |  |  | The 12-character description corresponding to the wizard option. |
