...
**Description:** MLLD_NDC_ACT_INGRED_LIST  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTIVE_INGREDIENT_CODE` | DOUBLE | NOT NULL |  | This field contains the code from the active ingredient table (Foreign Key) |
