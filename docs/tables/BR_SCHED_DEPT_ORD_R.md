...
> Stores relationship between departments and the order types they can be scheduled for
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTIVITY_SUBTYPE_CD` | DOUBLE | NOT NULL |  | Activity subtype of the orders the department can be scheduled for |
| 2 | `ACTIVITY_TYPE_CD` | DOUBLE | NOT NULL |  | Activity type of the orders the department can be scheduled for |
| 3 | `BR_CLIENT_ID` | DOUBLE | NOT NULL |  | Identifies which bedrock client data belongs to |
| 4 | `CATALOG_TYPE_CD` | DOUBLE | NOT NULL |  | Catalog type of the orders the department can be scheduled for |
| 5 | `LOCATION_CD` | DOUBLE | NOT NULL |  | Code value of the department |
| 6 | `START_VERSION_NBR` | DOUBLE |  |  | Identifies which version of start has been loaded |
