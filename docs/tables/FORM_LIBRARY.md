...
> Stores information for each form library

**Description:** Form Library  
**Table type:** REFERENCE  
**Primary key:** `FORM_LIBRARY_ID`  
**Columns:** 8  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `FORM_LIBRARY_ID` | DOUBLE | NOT NULL | PK | PRIMARY KEY |
| 2 | `FORM_LIBRARY_NAME` | VARCHAR(200) |  |  | The name of the form library |
| 3 | `FORM_NAME` | VARCHAR(200) |  |  | The name of the form |
...
| From table | Column |
|------------|--------|
| [FORM_LIBRARY_MAPPING](FORM_LIBRARY_MAPPING.md) | `FORM_LIBRARY_ID` |
