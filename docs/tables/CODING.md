...
> Stores some of the coded information captured from a coding system. Examples of coded information include length of stay, birthweight and ascpay.
...
| 11 | `CODING_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the coding table. It is an internal system assigned number. |
| 12 | `CODING_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Personnel who last coded the episode. |
| 13 | `COMPLETED_DT_TM` | DATETIME |  |  | This is the date and time that the coding record was saved as completed. |
...
| 22 | `MERGED_ENCNTR_ID` | DOUBLE | NOT NULL |  | The encounter ID for the encounter that has been merged with this one. (If it is a merged account). |
