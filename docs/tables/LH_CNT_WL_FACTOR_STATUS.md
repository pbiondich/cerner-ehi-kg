...
> This table is used to store the status of a single factor (a row in lh_cnt_wl_factor)
...
| 5 | `LH_CNT_WL_FACTOR_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to LH_CNT_WL_FACTOR |
| 6 | `LH_CNT_WL_FACTOR_STATUS_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
