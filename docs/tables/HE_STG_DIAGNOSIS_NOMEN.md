...
> Stages Nomenclature Ids within the ruleset to be utilized by the Health Expert Diagnosis Priming job.

**Description:** Health Expert Staging Diagnosis Nomenclature  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `KNOWLEDGEBASE_NAME` | VARCHAR(100) | NOT NULL |  | The name of the knowledge base that the staged data is for. Multiple knowledge bases may run simultaneous processes to stage data. |
| 2 | `PRIMARY_IDENT` | DOUBLE | NOT NULL |  | The primary identifier used to filter diagnosis results within the Health Expert Diagnosis Priming job, e.g. Nomenclature_Id or Originating_Nomenclature_Id. |
