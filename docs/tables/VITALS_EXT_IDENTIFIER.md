...
> This staging table holds the universally unique identifer of a vital result and whether it was written to the staging table or to the clinical event table. ;
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EVENT_ID` | DOUBLE | NOT NULL |  | The EVENT id of the clinical event associated with this data if the data was written to clinical event. |
| 2 | `SYSTEM_URI` | VARCHAR(80) |  |  | The URI of the coding system. |
...
| 8 | `VALUE_STR` | VARCHAR(200) |  |  | The codified value. |
| 9 | `VITALS_EXT_DATA_ID` | DOUBLE | NOT NULL | FK→ | The primary key of the vitals external data staging table if the data was staged. |
| 10 | `VITALS_EXT_IDENTIFIER_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `VITALS_EXT_DATA_ID` | [VITALS_EXT_DATA](VITALS_EXT_DATA.md) | `VITALS_EXT_DATA_ID` |
