...
> This is the HealthFacts dimension table that contains standard values for gender
...
| 3 | `GENDER_DESC` | VARCHAR(60) |  |  | The description for the gender |
| 4 | `GENDER_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines a gender |
| 5 | `HF_IND` | DOUBLE |  |  | Indicates if the record was generated via the Health Facts solution. |
