...
> Stores default bedrock scheduling department types.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DEPT_TYPE_DISPLAY` | VARCHAR(40) |  |  | Display of department type |
| 2 | `DEPT_TYPE_ID` | DOUBLE | NOT NULL |  | Department type identification |
| 3 | `DEPT_TYPE_PREFIX` | VARCHAR(4) |  |  | Default prefix for department type |
