...
> Contains the children of an appointment book.
...
| 5 | `APPT_BOOK_ID` | DOUBLE | NOT NULL | FK→ | The identifier for the appointment book. |
...
| 8 | `CHILD_APPT_BOOK_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for the child appointment book. |
...
|--------|--------------|---------------|
| `APPT_BOOK_ID` | [SCH_APPT_BOOK](SCH_APPT_BOOK.md) | `APPT_BOOK_ID` |
| `CHILD_APPT_BOOK_ID` | [SCH_APPT_BOOK](SCH_APPT_BOOK.md) | `APPT_BOOK_ID` |
