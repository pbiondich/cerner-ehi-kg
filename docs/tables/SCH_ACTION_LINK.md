...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTION_MEANING` | VARCHAR(12) | NOT NULL |  | A 12-char description corresponding to the Scheduling ActionCode. |
...
| 10 | `PARENT2_ID` | DOUBLE | NOT NULL |  | Parent2 Identifier |
| 11 | `PARENT2_TABLE` | VARCHAR(32) | NOT NULL |  | Parent2 Table |
| 12 | `PARENT_ID` | DOUBLE | NOT NULL |  | Parent Identifier |
| 13 | `PARENT_TABLE` | VARCHAR(32) | NOT NULL |  | Parent Table |
| 14 | `SCH_ACTION_CD` | DOUBLE | NOT NULL | FK→ | A unique identifier for the Scheduling Action Code |
