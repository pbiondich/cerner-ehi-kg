# PROV_ALLERGY_PARTICIPANT

> Stores Participant information associated to the provenance ALLERGY concept

**Description:** Provenance ALLERGY Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_ALLERGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Allergy table. |
| 9 | `PROV_ALLERGY_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
