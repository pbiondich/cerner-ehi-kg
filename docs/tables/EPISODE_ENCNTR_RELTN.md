...
> The episode-encounter relation table contains pointers to encounters in the encounter table that are related to the episode.
...
| 7 | `CREATE_DT_TM` | DATETIME |  |  | Date and time the relationship between the episode and the encounter was created. |
| 8 | `CREATE_PRSNL_ID` | DOUBLE |  |  | The id of the person who created the request. |
...
| 11 | `EPISODE_ENCNTR_RELTN_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the episode encounter relationship table. It is an internal system assigned number. |
| 12 | `EPISODE_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the episode table. It is an internal system assigned number. |
