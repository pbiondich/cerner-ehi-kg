...
> Stores scheduling departments with its prefix and department type.
...
| 2 | `DEPT_PREFIX` | VARCHAR(4) |  |  | 4 character prefix for department |
| 3 | `DEPT_TYPE_ID` | DOUBLE | NOT NULL |  | ID of associated department type from br_sched_dept_type table |
| 4 | `LOCATION_CD` | DOUBLE | NOT NULL |  | Code value of the department |
| 5 | `START_VERSION_NBR` | DOUBLE |  |  | Identifies which version of start has been loaded |
