...
> Relation table with corsp_log and bill_rec
...
| 5 | `ACTIVITY_ID` | DOUBLE | NOT NULL | FK→ | Foreign key reference to the corsp_log table. |
...
| 7 | `BILL_REC_ID` | DOUBLE | NOT NULL | FK→ | Part of foreign key reference to the bill_rec table |
| 8 | `BILL_VRSN_NBR` | DOUBLE | NOT NULL | FK→ | Part of foreign key reference to the bill_rec table |
| 9 | `CORSP_BR_RELTN_ID` | DOUBLE | NOT NULL |  | Primary Key |
...
| `BILL_REC_ID` | [BILL_REC](BILL_REC.md) | `CORSP_ACTIVITY_ID` |
