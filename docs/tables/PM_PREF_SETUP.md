...
| 5 | `APPLICATION_NUMBER` | DOUBLE | NOT NULL |  | Application Number. |
...
| 11 | `LOCKED_IND` | DOUBLE | NOT NULL |  | Determines if preferences is locked. |
| 12 | `PERSON_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Personnel ID for person whom preferences are tied to. |
| 13 | `PM_PREF_SETUP_ID` | DOUBLE | NOT NULL | PK | Primary key for the pm_pref_setup table. |
| 14 | `POSITION_CD` | DOUBLE | NOT NULL |  | Position Code. |
| 15 | `TASK_NUMBER` | DOUBLE | NOT NULL |  | Task Number. |
...
|--------|--------------|---------------|
| `PERSON_PRSNL_ID` | [PRSNL](PRSNL.md) | `PERSON_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PM_PREF](PM_PREF.md) | `PM_PREF_SETUP_ID` |
