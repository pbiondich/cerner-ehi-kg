...
> Stores information about entities associated to the provenance IMMUNIZATION concept

**Description:** Provenance IMMUNIZATION Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_IMMUN_ENTITY_ID`  
**Columns:** 12  
...
| 5 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Entity table name - e.g. SI_DOCUMENT_METADATA CLINICAL_EVENT |
| 6 | `PROVENANCE_IMMUNIZATION_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Immunization table. |
| 7 | `PROV_IMMUN_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_IMMUNIZATION_ID` | [PROVENANCE_IMMUNIZATION](PROVENANCE_IMMUNIZATION.md) | `PROVENANCE_IMMUNIZATION_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_IMMUN_ENTY_PRTCPNT](PROV_IMMUN_ENTY_PRTCPNT.md) | `PROV_IMMUN_ENTITY_ID` |
