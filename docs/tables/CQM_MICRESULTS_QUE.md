...
> This CQM queue table is the primary storage locations of the transaction message for the MDI Results application. This table contains the administrative and routing data used for controlling the transaction.
...
| 7 | `CREATE_RETURN_FLAG` | DOUBLE |  |  | create return flag |
...
| 15 | `QUEUE_ID` | DOUBLE | NOT NULL | PK | his is the value of the unique primary identifier of the CQM queue table. It is an internal system assigned number. |
...
| From table | Column |
|------------|--------|
| [CQM_MICRESULTS_LOG](CQM_MICRESULTS_LOG.md) | `QUEUE_ID` |
| [CQM_MICRESULTS_PAR](CQM_MICRESULTS_PAR.md) | `QUEUE_ID` |
| [CQM_MICRESULTS_TR_1](CQM_MICRESULTS_TR_1.md) | `QUEUE_ID` |
