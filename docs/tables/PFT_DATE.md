...
| 6 | `DATE_TYPE_CD` | DOUBLE | NOT NULL |  | Type of Date stored |
| 7 | `DATE_VALUE_DT_TM` | DATETIME |  |  | Date Value being stored |
...
| 10 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | The Parent entity of the date being stored |
| 11 | `PARENT_ENTITY_NAME` | VARCHAR(32) |  |  | Name of the parent entity for the stored date |
| 12 | `PFT_DATE_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 13 | `PFT_EVENT_ID` | DOUBLE |  | FK→ | Uniquely identifies the related row on the PFT_EVENT table. |
