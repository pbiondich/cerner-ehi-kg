...
> Stores patient consent for physicians to access their external medication list.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCESS_TYPE_CD` | DOUBLE |  |  | The Sweden NLL access reason/level code.; |
| 2 | `ACTIVE_IND` | DOUBLE |  |  | The table row is active or inactive. A row is generally active unless it is in an inactive state such as logically deleted, combined away, pending purge, etc. |
| 3 | `ENCNTR_ID` | DOUBLE |  | FK→ | The identifier for the encounter the access request is related to.; |
| 4 | `ERX_EXT_MED_LIST_ACCESS_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 10 | `USER_ID` | DOUBLE |  | FK→ | The physician / clinician / User who is being granted or revoked access. |
