...
> This table contains invoice default values for HIM ROI Requesters and Requester Source.
...
| 6 | `CHARGES` | DOUBLE | NOT NULL |  | This is the charges value |
...
| 13 | `REQUESTER_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the requester table. It is an internal system assigned number. |
| 14 | `REQUESTER_SOURCE_CD` | DOUBLE | NOT NULL |  | This is the type of requester(i.e. attorneys, insurance company) |
| 15 | `ROI_INV_CHG_DEFS_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the ROI_Invoice_Charge_Defaults table. It is an internal system assigned number. |
| 16 | `START_NUMBER` | DOUBLE |  |  | The starting range for the charge tier. |
