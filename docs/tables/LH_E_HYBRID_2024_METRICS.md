# LH_E_HYBRID_2024_METRICS

> Stores data gathered by the LH_E_HYBRID_2024 script.

**Description:** Lighthouse eMeasures HWR and HWM 2024 Metrics  
**Table type:** ACTIVITY  
...
| 49 | `LH_E_HYBRID_2024_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_HYBRID_2024_METRICS table. |
...
| 53 | `O2_SAT_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first O2 saturation in arterial blood by pulse oximetry recorded for the episode of care. |
| 54 | `O2_SAT_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first O2 saturation in arterial blood by pulse oximetry recorded for the episode of care. |
| 55 | `OBS_SERV_ARRIVAL_DT_TM` | DATETIME |  |  | The start of the observation encounter. |
| 56 | `OBS_SERV_DEPART_DT_TM` | DATETIME |  |  | The end of the observation encounter. |
| 57 | `OBS_SERV_ENCNTR_ID` | DOUBLE | NOT NULL |  | The ID of the observation services encounter associated to the record. |
| 58 | `ORG_MRN_TXT` | VARCHAR(50) |  |  | Medical Record Number of the record. |
...
| 66 | `PLATELET_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first platelet count recorded for the episode of care. |
| 67 | `PLATELET_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first platelet count recorded for the episode of care. |
| 68 | `POTAS_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first potassium lab test for the episode of care. |
| 69 | `POTAS_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first potassium lab test for the episode of care. |
| 70 | `RESP_RATE_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first respiratory rate recorded for the episode of care. |
| 71 | `RESP_RATE_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first respiratory rate recorded for the episode of care. |
| 72 | `SBP_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first systolic blood pressure recorded for the episode of care. |
| 73 | `SBP_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first systolic blood pressure recorded for the episode of care. |
| 74 | `SCRIPT_VERSION` | DOUBLE |  |  | The version number of the script that populated the row |
| 75 | `SOD_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first sodium lab test for the episode of care. |
| 76 | `SOD_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first sodium lab test for the episode of care. |
| 77 | `SRC_UPDT_DT_TM` | DATETIME |  |  | The date and time the row was last inserted or updated to be preserved during extracts. |
| 78 | `SRC_UPDT_SOURCE` | VARCHAR(50) |  |  | The script name responsible for updating the record to be preserved during extracts. |
| 79 | `TIMEZONE_TXT` | VARCHAR(300) |  |  | The timezone of the record in ""America/Chicago"" format. |
...
| 84 | `WBC_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first white blood cells count lab test for the episode of care. |
| 85 | `WBC_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first white blood cells count lab test for the episode of care. |
