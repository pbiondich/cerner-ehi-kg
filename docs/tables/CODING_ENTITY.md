...
> The entity details of the coding. Used to relate tables to the CODING_LOCK table

**Description:** Coding Entity  
**Table type:** ACTIVITY  
**Primary key:** `CODING_ENTITY_ID`  
**Columns:** 7  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CODING_ENTITY_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the CODING_ENTITY table. |
| 2 | `ENCNTR_ID` | DOUBLE |  | FK→ | Foreign key to the ENCOUNTER table. |
...
| From table | Column |
|------------|--------|
| [CODING](CODING.md) | `CODING_ENTITY_ID` |
| [CODING_HIST](CODING_HIST.md) | `CODING_ENTITY_ID` |
| [CODING_LOCK](CODING_LOCK.md) | `CODING_ENTITY_ID` |
| [CODING_SPECIALTY](CODING_SPECIALTY.md) | `CODING_ENTITY_ID` |
