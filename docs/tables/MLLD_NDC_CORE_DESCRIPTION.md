...
**Description:** MLLD_NDC_CORE_DESCRIPTION  
...
| 4 | `GLOBAL_TYPE_ID` | DOUBLE | NOT NULL | FK→ | Identifies the type of Global Identifier stored in Global Secondary Id |
