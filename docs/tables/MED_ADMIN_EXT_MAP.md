...
> This table is the external mapping of medication record identifiers.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EXT_MAP_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | EXTERNAL MAPPING PRSNL ID |
| 2 | `INTERNAL_IDENT` | DOUBLE | NOT NULL |  | Unique generated number that identifies the parent entity within medication administration records. |
| 3 | `MED_ADMIN_EXT_MAP_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `EXT_MAP_PRSNL_ID` | [PRSNL](PRSNL.md) | `PERSON_ID` |
