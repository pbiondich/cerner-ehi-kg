...
> Multum Dose Range Checking Grouper Relationships
...
| 3 | `MAIN_MULTUM_DRUG_CODE` | DOUBLE | NOT NULL | FK→ | Multum's designator for groups of similar drug products. |
| 4 | `SYNONYM_ID` | DOUBLE | NOT NULL | FK→ | Multum's identifier for a unique drug name. |
...
| `SYNONYM_ID` | [MLTM_DRUG_NAME](MLTM_DRUG_NAME.md) | `DRUG_SYNONYM_ID` |
