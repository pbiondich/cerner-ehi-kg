...
> HF_D_EVENT_RELTN table

**Description:** HF_D_EVENT_RELTN  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EVENT_RELTN_DESC` | VARCHAR(60) |  |  | The description for the event relation |
| 2 | `EVENT_RELTN_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines an event relation |
