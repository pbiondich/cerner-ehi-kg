# LH_E_OPRAD_2025_DETAILS

> Stores details for data gathered by the LH_E_OPRAD_2025 script.

**Description:** Lighthouse eMeasures Outpatient Excessive Radiation 2025 Metrics Details  
**Table type:** ACTIVITY  
...
| 13 | `LH_E_OPRAD_2025_DETAILS_ID` | DOUBLE | NOT NULL |  | Stores details for data gathered by the LH_E_OPRAD_2025 script. |
| 14 | `LH_E_OPRAD_2025_METRICS_ID` | DOUBLE |  | FK→ | Unique generated number that identifies a single row on the LH_E_OPRAD_2025_METRICS table |
...
|--------|--------------|---------------|
| `HEALTH_SYSTEM_SOURCE_ID` | [LH_E_OPRAD_2025_METRICS](LH_E_OPRAD_2025_METRICS.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| `LH_E_OPRAD_2025_METRICS_ID` | [LH_E_OPRAD_2025_METRICS](LH_E_OPRAD_2025_METRICS.md) | `LH_E_OPRAD_2025_METRICS_ID` |
