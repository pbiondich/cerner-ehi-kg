...
> Used to define a group of pathways.

**Description:** Care Planning Pathway Group  
**Table type:** REFERENCE  
**Primary key:** `CP_PATHWAY_GROUP_ID`  
**Columns:** 9  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CP_PATHWAY_GROUP_ID` | DOUBLE | NOT NULL | PK | Unique, generated number that identifies a single row on the CP_PATHWAY_GROUP table. |
...
| 3 | `PATHWAY_GROUP_NAME` | VARCHAR(100) | NOT NULL |  | The name of the pathway group as entered by the client. |
| 4 | `PATHWAY_TYPE_CD` | DOUBLE | NOT NULL |  | The type of pathway being stored. |
...
| From table | Column |
|------------|--------|
| [CP_PATHWAY_GROUP_R](CP_PATHWAY_GROUP_R.md) | `CP_PATHWAY_GROUP_ID` |
