...
> The RC_PARAMETER_SET table stores information about parameter sets.

**Description:** Revenue Cycle Parameter Set  
**Table type:** REFERENCE  
**Primary key:** `RC_PARAMETER_SET_ID`  
**Columns:** 17  
...
| 7 | `CREATE_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Contains the id of the person who created the row. |
...
| 10 | `PARM_SET_NAME` | VARCHAR(100) | NOT NULL |  | Contains the name of the parameter set. |
| 11 | `PARM_SET_TYPE_CD` | DOUBLE | NOT NULL |  | Codified Parameter Set Type |
| 12 | `RC_PARAMETER_SET_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the RC_PARAMETER_SET table. |
...
| From table | Column |
|------------|--------|
| [PM_AUTO_DISCH_PARM_SET_R](PM_AUTO_DISCH_PARM_SET_R.md) | `RC_PARAMETER_SET_ID` |
| [PM_RBC_PARM_SET_R](PM_RBC_PARM_SET_R.md) | `RC_PARAMETER_SET_ID` |
| [RC_PARAMETER](RC_PARAMETER.md) | `RC_PARAMETER_SET_ID` |
