...
> Dunning Message Definitions

**Description:** PFT DUNNING MSG  
**Table type:** REFERENCE  
**Primary key:** `PFT_DUNNING_MSG_ID`  
**Columns:** 15  
...
| 6 | `DUNNING_MSG_TXT` | VARCHAR(255) |  |  | Dunning Message Text |
| 7 | `DUNNING_MSG_TYPE_CD` | DOUBLE | NOT NULL |  | Types of dunning message formats |
...
| 10 | `PFT_DUNNING_MSG_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
| From table | Column |
|------------|--------|
| [PFT_DUNNING_MSG_RELTN](PFT_DUNNING_MSG_RELTN.md) | `PFT_DUNNING_MSG_ID` |
