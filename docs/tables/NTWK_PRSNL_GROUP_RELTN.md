...
> stores a relationship between networks and prsnl groups
...
| 10 | `NETWORK_ID` | DOUBLE | NOT NULL |  | Unique identifier of the Network table |
| 11 | `NTWK_PRSNL_GROUP_RELTN_ID` | DOUBLE | NOT NULL |  | unique identifier for the ntwk_prsnl_group_reltn table |
| 12 | `NTWK_SPCLTY_RELTN_ID` | DOUBLE | NOT NULL |  | unique identifier of the ntwk_spclty_reltn table |
| 13 | `PRSNL_GROUP_ID` | DOUBLE | NOT NULL |  | unique identifier of the prsnl_group table |
