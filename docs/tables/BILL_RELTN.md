...
> Contains information about entities related to a given bill.
...
| 6 | `BILL_RELTN_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 7 | `BILL_VRSN_NBR` | DOUBLE | NOT NULL | FK→ | The version number identifying which bill |
| 8 | `CORSP_ACTIVITY_ID` | DOUBLE | NOT NULL | FK→ | Correspondence Activity ID value |
...
| 10 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | FK reference to the bo_bill_reltn, bill_person_reltn, or bill_org_reltn tables |
| 11 | `PARENT_ENTITY_NAME` | CHAR(32) | NOT NULL |  | Name of the parent entity |
| 12 | `RELTN_TYPE_CD` | DOUBLE | NOT NULL |  | Relation Type Code |
