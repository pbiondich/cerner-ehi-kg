...
| 5 | `ACTIVITY_ID` | DOUBLE | NOT NULL |  | ** obsolete ** No longer used. Unique identify for activity. ** obsolete ** |
...
| 7 | `CHARGE_ITEM_ID` | DOUBLE | NOT NULL |  | Unique identifier for the charge table. |
| 8 | `CR_ACCT_ID` | DOUBLE | NOT NULL |  | Credit account id. |
| 9 | `CR_GL_ACCT_ID` | DOUBLE | NOT NULL |  | ** obsoelete ** No longer used. Credit gl account id. ** obsolete ** |
| 10 | `CSI_INTERFACE_CD` | DOUBLE | NOT NULL |  | CSI interface id. |
| 11 | `CSI_INTERFACE_REASON_CD` | DOUBLE | NOT NULL |  | CSI interface failure reason. |
| 12 | `DEPOSIT_ACCT_ID` | DOUBLE | NOT NULL |  | ** obsolete ** No longer used. Deposit account id. ** obsolete ** |
| 13 | `DR_ACCT_ID` | DOUBLE | NOT NULL |  | Debit account id. |
| 14 | `DR_GL_ACCT_ID` | DOUBLE | NOT NULL |  | ** obsolete ** No longer used. Debit gl account id. ** obsolete ** |
...
| 16 | `ERROR_DT_TM` | DATETIME |  |  | Date and time of error. |
| 17 | `EXLOG_ID` | DOUBLE | NOT NULL |  | Exception unique identifier |
| 18 | `INTERFACE_ID` | DOUBLE | NOT NULL | FK→ | Interface id. |
| 19 | `PFT_CHARGE_ID` | DOUBLE | NOT NULL | FK→ | Unique id from PFT_CHARGE table. |
