...
> Defines what items are added or modified for an exception
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTIVE_DT_TM` | DATETIME | NOT NULL |  | Date and Time the item exception was made active or inactive; |
...
| 3 | `ACTIVE_PRSNL_ID` | DOUBLE |  | FK→ | User who changed the active status |
| 4 | `CREATE_DT_TM` | DATETIME | NOT NULL |  | Date and Time the item exception was created; |
| 5 | `CREATE_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | User who created the item exception; |
| 6 | `HOLD_QTY` | DOUBLE | NOT NULL |  | The quantity of the item that should be picked but not opened; |
| 7 | `ITEM_ID` | DOUBLE | NOT NULL | FK→ | The item being added or modified on the exception |
| 8 | `OPEN_QTY` | DOUBLE | NOT NULL |  | The quantity of the item that should be opened |
| 9 | `SN_PREF_CARD_EXCEPTION_ID` | DOUBLE |  | FK→ | Preference Card Exception the item is for; |
| 10 | `SN_PREF_CARD_EXCEPT_ADD_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| `SN_PREF_CARD_EXCEPTION_ID` | [SN_PREF_CARD_EXCEPTION](SN_PREF_CARD_EXCEPTION.md) | `SN_PREF_CARD_EXCEPTION_ID` |
