...
> Table containing the qualifying encounters for Meaningful Use NQF Stage 2 2018
...
| 20 | `LH_AMB_QUAL_ENCNTR_2018_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_QUAL_ENCNTR_2018 table. |
