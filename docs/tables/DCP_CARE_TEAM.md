...
| 3 | `CARETEAM_ID` | DOUBLE | NOT NULL | PK | Unique id for care team. |
...
| 5 | `NAME` | VARCHAR(100) |  |  | Display name for care team. |
...
| From table | Column |
|------------|--------|
| [DCP_CARE_TEAM_PRSNL](DCP_CARE_TEAM_PRSNL.md) | `CARETEAM_ID` |
