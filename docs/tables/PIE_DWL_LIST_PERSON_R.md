...
> This table will store the list of all the patients tied to lists from pie_dwl_list table
...
| 5 | `PERSON_ID` | DOUBLE | NOT NULL | FK→ | The ID of the PERSON/PATIENT for whom the worklist is related |
| 6 | `PIE_DWL_LIST_ID` | DOUBLE | NOT NULL | FK→ | List ID from the pie_dwl_list table |
| 7 | `PIE_DWL_LIST_PERSON_R_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| `PIE_DWL_LIST_ID` | [PIE_DWL_LIST](PIE_DWL_LIST.md) | `PIE_DWL_LIST_ID` |
