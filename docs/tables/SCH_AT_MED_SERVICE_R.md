...
> Links an appointment type to a list of related medical services.
...
| 7 | `MED_SERVICE_CD` | DOUBLE | NOT NULL |  | The medical service related to the appointment type. |
| 8 | `SCH_AT_MED_SERVICE_R_ID` | DOUBLE | NOT NULL |  | The unique primary key for the SCH_AT_MED_SERVICE_R table. |
