...
> This table stores information about ethnicity of a person.
...
| 7 | `ETHNICITY_TXT` | VARCHAR(50) | NOT NULL |  | The display text for the ethnicity. |
...
| 10 | `MILL_ETHNICITY_CD` | DOUBLE | NOT NULL |  | The code value associated with the ethnicity. |
| 11 | `RC_D_ETHNICITY_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the RC_D_ETHNICITY table. |
