...
> Stores Person_id and action type(Hide/Delete/Unhide) of persons chosen to have their data hidden, deleted or unhidden
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `BB_PTC_TEMP_PERSON_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the BB_PTC_TEMP_PERSON table. |
| 2 | `EXPORT_IND` | DOUBLE | NOT NULL |  | Indicates whether the export action has occured or not. |
| 3 | `PERSON_ID` | DOUBLE | NOT NULL |  | Uniquely identifies the related Person. |
| 4 | `PROCESS_TYPE_FLAG` | DOUBLE | NOT NULL |  | Type of action selected(Hide/Delete/UnHide) |
