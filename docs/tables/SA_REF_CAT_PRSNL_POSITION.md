...
> SA REFERENCE CATEGORY PRSNL POSITION
...
| 6 | `SA_REF_CAT_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | sa reference category prsnl id FK to sa_ref_cat_prsnl |
| 7 | `SA_REF_CAT_PRSNL_POSITION_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
