...
> Stores information about entities associated to the provenance CARDIOLOGY concept

**Description:** PROV_CARD_ENTITY  
**Table type:** ACTIVITY  
**Primary key:** `PROV_CARD_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_CARDIOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_CARDIOLOGY table. |
| 7 | `PROV_CARD_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_CARDIOLOGY_ID` | [PROVENANCE_CARDIOLOGY](PROVENANCE_CARDIOLOGY.md) | `PROVENANCE_CARDIOLOGY_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_CARD_ENTY_PRTCPNT](PROV_CARD_ENTY_PRTCPNT.md) | `PROV_CARD_ENTITY_ID` |
