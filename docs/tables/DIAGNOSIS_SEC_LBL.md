...
| 5 | `DIAGNOSIS_GROUP_ID` | DOUBLE |  | FK→ | The ID of the data entity that this security attribute is associated with. |
| 6 | `DIAGNOSIS_SEC_LBL_ID` | DOUBLE | NOT NULL |  | A system generated number to uniquely identify a row on the Diagnosis Security Label Identifier table. |
