...
> Stores the identifing information of the source of evaluation for an expectation
...
| 4 | `EXPECT_ID` | DOUBLE | NOT NULL | FK→ | Identifier of the Expectation to which this source identifier belongs |
| 5 | `HM_EXPECT_SOURCE_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 7 | `SOURCE_DOUBLE_IDENT` | DOUBLE | NOT NULL |  | The Identifier of the source of evaluation for the expectation. This is a double value |
| 8 | `SOURCE_TEXT_IDENT` | VARCHAR(2000) | NOT NULL |  | The character Identifier of the source of evaluation for the expectation. |
| 9 | `SOURCE_TYPE_FLAG` | DOUBLE | NOT NULL |  | The type of the source. This type could indicate that the source of evaluation is Immunization Based, or Cloud based, etc.1 = Travel Immunization2 = HealtheRegistry Measure3 = Preventative Service3 |
