...
> Table containing event information for meaningful use NQF stage 2 2025
...
| 23 | `LH_AMB_EVENT_DATA_2025_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EVENT_DATA_2025 table. |
