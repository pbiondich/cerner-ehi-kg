...
> Attribute containing additional information such as table a context is associated to. Also contains merge information.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ENTRY_ID` | DOUBLE | NOT NULL |  | Entry id that we are setting a source for. |
