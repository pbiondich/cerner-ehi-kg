...
> Multum Rx Builder Order Frequency Map Table
...
| 3 | `FREQUENCY_DICTIONARY_ID` | DOUBLE | NOT NULL | FK→ | This field contains an identifier that represents the administration frequency such "once a day". |
...
| `FREQUENCY_DICTIONARY_ID` | [MLTM_RXB_DICTIONARY](MLTM_RXB_DICTIONARY.md) | `DICTIONARY_ID` |
