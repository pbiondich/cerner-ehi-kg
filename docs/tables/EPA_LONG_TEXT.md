...
> Stores Long String Values for Electronic Authorization

**Description:** Electronic Prior Authorization Long Text  
**Table type:** ACTIVITY  
**Primary key:** `EPA_LONG_TEXT_ID`  
**Columns:** 8  
...
| 2 | `EPA_LONG_TEXT_ID` | DOUBLE | NOT NULL | PK | PRIMARY KEY |
| 3 | `LONG_TEXT` | LONGTEXT |  |  | The String value to be stored on the EPA_LONG_TEXT table. |
...
| From table | Column |
|------------|--------|
| [EPA_ACTIVITY](EPA_ACTIVITY.md) | `EPA_APPEAL_NOTE_ID` |
| [EPA_ACTIVITY](EPA_ACTIVITY.md) | `EPA_PA_NOTE_ID` |
| [EPA_AUTH_DETAIL](EPA_AUTH_DETAIL.md) | `EPA_AUTH_NOTE_ID` |
| [EPA_ERROR_LOG](EPA_ERROR_LOG.md) | `EPA_ERROR_NOTE_ID` |
