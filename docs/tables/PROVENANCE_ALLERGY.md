...
> Stores provenance information for the ALLERGY concept

**Description:** Provenance for ALLERGY  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_ALLERGY_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (ALLERGY - ALLERGY_EXT_DATA) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_ALLERGY_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_ALLERGY_ENTITY](PROV_ALLERGY_ENTITY.md) | `PROVENANCE_ALLERGY_ID` |
| [PROV_ALLERGY_PARTICIPANT](PROV_ALLERGY_PARTICIPANT.md) | `PROVENANCE_ALLERGY_ID` |
