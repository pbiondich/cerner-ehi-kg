# PROV_PATDEMO_PARTICIPANT

> Stores Participant information associated to the provenance Patient Demographics concept

**Description:** Provenance Patient Demographic Participant  
**Table type:** ACTIVITY  
...
| 4 | `PARTICIPANT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Participant table name e.g. PERSON |
...
| 8 | `PROVENANCE_PATDEMO_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_PATDEMO table. |
| 9 | `PROV_PATDEMO_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
