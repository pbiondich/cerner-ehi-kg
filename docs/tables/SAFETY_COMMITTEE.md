...
> Table stores all the members comprising the safety committee for an amendment
...
| 4 | `PROT_AMENDMENT_ID` | DOUBLE | NOT NULL | FK→ | identifies the amendment |
| 5 | `SAFETY_COMMITTEE_ID` | DOUBLE | NOT NULL |  | Primary Key |
