...
**Description:** MLLD_ALR_INTERACT_TEXT  
...
| 2 | `INTERACTION_TEXT_ID` | DOUBLE | NOT NULL |  | Each of the textual descriptions present in this table is linked to the appropriate variables via the interaction_text_id field. |
