...
|--:|--------|------|:-----:|-------|------------|
| 1 | `MARS_MAPPING_ID` | DOUBLE |  | FK→ | Reference to a row in the MARS_MAPPING Table |
| 2 | `MARS_MAPPING_METADATA_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `METADATA_TYPE` | VARCHAR(40) |  |  | Type of Mapping Resolution - CODE_VALUE, EVENT_CD, ORDER_CATALOG_CD |
| 4 | `METADATA_TYPE_SEQ` | DOUBLE |  |  | Order of precedence for the metadata values |
| 5 | `METADATA_VALUE` | VARCHAR(40) |  |  | A resolvable value such as CKI, Concept CKI, code value or other UID |
...
|--------|--------------|---------------|
| `MARS_MAPPING_ID` | [MARS_MAPPING](MARS_MAPPING.md) | `MARS_MAPPING_ID` |
