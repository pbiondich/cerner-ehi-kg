...
| 6 | `LONG_TEXT_ID` | DOUBLE | NOT NULL |  | The unique identifier to the LONG_TEXT table where textual comments are stored |
...
| 8 | `PRSNL_TEXT_RELTN_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the prsnl_text_reltn table. It is an internal system assigned number. |
