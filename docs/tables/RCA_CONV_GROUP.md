...
> Stores the details about the conversation groups for the Revenue Cycle Registration solution.

**Description:** Revenue Cycle Ambulatory - Conversation Group  
**Table type:** REFERENCE  
**Primary key:** `RCA_CONV_GROUP_ID`  
**Columns:** 11  
...
| 2 | `ALTERNATE_GROUP_NAME` | VARCHAR(50) |  |  | An alternate name for the conversation group. It can be used to identify one or more conversation groups. |
| 3 | `CONV_GROUP_NAME` | VARCHAR(100) | NOT NULL |  | The name of the Revenue Cycle conversation group. |
| 4 | `DESCRIPTION_TXT` | VARCHAR(255) | NOT NULL |  | The description of the Revenue Cycle conversation group. |
...
| 6 | `RCA_CONV_GROUP_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the RCA_CONV_GROUP table. |
...
| From table | Column |
|------------|--------|
| [RCA_CONV_GROUP_CONV_R](RCA_CONV_GROUP_CONV_R.md) | `RCA_CONV_GROUP_ID` |
| [RCA_CONV_GROUP_POSITION_R](RCA_CONV_GROUP_POSITION_R.md) | `RCA_CONV_GROUP_ID` |
