...
> Reference table containing supported operators for algorithm calculations
...
| 9 | `DESCRIPTION_2` | VARCHAR(20) |  |  | A description of the function of the operatorColumn |
...
| 11 | `LONG_TEXT_ID` | DOUBLE | NOT NULL | FK→ | Foreign key. CCL parser() function text.Column |
| 12 | `NBR_OPERANDS` | DOUBLE |  |  | The number of operands the operator requiresColumn |
| 13 | `OPERATOR` | VARCHAR(20) | NOT NULL |  | The operator (e.g. +, - )Column |
| 14 | `OPERATOR_ID` | DOUBLE | NOT NULL |  | Primary key for the table.Column |
