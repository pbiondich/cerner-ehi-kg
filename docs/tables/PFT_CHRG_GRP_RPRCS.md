...
> Stores balance information along with encounter details to reprocess through WTP server.
...
| 17 | `PFT_CHRG_GRP_RPRCS_ID` | DOUBLE | NOT NULL |  | System Generated Number to Uniquely Identify a Row on the PFT_CHRG_GRP_RPRCS table. |
