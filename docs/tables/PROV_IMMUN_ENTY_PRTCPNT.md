# PROV_IMMUN_ENTY_PRTCPNT

> Stores Participant relationships to the concept entity

**Description:** PROV_IMMUN_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_IMMUN_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_IMMUN_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_IMMUN_ENTITY_ID` | [PROV_IMMUN_ENTITY](PROV_IMMUN_ENTITY.md) | `PROV_IMMUN_ENTITY_ID` |
