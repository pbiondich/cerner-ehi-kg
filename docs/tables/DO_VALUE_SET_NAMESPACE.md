...
> The namespace this valueset represents.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DO_NAMESPACE` | VARCHAR(128) | NOT NULL |  | The Namepace that identifies the Value Set. Typically this is an industry standard FHIR identifier that represents the Set. |
| 2 | `DO_VALUE_SET_ID` | DOUBLE | NOT NULL | FK→ | The Value Set Identifier, unique row in the DO_VALUE_SET database table. |
| 3 | `DO_VALUE_SET_NAMESPACE_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the DO_VALUE_SET_NAMESPACE table. |
