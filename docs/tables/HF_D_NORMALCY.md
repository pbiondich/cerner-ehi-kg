...
|--:|--------|------|:-----:|-------|------------|
| 1 | `NORMALCY_DESC` | VARCHAR(60) |  |  | The description for the event normalcy |
| 2 | `NORMALCY_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines an event normalcy |
