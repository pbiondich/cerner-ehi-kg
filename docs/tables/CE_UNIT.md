...
| 2 | `FROM_TO_FORMULA` | VARCHAR(255) | NOT NULL |  | The formula to convert a FROM unit to a TO unit. |
| 3 | `FROM_UNIT_CD` | DOUBLE | NOT NULL |  | From Unit Cd |
| 4 | `FROM_UNIT_CKI` | VARCHAR(255) |  |  | From Unit CKI |
| 5 | `TO_FROM_FORMULA` | VARCHAR(255) | NOT NULL |  | The formula for TO UNIT to FROM UNIT |
| 6 | `TO_UNIT_CD` | DOUBLE | NOT NULL |  | To Unit Cd |
| 7 | `TO_UNIT_CKI` | VARCHAR(255) |  |  | To Unit CKI |
