...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ABN_CHECK_ID` | DOUBLE | NOT NULL | FK→ | ABN Check Identifier |
...
| 7 | `DIAG_NOMEN_ID` | DOUBLE | NOT NULL | FK→ | Diagnosis Nomenclature Identifier |
| 8 | `DIAG_SEQ_NBR` | DOUBLE | NOT NULL |  | Diagnosis Sequence Number |
| 9 | `DIAG_SOURCE_IDENT` | VARCHAR(50) | NOT NULL |  | Diagnosis Source Identifier |
| 10 | `DIAG_VOCAB_CD` | DOUBLE | NOT NULL | FK→ | Diagnosis Vocabulary Code |
| 11 | `DIAG_VOCAB_MEANING` | VARCHAR(12) |  |  | Diagnosis Vocabulary Meaning |
...
| `DIAG_VOCAB_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
