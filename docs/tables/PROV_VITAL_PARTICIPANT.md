...
> Stores Participant information associated to the provenance VITALS concept
...
| 8 | `PROVENANCE_VITAL_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Vital table. |
| 9 | `PROV_VITAL_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
