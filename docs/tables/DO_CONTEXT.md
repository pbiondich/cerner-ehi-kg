...
> A Discern Ontology context is a namespace for concepts. It identifies the use cases for which a set of concepts is targeted.

**Description:** DO_CONTEXT  
**Table type:** REFERENCE  
**Primary key:** `DO_CONTEXT_ID`  
**Columns:** 8  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DO_CONTEXT_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the DO_CONTEXT table. |
| 2 | `DO_CONTEXT_NAME` | VARCHAR(100) | NOT NULL |  | Name of the context. |
| 3 | `DO_CONTEXT_UUID` | VARCHAR(36) | NOT NULL |  | Discern Ontology context identifier. Will be consistent across domains. |
...
| From table | Column |
|------------|--------|
| [DO_CONTEXT_VERSION](DO_CONTEXT_VERSION.md) | `DO_CONTEXT_ID` |
