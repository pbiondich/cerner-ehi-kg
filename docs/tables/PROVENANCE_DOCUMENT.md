...
> Stores provenance information for the documents concept

**Description:** Provenance for documents  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_DOCUMENT_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name ( SI_DOCUMENT_METADATA - CLINICAL_EVENT) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_DOCUMENT_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_DOC_ENTITY](PROV_DOC_ENTITY.md) | `PROVENANCE_DOCUMENT_ID` |
| [PROV_DOC_PARTICIPANT](PROV_DOC_PARTICIPANT.md) | `PROVENANCE_DOCUMENT_ID` |
