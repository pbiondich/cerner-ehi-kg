...
> The res_sign_act_subtype contains the resident type indicator
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACT_SUBTYPE_CD` | DOUBLE | NOT NULL |  | This is a foreign key to the code_value table. It uniquely identifies the activity sub type code. |
