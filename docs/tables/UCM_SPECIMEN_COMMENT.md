# UCM_SPECIMEN_COMMENT

> Stores comments associated to a specimen.

**Description:** Unified Case Manager - Specimen Comment  
**Table type:** ACTIVITY  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCESSION_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the accession related to this comment. |
...
| 6 | `LONG_BLOB_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the Long Blob record related to this comment. |
| 7 | `PREV_UCM_SPECIMEN_COMMENT_ID` | DOUBLE | NOT NULL |  | Used to track versions of the specimen comment. This field will always point back to the initial value created. This may be used to find the correct version when combined with begin and end effective dates and times. |
| 8 | `UCM_SPECIMEN_COMMENT_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a specimen comment. |
