...
> Encounter span code (UB92).

**Description:** ENCNTR SPAN CODE  
**Table type:** ACTIVITY  
**Primary key:** `SPAN_CODE_ID`  
**Columns:** 21  
...
| 12 | `SEQUENCE` | DOUBLE |  |  | **OBSOLETE** NOT USED AT THIS TIME. Placeholder for sequential order of the condition codes. **OBSOLETE** |
| 13 | `SPAN_CD` | DOUBLE | NOT NULL |  | A UB92 span code (Universal Billing). |
| 14 | `SPAN_CODE_ID` | DOUBLE | NOT NULL | PK | This is the value of the unique primary identifier of the encounter span code table. It is an internal system assigned number. |
...
| From table | Column |
|------------|--------|
| [ENCNTR_SPAN_CODE_HIST](ENCNTR_SPAN_CODE_HIST.md) | `SPAN_CODE_ID` |
