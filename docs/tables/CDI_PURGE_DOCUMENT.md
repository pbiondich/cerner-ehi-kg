...
> Stores information about documents that require deletion and the status of previous deletion attempts
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `BLOB_HANDLE` | VARCHAR(128) | NOT NULL |  | Globally unique identifier for the document in the external system. |
| 2 | `CDI_PURGE_DOCUMENT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `FAILURE_CNT` | DOUBLE | NOT NULL |  | A count of how many prior failed attempts there have been to delete this document. |
| 4 | `IN_PROGRESS_IND` | DOUBLE | NOT NULL |  | Indicates if this document is in the process of being deleted. |
