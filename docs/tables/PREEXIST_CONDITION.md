...
| 9 | `NOMENCLATURE_ID` | DOUBLE | NOT NULL |  |  |
| 10 | `PERSON_PLAN_RELTN_ID` | DOUBLE | NOT NULL | FK→ |  |
| 11 | `PREEXIST_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a row on the PREEXIST_CONDITION table. |
...
| 15 | `UPDT_PRSNL_ID` | DOUBLE | NOT NULL |  |  |
