# PROV_DOC_ENTY_PRTCPNT

> Stores Participant relationships to the concept entity

**Description:** PROV_DOC_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_DOC_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_DOC_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_DOC_ENTITY_ID` | [PROV_DOC_ENTITY](PROV_DOC_ENTITY.md) | `PROV_DOC_ENTITY_ID` |
