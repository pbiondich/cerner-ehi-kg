...
> Detailed information about the preference entry. More like a help file for the entry.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ENTRY_ID` | DOUBLE | NOT NULL |  | Entry id that we are setting a description for. |
