...
**Description:** MLLD_XP_CLIN_TEXT_XREF  
...
| 3 | `FUNCTION_ID` | DOUBLE | NOT NULL |  | The function ID from MLTM FUNCTION TYPE table |
| 4 | `LEVEL_ID` | DOUBLE | NOT NULL |  | Part of the unique identifier for this table. |
| 5 | `SEVERITY_ID` | DOUBLE | NOT NULL |  | FK from the Multum severity table |
| 6 | `SYST_ID` | DOUBLE | NOT NULL |  | FK from the MLTM SYST IDENTIFIER TABLE |
| 7 | `TEXT_ID` | DOUBLE | NOT NULL |  | PK from the Multum XP Clin Text table |
