...
| 9 | `PARENT_ID` | DOUBLE | NOT NULL |  | Parent Identifier |
| 10 | `PARENT_TABLE` | VARCHAR(32) | NOT NULL |  | Parent Table |
| 11 | `SUB_TEXT_CD` | DOUBLE | NOT NULL | FK→ | The identifier for the scheduling text sub-type. |
| 12 | `SUB_TEXT_MEANING` | VARCHAR(12) |  |  | The 12-character string corresponding to the scheduling text sub-type. |
| 13 | `TEXT_ID` | DOUBLE | NOT NULL | FK→ | Text Identifier |
| 14 | `TEXT_TYPE_CD` | DOUBLE | NOT NULL | FK→ | The identifier for the scheduling text type. |
| 15 | `TEXT_TYPE_MEANING` | VARCHAR(12) | NOT NULL |  | The 12-character string corresponding to the scheduling text type. |
