...
> Defines the quantity filled of an item instance on the picklist
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EQUIPMENT_STATUS_CD` | DOUBLE | NOT NULL |  | The status of the equipment instance at the time the instance was filled |
| 2 | `FILL_DT_TM` | DATETIME |  |  | The Date and Time that the quantity was filled |
| 3 | `FILL_LOCATION_CD` | DOUBLE | NOT NULL |  | The location that the quantity was filled from |
| 4 | `FILL_QTY` | DOUBLE | NOT NULL |  | The quantity of the instance of an item that was filled |
| 5 | `IN_CASE_FILL_IND` | DOUBLE | NOT NULL |  | Indicates whether the quanity was filled during the surgical case (rather than being filled during the initial fill) |
| 6 | `SN_PICKLIST_FILL_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 7 | `SN_PICKLIST_ITEM_DETAIL_ID` | DOUBLE | NOT NULL | FK→ | Indicates whether the quanity was filled during the surgical case (rather than being filled during the initial fill) |
| 8 | `SUPPLY_CABINET_IND` | DOUBLE | NOT NULL |  | Indicates whether the fill was generated via Supply Cabinet Integration |
