...
> Contains codified values from an external source like FHIR and association to the vitals staged data.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CODE_STR` | VARCHAR(40) |  |  | The codified value. |
| 2 | `DISPLAY_STR` | VARCHAR(255) |  |  | The display string of the codified value. |
| 3 | `SYSTEM_URI` | VARCHAR(80) |  |  | The URI of the coding system. |
...
| 9 | `VERSION_STR` | VARCHAR(10) |  |  | The version of the coding system. |
| 10 | `VITALS_EXT_DATA_ID` | DOUBLE | NOT NULL | FK→ | The primary key of the external data associated with this codified value. |
| 11 | `VITALS_EXT_STANDARD_CODE_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
