...
> Store provenance information for the encounters concept.

**Description:** Provenance for Encounters  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_ENCOUNTER_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name ( ENCOUNTER ) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_ENCOUNTER_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_ENCNTR_ENTITY](PROV_ENCNTR_ENTITY.md) | `PROVENANCE_ENCOUNTER_ID` |
| [PROV_ENCNTR_PARTICIPANT](PROV_ENCNTR_PARTICIPANT.md) | `PROVENANCE_ENCOUNTER_ID` |
