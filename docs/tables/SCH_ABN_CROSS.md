...
> Scheduling ABN Cross Reference
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ABN_CROSS_ID` | DOUBLE | NOT NULL |  | ABN Cross Reference Identifier |
...
| 9 | `PARENT_APPT_TYPE_CD` | DOUBLE | NOT NULL | FK→ | Protocol Parent Appointment Type Code |
| 10 | `PROC_NOMEN_ID` | DOUBLE | NOT NULL | FK→ | Procedure Nomenclature Identifier |
...
| `PARENT_APPT_TYPE_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
