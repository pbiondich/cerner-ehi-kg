...
> This table will store the confidentiality defaults at synonym level
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CONFIDENTIAL_REASON_CD` | DOUBLE |  |  | Stores the Confidentiality reason code value |
| 2 | `OCS_CONFIDENTIAL_DEFAULTS_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `SYNONYM_ID` | DOUBLE |  | FK→ | Identifies the orderable item. Foreign Key from ORDER_CATALOG_SYNONYM table. |
