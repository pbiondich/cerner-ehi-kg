...
> Activity table that stores the facts (results) from cvnet omf data
...
| 6 | `COUNT` | DOUBLE | NOT NULL |  | Stores the value of different types of countColumn |
| 7 | `COUNT_DATA_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the cv_count_data table. It is an internal system assigned number. |
| 8 | `COUNT_ID` | DOUBLE | NOT NULL |  | Foreign Key to this table. It is the unique identifier to cv_count table |
...
| 13 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | This attributes identifies the primary key of the Parent tableColumn |
| 14 | `PARENT_ENTITY_NAME` | VARCHAR(80) |  |  | The name of Parent tableColumn |
