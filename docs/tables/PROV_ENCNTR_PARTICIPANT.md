...
> Stores Participant information associated to the provenance ENCNTR concept

**Description:** Provenance ENCNTR Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_ENCOUNTER_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Encounter table. |
| 9 | `PROV_ENCNTR_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
