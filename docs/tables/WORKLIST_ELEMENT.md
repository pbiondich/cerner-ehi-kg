...
| 2 | `ORDER_ID` | DOUBLE | NOT NULL | FK→ | A unique, internal, system-assigned number that identifies a specific order related to this worklist element. |
...
| 9 | `WORKLIST_ELEMENT_ID` | DOUBLE | NOT NULL |  | A unique, internal, system-assigned number that identifies a specific worklist element. |
| 10 | `WORKLIST_ID` | DOUBLE | NOT NULL | FK→ | A unique, internal, system-assigned number that identifies a specific worklist related to this worklist elelment. |
