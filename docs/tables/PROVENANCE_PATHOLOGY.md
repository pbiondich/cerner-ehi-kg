# PROVENANCE_PATHOLOGY

> Provenance for PATHOLOGY

**Description:** PROVENANCE_PATHOLOGY  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_PATHOLOGY_ID`  
**Columns:** 14  
...
| 8 | `PROVENANCE_PATHOLOGY_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_PATH_ENTITY](PROV_PATH_ENTITY.md) | `PROVENANCE_PATHOLOGY_ID` |
| [PROV_PATH_PARTICIPANT](PROV_PATH_PARTICIPANT.md) | `PROVENANCE_PATHOLOGY_ID` |
