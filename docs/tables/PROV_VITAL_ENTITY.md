...
> Stores information about entities associated to the provenance VITALS concept

**Description:** Provenance VITALS Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_VITAL_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_VITAL_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Vital table. |
| 7 | `PROV_VITAL_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_VITAL_ID` | [PROVENANCE_VITAL](PROVENANCE_VITAL.md) | `PROVENANCE_VITAL_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_VITAL_ENTY_PRTCPNT](PROV_VITAL_ENTY_PRTCPNT.md) | `PROV_VITAL_ENTITY_ID` |
