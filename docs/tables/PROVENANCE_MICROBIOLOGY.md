# PROVENANCE_MICROBIOLOGY

> Provenance for MICROBIOLOGY

**Description:** PROVENANCE_MICROBIOLOGY  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_MICROBIOLOGY_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (tbd - tbd_EXT_DATA) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_MICROBIOLOGY_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_MICRO_ENTITY](PROV_MICRO_ENTITY.md) | `PROVENANCE_MICROBIOLOGY_ID` |
| [PROV_MICRO_PARTICIPANT](PROV_MICRO_PARTICIPANT.md) | `PROVENANCE_MICROBIOLOGY_ID` |
