# PROV_ORDER_ENTY_PRTCPNT

> Stores Participant relationships to the concept entity

**Description:** PROV_ORDER_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_ORDER_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_ORDER_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_ORDER_ENTITY_ID` | [PROV_ORDER_ENTITY](PROV_ORDER_ENTITY.md) | `PROV_ORDER_ENTITY_ID` |
