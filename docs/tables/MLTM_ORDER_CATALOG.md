...
> Supports loading Multum's Order Catalog

**Description:** Multum Order Catalog  
...
| 4 | `DRUG_SYNONYM_ID` | DOUBLE | NOT NULL | FK→ | This field contains a (unique ?) numeric identifier for a description of a drug. This value comes from an outside source and is not generated in Millennium. |
