...
> Stores requisition line items that need to be externally sourced and are waiting to be placed on a purchase order.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `LINE_ITEM_ID` | DOUBLE | NOT NULL | FK→ | The primary identifier into the line_item table. |
