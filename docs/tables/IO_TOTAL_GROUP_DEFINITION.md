...
> Contains the Grouper ID for the definitions

**Description:** IO Total Group Definition  
**Table type:** REFERENCE  
**Primary key:** `IO_TOTAL_GROUP_ID`  
**Columns:** 6  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `IO_TOTAL_GROUP_ID` | DOUBLE | NOT NULL | PK | ID value for the definition Grouper |
...
| From table | Column |
|------------|--------|
| [IO_DEF_ELEMENT_RELTN](IO_DEF_ELEMENT_RELTN.md) | `IO_TOTAL_GROUP_ID` |
| [IO_TOTAL_DEFINITION](IO_TOTAL_DEFINITION.md) | `IO_TOTAL_GROUP_ID` |
