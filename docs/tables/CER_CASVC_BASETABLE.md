...
> Table to support production of Care Aware solution and CER_CASVC userid.

**Description:** CER_CASVC_BASETABLE  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CER_CASVC_BASETABLE_ID` | DOUBLE | NOT NULL |  | Primary key of CER_CASVC_BASETABLE |
