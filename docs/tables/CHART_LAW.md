...
> This table stores the general details for each cross-encounter law. (DistributionTool.exe)
...
| 5 | `LAW_DESCR` | VARCHAR(100) | NOT NULL |  | The cross-encounter law description. |
| 6 | `LAW_ID` | DOUBLE | NOT NULL | PK | The unique identifier for the cross-encounter law. |
...
| 8 | `LOOKBACK_DAYS` | DOUBLE | NOT NULL |  | The number of days to lookback for law. |
| 9 | `LOOKBACK_TYPE_IND` | DOUBLE | NOT NULL |  | 1=By Discharge Date/Time, 2=By Clinical Activity Date/Time |
...
| From table | Column |
|------------|--------|
| [CHART_LAW_FILTER](CHART_LAW_FILTER.md) | `LAW_ID` |
| [CHART_LAW_FILTER_VALUE](CHART_LAW_FILTER_VALUE.md) | `LAW_ID` |
