...
> Contains filter information for order sentence.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `AGE_MAX_VALUE` | DOUBLE | NOT NULL |  | Maximum value for the age range |
| 2 | `AGE_MIN_VALUE` | DOUBLE | NOT NULL |  | minimum value for the age range |
| 3 | `AGE_UNIT_CD` | DOUBLE | NOT NULL |  | Age code valueCode Set: 54The unit of the age: hours, days, weeks, months, years |
| 4 | `ORDER_SENTENCE_FILTER_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the ORDER_SENTENCE_FILTER table. |
| 5 | `ORDER_SENTENCE_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for the order sentence in order_sentence table. |
| 6 | `PMA_MAX_VALUE` | DOUBLE | NOT NULL |  | Maximum value for the PMA range |
| 7 | `PMA_MIN_VALUE` | DOUBLE | NOT NULL |  | minimum value for the PMA range |
| 8 | `PMA_UNIT_CD` | DOUBLE | NOT NULL |  | The unit of the PMA: days, weeks |
...
| 14 | `WEIGHT_MAX_VALUE` | DOUBLE | NOT NULL |  | Maximum value for the weight range |
| 15 | `WEIGHT_MIN_VALUE` | DOUBLE | NOT NULL |  | Minimum value for the weight range |
| 16 | `WEIGHT_UNIT_CD` | DOUBLE | NOT NULL |  | weight code value. The unit of the weight: oz, lb, g, kg |
