...
> Relationship table between worklist and dispense category filters.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DISPENSE_CATEGORY_CD` | DOUBLE | NOT NULL | FK→ | The dispense category that this worklist is filtered by. |
| 2 | `INCLUDE_IND` | DOUBLE |  |  | Indicates if the dispense category for the worklist should be included. 0: Dispense category for the worklist should be excluded.; 1: Dispense category for the worklist should be included. |
| 3 | `RXS_WORKLIST_DISP_CAT_R_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the RXS_WORKLIST_DISP_CAT_R table. |
| 4 | `RXS_WORKLIST_ID` | DOUBLE | NOT NULL | FK→ | The worklist that is being filtered by the dispense category. |
...
|--------|--------------|---------------|
| `DISPENSE_CATEGORY_CD` | [DISPENSE_CATEGORY](DISPENSE_CATEGORY.md) | `DISPENSE_CATEGORY_CD` |
