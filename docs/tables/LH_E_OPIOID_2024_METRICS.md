...
> Stores data gathered by the LH_E_OPIOID_2024 script.
...
| 33 | `LH_E_OPIOID_2024_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_OPIOID_2024_METRICS table. |
