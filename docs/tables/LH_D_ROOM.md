...
> Dimension table to hold Room information for Lighthouse Reporting

**Description:** LH_D_ROOM  
**Table type:** REFERENCE  
**Primary key:** `D_ROOM_ID`, `HEALTH_SYSTEM_SOURCE_ID`  
**Columns:** 15  
...
| 3 | `D_ROOM_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the LH_D_ROOM table. |
...
| 7 | `LOC_ROOM_CD` | DOUBLE | NOT NULL |  | The location of the room. CODE SET 220 |
| 8 | `PROCESS_DT_TM` | DATETIME |  |  | The date/time the record wad first loaded into the table. |
| 9 | `ROOM_DESCRIPTION` | VARCHAR(50) |  |  | The description of the room |
| 10 | `ROOM_DISPLAY` | VARCHAR(50) |  |  | The display value for the room |
| 11 | `ROOM_MEANING` | VARCHAR(50) |  |  | The Cerner-identified meaning for the room |
...
| From table | Column |
|------------|--------|
| [LH_F_IC_MDRO_DTL_METRICS](LH_F_IC_MDRO_DTL_METRICS.md) | `D_COLL_PREV_ROOM_ID` |
| [LH_F_IC_MDRO_DTL_METRICS](LH_F_IC_MDRO_DTL_METRICS.md) | `D_COLL_ROOM_ID` |
