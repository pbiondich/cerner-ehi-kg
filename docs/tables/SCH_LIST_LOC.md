...
> Scheduling Resource List Location
...
| 8 | `LIST_ROLE_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for the scheduling role. |
| 9 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The field identifies the current permanent location of the patient. |
