...
> Defines the interaction checking for an appointment type.
...
| 10 | `INTER_TYPE_MEANING` | VARCHAR(12) |  |  | A 12-character corresponding to the INTER_TYPE_CD. |
...
| 13 | `SEQ_GROUP_ID` | DOUBLE | NOT NULL | FK→ | A internal identifier for a scheduling sequence group. |
