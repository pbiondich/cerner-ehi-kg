...
| From table | Column |
|------------|--------|
| [MLLD_RXB_CALC_DISP_RULE_ORDMAP](MLLD_RXB_CALC_DISP_RULE_ORDMAP.md) | `DOSE_DISPENSE_RULE_ID` |
| [MLLD_RXB_CALC_DUR_RULE_ORD_MAP](MLLD_RXB_CALC_DUR_RULE_ORD_MAP.md) | `DOSE_DISPENSE_RULE_ID` |
