...
> Table used to store information regarding automated messaging

**Description:** Scheduling Automated Messaging  
**Table type:** REFERENCE  
**Primary key:** `SCH_AUTO_MSG_ID`  
**Columns:** 17  
...
| 5 | `AUTOMATED_MESSAGE_TYPE_CD` | DOUBLE | NOT NULL |  | The automated message type code value that the automated messaging build is associated with. |
...
| 7 | `DAYS_IN_ADVANCE` | DOUBLE | NOT NULL |  | The number of days in advance to perform the automated message. |
...
| 9 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The location code value that the automated messaging build is associated with. |
| 10 | `ORIG_SCH_AUTO_MSG_ID` | DOUBLE | NOT NULL | FK→ | ORIGINAL SCH_AUTO_MSG_ID for this set of versioned entries. Required for Type-2 Versioning |
| 11 | `SCH_AUTO_MSG_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the SCH_AUTO_MSG table. |
...
| `ORIG_SCH_AUTO_MSG_ID` | [SCH_AUTO_MSG](SCH_AUTO_MSG.md) | `SCH_AUTO_MSG_ID` |

## Referenced by (3)

| From table | Column |
|------------|--------|
| [SCH_AUTO_MSG](SCH_AUTO_MSG.md) | `ORIG_SCH_AUTO_MSG_ID` |
| [SCH_AUTO_MSG_APPT_TYPE_R](SCH_AUTO_MSG_APPT_TYPE_R.md) | `SCH_AUTO_MSG_ID` |
| [SCH_AUTO_MSG_RESOURCE_R](SCH_AUTO_MSG_RESOURCE_R.md) | `SCH_AUTO_MSG_ID` |
