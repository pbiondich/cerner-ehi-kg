# CPS_JQ_CAMM_VALIDATESTUDY

> CammPlatformServices_JobQueue_VALIDATE STUDY

**Description:** CPS_JQ_CAMM_VALIDATESTUDY  
**Table type:** ACTIVITY  
...
| 2 | `CPS_JQ_CAMM_VALIDATESTUDY_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
