...
|--:|--------|------|:-----:|-------|------------|
| 1 | `COUNTRY_ID` | DOUBLE | NOT NULL | FK→ | FK to MLLD_COUNTRY |
...
|--------|--------------|---------------|
| `COUNTRY_ID` | [MLLD_COUNTRY](MLLD_COUNTRY.md) | `COUNTRY_ID` |

## Referenced by (4)

| From table | Column |
|------------|--------|
| [MLLD_BCB_DRC_UNITS](MLLD_BCB_DRC_UNITS.md) | `GLOBAL_TYPE_ID` |
| [MLLD_DRUG_NAME_GLOBAL_TYPE](MLLD_DRUG_NAME_GLOBAL_TYPE.md) | `GLOBAL_TYPE_ID` |
| [MLLD_NDC_CORE_DESCRIPTION](MLLD_NDC_CORE_DESCRIPTION.md) | `GLOBAL_TYPE_ID` |
| [MLLD_NDC_MAIN_DRUG_CODE](MLLD_NDC_MAIN_DRUG_CODE.md) | `GLOBAL_TYPE_ID` |
