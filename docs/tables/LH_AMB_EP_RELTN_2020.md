# LH_AMB_EP_RELTN_2020

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2020

**Description:** LH_AMB_EP_RELTN_2020  
**Table type:** ACTIVITY  
...
| 10 | `LH_AMB_EP_RELTN_2020_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2020 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2020_ID` | DOUBLE | NOT NULL | FK→ | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2020 that matches. |
...
|--------|--------------|---------------|
| `HEALTH_SYSTEM_SOURCE_ID` | [LH_AMB_QUAL_ENCNTR_2020](LH_AMB_QUAL_ENCNTR_2020.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| `LH_AMB_QUAL_ENCNTR_2020_ID` | [LH_AMB_QUAL_ENCNTR_2020](LH_AMB_QUAL_ENCNTR_2020.md) | `LH_AMB_QUAL_ENCNTR_2020_ID` |
