# TERMINAL_DIGIT_GROUP

> This is used to format a number in terminal digit order.

**Description:** Terminal Digit Group  
...
| 5 | `ALIAS_POOL_CD` | DOUBLE | NOT NULL |  | This is the Alias pool code which is used for display format |
...
| 8 | `GROUP_LENGTH` | DOUBLE |  |  | This is the length of the number grouping |
| 9 | `GROUP_START_POSITION` | DOUBLE |  |  | This is the Start position for the number grouping |
| 10 | `PARENT_ENTITY_FIELD` | VARCHAR(40) |  |  | This is the field name for the parent entity table |
| 11 | `PARENT_ENTITY_NAME` | VARCHAR(40) |  |  | This is the name of the table |
| 12 | `TDG_SEQUENCE` | DOUBLE | NOT NULL |  | This is the sequence number that this grouping is |
