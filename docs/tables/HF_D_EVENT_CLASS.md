...
> HF_D_EVENT_CLASS table

**Description:** HF_D_EVENT_CLASS  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EVENT_CLASS_DESC` | VARCHAR(60) |  |  | The description for the event class |
| 2 | `EVENT_CLASS_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines an event class |
