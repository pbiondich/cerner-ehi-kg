...
> The operations month of year table stores the months of the year that a job is scheduled to run.

**Description:** Operations Month of Year  
**Table type:** REFERENCE  
**Primary key:** `OPS2_MONTH_OF_YEAR_ID`  
**Columns:** 7  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `MONTH_NBR_TXT` | VARCHAR(100) | NOT NULL |  | Indicates the month of year. Possibilities are 1-12 and All Months. |
| 2 | `OPS2_MONTH_OF_YEAR_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the OPS2_MONTH_OF_YEAR table. |
...
| From table | Column |
|------------|--------|
| [OPS2_DEPENDENCY_RELTN](OPS2_DEPENDENCY_RELTN.md) | `OPS2_MONTH_OF_YEAR_ID` |
| [OPS2_JOB_SCHED](OPS2_JOB_SCHED.md) | `OPS2_MONTH_OF_YEAR_ID` |
