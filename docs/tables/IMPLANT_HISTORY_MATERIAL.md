...
> Contains information about the alert set Material component for the rule
...
| 3 | `IMPLANT_HISTORY_MATERIAL_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 4 | `MATERIAL_CD` | DOUBLE | NOT NULL |  | Material type used for an Implant |
