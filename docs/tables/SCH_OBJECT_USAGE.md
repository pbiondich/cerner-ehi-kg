...
| 11 | `OBJECT_USAGE_CD` | DOUBLE | NOT NULL | FK→ | A coded identifier for the scheduling object usage. |
| 12 | `OBJECT_USAGE_MEANING` | VARCHAR(12) |  |  | A 12-char description corresponding to the scheduling object usage. |
...
| `OBJECT_USAGE_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
