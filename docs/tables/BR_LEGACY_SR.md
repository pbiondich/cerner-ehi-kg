...
> Stores relationships between Service Resources and the DTAs.
...
| 2 | `BR_CLIENT_ID` | DOUBLE | NOT NULL |  | Bedrock Client ID from BR_CLIENT |
| 3 | `SERVICE_RESOURCE` | VARCHAR(40) | NOT NULL |  | The Service Resource Description |
| 4 | `SR_ID` | DOUBLE | NOT NULL |  | Service Resource ID from BR_SERVICE_RESOURCE |
