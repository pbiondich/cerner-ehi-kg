...
> Relates Charted Sections to the Clinical Event values that they contain.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EVENT_ID` | DOUBLE | NOT NULL |  | The clinical event that belongs to the Charted Section. |
| 2 | `NC_CHARTED_SECTION_CE_R_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the NC_CHARTED_SECTON_CE_R table. |
| 3 | `NC_CHARTED_SECTION_ID` | DOUBLE | NOT NULL | FK→ | The Charted Section that the associated Event_id belongs to. |
...
|--------|--------------|---------------|
| `NC_CHARTED_SECTION_ID` | [NC_CHARTED_SECTION](NC_CHARTED_SECTION.md) | `NC_CHARTED_SECTION_ID` |
