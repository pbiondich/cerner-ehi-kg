...
> Contains set information about a set that contains personnel preferential agreements that could be applied to a personnel.

**Description:** Revenue Cycle Service Set  
**Table type:** REFERENCE  
**Primary key:** `RC_SERVICE_SET_ID`  
**Columns:** 10  
...
| 3 | `RC_SERVICE_SET_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the RC_SERVICE_SET table. |
| 4 | `SERVICE_SET_DISPLAY` | VARCHAR(100) | NOT NULL |  | Contains the Mnemonic for this service set. This column should be unique within a given domain for active rows. |
| 5 | `SERVICE_SET_DISPLAY_KEY` | VARCHAR(100) | NOT NULL |  | The key version of the service set display (all uppercase and all spaces removed). |
...
| From table | Column |
|------------|--------|
| [RC_ORG_SERVICE_SET_RELTN](RC_ORG_SERVICE_SET_RELTN.md) | `RC_SERVICE_SET_ID` |
| [RC_PRSNL_SERVICE_SET_RELTN](RC_PRSNL_SERVICE_SET_RELTN.md) | `RC_SERVICE_SET_ID` |
| [RC_SERVICE_SET_ITEM](RC_SERVICE_SET_ITEM.md) | `RC_SERVICE_SET_ID` |
