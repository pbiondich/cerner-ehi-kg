...
> Provenance for RADIOLOGY

**Description:** PROVENANCE_RADIOLOGY  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_RADIOLOGY_ID`  
**Columns:** 14  
...
| 8 | `PROVENANCE_RADIOLOGY_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_RAD_ENTITY](PROV_RAD_ENTITY.md) | `PROVENANCE_RADIOLOGY_ID` |
| [PROV_RAD_PARTICIPANT](PROV_RAD_PARTICIPANT.md) | `PROVENANCE_RADIOLOGY_ID` |
