...
> Used for tracking history of columns on the ENCNTR_CONDITION_CODE table
...
| 6 | `CONDITION_CD` | DOUBLE |  |  | A ub92 condition code (universal billing) |
| 7 | `CONDITION_CODE_ID` | DOUBLE |  | FK→ | Uniquely identifies the related Encounter Condition Code Identifier |
...
| 12 | `ENCNTR_CNDTN_CODE_HIST_ID` | DOUBLE | NOT NULL |  | A system generated code to uniquely identify a row on the ENCNTR_CNDTN_CODE_HIST table |
...
| 14 | `PM_HIST_TRACKING_ID` | DOUBLE |  | FK→ | This is the value of the unique primary identifier of the pm_hist_tracking table. It is an internal system assigned number. |
...
|--------|--------------|---------------|
| `CONDITION_CODE_ID` | [ENCNTR_CONDITION_CODE](ENCNTR_CONDITION_CODE.md) | `CONDITION_CODE_ID` |
