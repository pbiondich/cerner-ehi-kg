...
> This table models a radiologist's reading worklist.

**Description:** Radiology Worklist Definition  
**Table type:** REFERENCE  
**Primary key:** `RAD_WRKLST_DEF_ID`  
**Columns:** 15  
...
| 6 | `PRSNL_ID` | DOUBLE | NOT NULL | FK→ | a foreign key from the prsnl table. it is the id of the person that owns the definition. |
| 7 | `RAD_WRKLST_DEF_ID` | DOUBLE | NOT NULL | PK | Unique generated numbere that identifies a single row on the RAD_WRKLST_DEF table. |
| 8 | `SHARED_IND` | DOUBLE | NOT NULL |  | Used to identify a worklist as public or private. |
...
| 14 | `WRKLST_NAME` | VARCHAR(50) | NOT NULL |  | The name of the defined worklist. |
| 15 | `WRKLST_TYPE_CD` | DOUBLE | NOT NULL |  | The mode of the defined worklist. |
...
| From table | Column |
|------------|--------|
| [RAD_WRKLST_CRIT](RAD_WRKLST_CRIT.md) | `RAD_WRKLST_DEF_ID` |
| [RAD_WRKLST_PRSNL_PREF](RAD_WRKLST_PRSNL_PREF.md) | `RAD_WRKLST_DEF_ID` |
