...
> Stores the information of patient encounter for each custom patient list created within PowerChart.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CUSTOM_ENTRY_ID` | DOUBLE | NOT NULL |  | Unique identifier for custom patient list entry. |
...
| 3 | `PATIENT_LIST_ID` | DOUBLE | NOT NULL | FK→ | Identification of custom patient list entry is for. |
...
| 5 | `PRSNL_GROUP_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the personnel group table. It is an internal system assigned number. |
