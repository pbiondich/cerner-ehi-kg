...
| 7 | `DEFINITION` | VARCHAR(255) |  |  | The 12-character string corresponding to the field meaning. |
| 8 | `DESCRIPTION` | VARCHAR(255) |  |  | A long description used for documentation. |
| 9 | `DISP_FIELD_ID` | DOUBLE | NOT NULL | PK | The unique identifier for the scheduling display field. |
...
| From table | Column |
|------------|--------|
| [SCH_EVENT_DISP](SCH_EVENT_DISP.md) | `DISP_FIELD_ID` |
