...
**Description:** MLLD_DRUG_CATEGORIES  
...
| 3 | `MULTUM_CATEGORY_ID` | DOUBLE | NOT NULL |  | This field is used to assign a therapeutic/chemical category to a specific drug. |
