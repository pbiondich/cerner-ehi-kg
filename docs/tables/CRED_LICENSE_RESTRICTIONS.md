...
| 7 | `CREDENTIAL_ID` | DOUBLE | NOT NULL |  | A unique identifier of a credential. This is a key field from the Credential table. |
| 8 | `CRED_LIC_RESTRICT_ID` | DOUBLE | NOT NULL |  | Unique Identifier for a Credential License Restriction. |
...
| 13 | `LICENSE_RESTRICTION_CD` | DOUBLE | NOT NULL |  | Future Use |
| 14 | `RESTRICTION_DESC` | VARCHAR(100) |  |  | Text description of the restriction. |
