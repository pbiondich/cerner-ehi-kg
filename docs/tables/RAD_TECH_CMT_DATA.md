...
> The Rad_Tech_Cmt_Data table stores technical comment data for a given order in the system.

**Description:** Radiology Technical Comment Data  
**Table type:** ACTIVITY  
**Primary key:** `TECH_DATA_ID`  
**Columns:** 20  
...
| 14 | `SEQUENCE` | DOUBLE | NOT NULL |  | The sequence identifies a sequence of a list of technical comment fields for a given order |
| 15 | `TECH_DATA_ID` | DOUBLE | NOT NULL | PK | The Tech_Data_Id uniquely identifies a row in the Rad_Tech_Cmt_Data table. It serves no other purpose other than to uniquely identify the row |
...
| From table | Column |
|------------|--------|
| [RAD_TECH_CMT_DATA_HIST](RAD_TECH_CMT_DATA_HIST.md) | `TECH_DATA_ID` |
