...
> Stores relationships between a sequencing activity type and its associated genes.
...
| 3 | `CATALOG_CD` | DOUBLE | NOT NULL |  | Uniquely identifies the related DRS orderable. |
...
| 5 | `GENE_CD` | DOUBLE | NOT NULL |  | Uniquely identifies the related gene. |
| 6 | `UCMR_DSR_ORD_GENE_R_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a relationship between a DSR Orderable and a gene. |
