...
> Table stores unit of measure conversion for one unit of measure to another
...
| 3 | `AOAV_UNIT_CONVERSION_REF_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 4 | `CONVERSION_FACTOR` | VARCHAR(255) |  |  | Factor value for the conversion of measure to be converted conversion |
| 5 | `FROM_UNIT_CD` | DOUBLE | NOT NULL |  | Code value for the unit of measure to be converted from |
| 6 | `TO_UNIT_CD` | DOUBLE | NOT NULL |  | Code value for the unit of measure to be converted to |
