# PROV_PROC_PARTICIPANT

> Stores Participant information associated to the provenance PROCEDURE concept

**Description:** Provenance PROCEDURE Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_PROCEDURE_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Procedure table. |
| 9 | `PROV_PROC_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
