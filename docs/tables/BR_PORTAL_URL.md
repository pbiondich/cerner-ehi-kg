...
> This will store user created patient portal URL's, which will be mapped to a group of Eligible Providers and/or a group of CCNs.

**Description:** Bedrock Portal URL  
**Table type:** REFERENCE  
**Primary key:** `BR_PORTAL_URL_ID`  
**Columns:** 11  
...
| 3 | `BR_PORTAL_URL` | VARCHAR(255) | NOT NULL |  | Client entered URL that is used to map to Eligible Providers and / or CCNs |
| 4 | `BR_PORTAL_URL_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the BR_PORTAL_URL table. |
...
| From table | Column |
|------------|--------|
| [BR_PORTAL_URL_SVC_ENTITY_R](BR_PORTAL_URL_SVC_ENTITY_R.md) | `BR_PORTAL_URL_ID` |
