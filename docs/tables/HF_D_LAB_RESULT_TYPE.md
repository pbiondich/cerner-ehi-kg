...
> This is the HealthFacts dimension table that contains standard values for general lab result types
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `LAB_RESULT_TYPE_DESC` | VARCHAR(60) |  |  | The textual description of the lab result (numeric, character, date, etc.) |
| 2 | `LAB_RESULT_TYPE_ID` | DOUBLE |  |  | A unique non-intelligent identifier for the table |
