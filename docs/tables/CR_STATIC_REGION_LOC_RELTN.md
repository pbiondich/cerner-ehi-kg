...
> This table stores the relationships between Report Static Regions (Page Masters) and locations for a given date range.
...
| 3 | `CR_STATIC_REGION_LOC_RELTN_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 5 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The id of the location with which this row is associated. |
