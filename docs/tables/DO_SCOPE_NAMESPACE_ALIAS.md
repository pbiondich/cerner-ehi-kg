...
> Defines an alias for a namespace within a scope.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DO_SCOPE_ID` | DOUBLE | NOT NULL | FK→ | Reference to the Scope, a row in the DO_SCOPE table. |
| 2 | `DO_SCOPE_NAMESPACE` | VARCHAR(128) | NOT NULL |  | A string that represents the Namespace. |
| 3 | `DO_SCOPE_NAMESPACE_ALIAS` | VARCHAR(128) | NOT NULL |  | The Scope Alias to use when making mapping requests. |
| 4 | `DO_SCOPE_NAMESPACE_ALIAS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the DO_SCOPE_NAMESPACE_ALIAS table. |
