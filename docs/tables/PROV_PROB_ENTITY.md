...
> Stores information about entities associated to the provenance PROBLEM concept

**Description:** Provenance PROBLEM Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_PROB_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_PROBLEM_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Problem table. |
| 7 | `PROV_PROB_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_PROBLEM_ID` | [PROVENANCE_PROBLEM](PROVENANCE_PROBLEM.md) | `PROVENANCE_PROBLEM_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_PROB_ENTY_PRTCPNT](PROV_PROB_ENTY_PRTCPNT.md) | `PROV_PROB_ENTITY_ID` |
