...
> Holds multiple select code values on the encounter level.
...
| 6 | `CODE_SET` | DOUBLE | NOT NULL |  | This is a code set that can have multiple code values for one encounter. |
| 7 | `CODE_VALUE` | DOUBLE | NOT NULL |  | This is the code value for certain code sets that allow for multiple selects. |
...
| 9 | `ENCNTR_CODE_VALUE_R_ID` | DOUBLE | NOT NULL |  | Unique identifier for the encntr_code_value_r table. |
