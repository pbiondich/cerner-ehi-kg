...
| 15 | `WARN_TOKEN_CD` | DOUBLE | NOT NULL | FK→ | A unique identifier for the scheduling display token. |
| 16 | `WARN_TOKEN_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the scheduling display token. |
| 17 | `WARN_TYPE_CD` | DOUBLE | NOT NULL | FK→ | The unique identifier for the scheduling warning type. |
| 18 | `WARN_TYPE_MEANING` | VARCHAR(12) |  |  | The 12-character description corresponding to the scheduling warning type. |
