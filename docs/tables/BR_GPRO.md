...
> Group of eligible providers for group reporting..

**Description:** Bedrock Group Provider Reporting Option  
**Table type:** REFERENCE  
**Primary key:** `BR_GPRO_ID`  
**Columns:** 14  
...
| 3 | `BR_GPRO_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the br_gpro table. |
| 4 | `BR_GPRO_NAME` | VARCHAR(255) | NOT NULL |  | Name string that identifies the GPRO. |
...
| 7 | `ORIG_BR_GPRO_ID` | DOUBLE | NOT NULL | FK→ | Used for versioning. Contains the original PK from BR_GPRO |
| 8 | `SUBMIT_TYPE_FLAG` | DOUBLE | NOT NULL |  | Flag to indicate how the TIN has submitted electronically as a Group or Individual or None. |
| 9 | `TAX_ID_NBR_TXT` | VARCHAR(50) | NOT NULL |  | Stores the eligible providers's tax id number. |
...
| `ORIG_BR_GPRO_ID` | [BR_GPRO](BR_GPRO.md) | `BR_GPRO_ID` |

## Referenced by (4)

| From table | Column |
|------------|--------|
| [BR_GPRO](BR_GPRO.md) | `ORIG_BR_GPRO_ID` |
| [BR_GPRO_RELTN](BR_GPRO_RELTN.md) | `BR_GPRO_ID` |
| [BR_GPRO_SUB](BR_GPRO_SUB.md) | `BR_GPRO_ID` |
| [LH_QRDA_SETUP_DATA](LH_QRDA_SETUP_DATA.md) | `BR_GPRO_ID` |
