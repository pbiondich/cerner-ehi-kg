...
> Defined the resources which can utilize the default schedule.
...
| 7 | `DEF_SCHED_ID` | DOUBLE | NOT NULL | FK→ | The identifier for a default schedule. |
...
| 16 | `VERSION_DT_TM` | DATETIME | NOT NULL |  | The version date and time marks the date the record became historical. |
