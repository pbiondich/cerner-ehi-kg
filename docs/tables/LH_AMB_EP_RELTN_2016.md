# LH_AMB_EP_RELTN_2016

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2016

**Description:** LH_AMB_EP_RELTN_2016  
**Table type:** ACTIVITY  
...
| 10 | `LH_AMB_EP_RELTN_2016_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2016 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2016_ID` | DOUBLE | NOT NULL |  | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2016 that matches. |
