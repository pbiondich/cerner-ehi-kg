...
> Encounter codes to be included for billing.
...
| 6 | `CODE_ERROR_IND` | DOUBLE | NOT NULL |  | Indicates that the RUG code or Qualifier is in error |
| 7 | `ENCNTR_CODE_DURATION_DAYS` | DOUBLE | NOT NULL |  | This field indicates the number of days that the encounter code is valid for. |
| 8 | `ENCNTR_CODE_ID` | DOUBLE | NOT NULL |  | This field is the unique identifier for the encounter code table. |
| 9 | `ENCNTR_CODE_START_DATE` | DATETIME | NOT NULL |  | This field contains the active start date for the encounter code. |
| 10 | `ENCNTR_CODE_STRING` | VARCHAR(40) |  |  | This field contains the value for the encounter code. |
| 11 | `ENCNTR_CODE_TYPE_FLAG` | DOUBLE | NOT NULL |  | This field contains a value indicating the type of encounter codfe. |
...
| 14 | `FROM_ENCNTR_CODE_ID` | DOUBLE | NOT NULL |  | Unique identifier of the from encounter code |
