...
| 2 | `LOCATION_CD` | DOUBLE | NOT NULL |  | Foreign key to location table |
| 3 | `LOT_NUMBER_ID` | DOUBLE | NOT NULL | FK→ | Primary Key |
| 4 | `PACKAGE_TYPE_ID` | DOUBLE | NOT NULL | FK→ | Foreign Key |
| 5 | `QTY` | DOUBLE | NOT NULL |  | The quantity of the lot at this location |
