...
> Links an appointment type to a list of related Specialties.
...
| 7 | `SCH_AT_SPECIALTY_R_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the SCH_AT_SPECIALTY_R table. |
| 8 | `SPECIALTY_CD` | DOUBLE | NOT NULL |  | Specialty related to the appointment type |
