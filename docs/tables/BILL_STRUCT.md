...
> Contains information about the Bill Structure
...
| 6 | `BILL_STRUCT_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 7 | `BILL_VRSN_NBR` | DOUBLE | NOT NULL | FK→ | The version number identifying which bill |
| 8 | `BR_SEQ` | DOUBLE |  |  | Bill Record Sequence |
| 9 | `BR_SIZE` | DOUBLE |  |  | Bill Record Size |
| 10 | `BR_STRING` | LONGBLOB |  |  | Bill Record String |
...
| 13 | `ORIG_SIZE` | DOUBLE |  |  | Original size of the bill record |
