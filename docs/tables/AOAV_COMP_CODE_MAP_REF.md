...
> This table stores the component code to concept_cki mapping
...
| 3 | `AOAV_COMP_CODE_MAP_REF_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 4 | `CONCEPT_CKI` | VARCHAR(255) | NOT NULL |  | Concept_cki for a component |
