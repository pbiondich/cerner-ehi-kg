...
> Table used to store calculated rounding mask for RxBuilder
...
|--------|--------------|---------------|
| `ROUNDING_FORMAT_ID` | [MLTM_RXB_CALC_RND_FORMAT](MLTM_RXB_CALC_RND_FORMAT.md) | `FORMAT_ID` |

## Referenced by (2)

| From table | Column |
|------------|--------|
| [MLTM_RXB_CALC_DISP_RULE_ORDMAP](MLTM_RXB_CALC_DISP_RULE_ORDMAP.md) | `ROUNDING_MASK_ID` |
| [MLTM_RXB_CALC_DUR_RULE_ORD_MAP](MLTM_RXB_CALC_DUR_RULE_ORD_MAP.md) | `ROUNDING_MASK_ID` |
