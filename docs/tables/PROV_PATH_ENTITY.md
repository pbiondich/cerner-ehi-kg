...
> Stores information about entities associated to the provenance PATHOLOGY concept

**Description:** PROV_PATH_ENTITY  
**Table type:** ACTIVITY  
**Primary key:** `PROV_PATH_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_PATHOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_PATHOLOGY table. |
| 7 | `PROV_PATH_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_PATHOLOGY_ID` | [PROVENANCE_PATHOLOGY](PROVENANCE_PATHOLOGY.md) | `PROVENANCE_PATHOLOGY_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_PATH_ENTY_PRTCPNT](PROV_PATH_ENTY_PRTCPNT.md) | `PROV_PATH_ENTITY_ID` |
