...
> Stores information about entities associated to the provenance GEN_LAB concept

**Description:** Provenance GEN_LAB Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_GEN_LAB_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_GEN_LAB_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Gen_Lab table. |
| 7 | `PROV_GEN_LAB_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_GEN_LAB_ID` | [PROVENANCE_GEN_LAB](PROVENANCE_GEN_LAB.md) | `PROVENANCE_GEN_LAB_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_GENLAB_ENTY_PRTCPNT](PROV_GENLAB_ENTY_PRTCPNT.md) | `PROV_GEN_LAB_ENTITY_ID` |
