...
> The data type for the entry - supported types include text, value, switch, color, registered and pointer
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ENTRY_ID` | DOUBLE | NOT NULL |  | The entry id that the data type is specified for. |
