...
| 6 | `DISTRIBUTION_DESC` | VARCHAR(100) |  |  | Description of the distribution. |
| 7 | `DISTRIBUTION_DISPLAY` | VARCHAR(40) |  |  | Display value for a distribution. |
| 8 | `DISTRIBUTION_ID` | DOUBLE | NOT NULL |  | Primary key. |
