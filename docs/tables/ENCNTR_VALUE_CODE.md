...
> Encounter value code (UB92).

**Description:** ENCNTR VALUE CODE  
**Table type:** ACTIVITY  
**Primary key:** `VALUE_CODE_ID`  
**Columns:** 20  
...
| 5 | `AMOUNT` | DOUBLE |  |  | Dollar (numeric) value for the type of UB92 value stored. |
...
| 13 | `SEQUENCE` | DOUBLE |  |  | **OBSOLETE** NOT USED. Placeholder for future use of prioritizing encntr_value_code rows. **OBSOLETE** |
...
| 19 | `VALUE_CD` | DOUBLE | NOT NULL |  | Type of encounter value, UB92 value code, that is stored. |
| 20 | `VALUE_CODE_ID` | DOUBLE | NOT NULL | PK | This is the value of the unique primary identifier of the encounter value code table. It is an internal system assigned number. |
...
| From table | Column |
|------------|--------|
| [ENCNTR_VALUE_CODE_HIST](ENCNTR_VALUE_CODE_HIST.md) | `VALUE_CODE_ID` |
