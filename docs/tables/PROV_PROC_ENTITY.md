...
> Stores information about entities associated to the provenance PROCEDURE concept

**Description:** Provenance PROCEDURE Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_PROC_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_PROCEDURE_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Procedure table. |
| 7 | `PROV_PROC_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_PROCEDURE_ID` | [PROVENANCE_PROCEDURE](PROVENANCE_PROCEDURE.md) | `PROVENANCE_PROCEDURE_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_PROC_ENTY_PRTCPNT](PROV_PROC_ENTY_PRTCPNT.md) | `PROV_PROC_ENTITY_ID` |
