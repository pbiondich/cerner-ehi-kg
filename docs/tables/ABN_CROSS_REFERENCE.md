...
> Cross references order catalog items with cpt-4 codes using the catalog_cd and the nomenclature_id.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ABN_CROSS_REFERENCE_ID` | DOUBLE | NOT NULL |  | primary key |
...
| 7 | `CATALOG_CD` | DOUBLE | NOT NULL |  | Catalog Code from order_catalog and code_set that this row points to. |
| 8 | `CPT_NOMEN_ID` | DOUBLE | NOT NULL |  | nomenclature id of the associated cpt-4 code |
