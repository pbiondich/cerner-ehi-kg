...
**Description:** MLLD_RXB_ORD_CLINICAL_RTE_MAP  
...
| 3 | `CLINICAL_ROUTE_DICTIONARY_ID` | DOUBLE | NOT NULL |  | This field contains an identifier that represents a description clinically appropriate for describing the primary route of administration for a product. |
