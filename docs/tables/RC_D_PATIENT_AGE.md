...
> This table contains the possible patient ages in years and months.

**Description:** Revenue Cycle Dimension Patient Age  
**Table type:** REFERENCE  
**Primary key:** `RC_D_PATIENT_AGE_ID`  
**Columns:** 13  
...
| 2 | `AGE_IN_MONTHS` | DOUBLE | NOT NULL |  | Age of Patient in Months |
| 3 | `AGE_IN_YEARS` | DOUBLE | NOT NULL |  | Age of patient in years. |
...
| 8 | `RC_D_PATIENT_AGE_ID` | DOUBLE | NOT NULL | PK | Uniquely identifies information about a patients age. |
...
| From table | Column |
|------------|--------|
| [RC_F_DAILY_CENSUS](RC_F_DAILY_CENSUS.md) | `RC_D_PATIENT_AGE_ID` |
| [RC_F_DAILY_CENSUS_SMRY](RC_F_DAILY_CENSUS_SMRY.md) | `RC_D_PATIENT_AGE_ID` |
| [RC_F_MONTHLY_CENSUS_SMRY](RC_F_MONTHLY_CENSUS_SMRY.md) | `RC_D_PATIENT_AGE_ID` |
