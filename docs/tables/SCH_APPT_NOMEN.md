...
> Allows the association of nomenclature entries with an appointment type.

**Description:** Scheduling Appointment Nomenclature  
**Table type:** REFERENCE  
**Primary key:** `APPT_NOMEN_CD`, `APPT_TYPE_CD`  
**Columns:** 17  
...
| 5 | `APPT_NOMEN_CD` | DOUBLE | NOT NULL | PK FK→ | A coded identifier corresponding to a appointment nomenclature type. |
| 6 | `APPT_NOMEN_MEANING` | VARCHAR(12) |  |  | A 12 character description corresponding to APPT_NOMEN_CD |
| 7 | `APPT_TYPE_CD` | DOUBLE | NOT NULL | PK FK→ | The identifier for an appointment type. |
...
|--------|--------------|---------------|
| `APPT_NOMEN_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
...
| From table | Column |
|------------|--------|
| [SCH_NOMEN_LIST](SCH_NOMEN_LIST.md) | `APPT_NOMEN_CD` |
| [SCH_NOMEN_LIST](SCH_NOMEN_LIST.md) | `APPT_TYPE_CD` |
