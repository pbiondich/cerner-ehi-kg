...
> binding of ref log event to application/user information
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `PARAM_NUM` | DOUBLE | NOT NULL |  | param num |
| 2 | `REF_BIND_NUM` | DOUBLE | NOT NULL |  | bind num |
| 3 | `REF_ID` | DOUBLE | NOT NULL |  | ref id |
| 4 | `REF_TEXT` | VARCHAR(2000) |  |  | reference text |
| 5 | `REF_TYPE` | CHAR(1) |  |  | type of reference |
