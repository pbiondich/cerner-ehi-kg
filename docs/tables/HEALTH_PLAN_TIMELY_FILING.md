...
> Table used to store information regarding health plan timely filing.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `AUTO_RELEASE_DAYS` | DOUBLE | NOT NULL |  | *** OBSOLETE *** |
| 2 | `HEALTH_PLAN_ID` | DOUBLE | NOT NULL | FK→ | *** OBSOLETE *** |
| 3 | `HEALTH_PLAN_TIMELY_FILING_ID` | DOUBLE | NOT NULL |  | *** OBSOLETE *** |
| 4 | `LIMIT_DAYS` | DOUBLE | NOT NULL |  | *** OBSOLETE *** |
| 5 | `NOTIFY_DAYS` | DOUBLE | NOT NULL |  | *** OBSOLETE *** |
| 6 | `PAYER_ID` | DOUBLE | NOT NULL |  | *** OBSOLETE *** |
