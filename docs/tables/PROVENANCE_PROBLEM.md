...
> Stores provenance information for the problems concept

**Description:** Provenance for problems  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_PROBLEM_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (PROBLEM - PROBLEM_EXT_DATA) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_PROBLEM_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_PROB_ENTITY](PROV_PROB_ENTITY.md) | `PROVENANCE_PROBLEM_ID` |
| [PROV_PROB_PARTICIPANT](PROV_PROB_PARTICIPANT.md) | `PROVENANCE_PROBLEM_ID` |
