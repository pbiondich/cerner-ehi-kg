...
> Contains information about entities related to a surcharge
...
| 4 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | Contains the reference to the ID of the parent entity name |
| 5 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Name of the parent entity. |
| 6 | `PFT_SURCHARGE_ENABLED_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the pfr_surcharge_enabled. |
