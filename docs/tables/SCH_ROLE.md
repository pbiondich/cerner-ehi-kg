...
| 16 | `ROLE_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the scheduling role. |
| 17 | `SCH_ROLE_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the scheduling role. |
