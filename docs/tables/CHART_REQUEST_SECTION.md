...
| 5 | `CHART_REQUEST_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to the CHART_REQUEST table |
| 6 | `CHART_SECTION_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to the CHART_SECTION table |
| 7 | `CR_SECT_SEQ` | DOUBLE |  |  | Sequence of the section_id |
