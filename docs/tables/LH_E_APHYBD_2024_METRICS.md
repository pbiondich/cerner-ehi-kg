# LH_E_APHYBD_2024_METRICS

> Stores data gathered by the LH_E_APHYBD_2024 script. The data consists of HWR and HWM 2024 Metrics for State of Maryland (ALL_PAYER).

**Description:** Lighthouse eMeasures All Payer Hybrid 2024 Metrics  
**Table type:** ACTIVITY  
...
| 49 | `LH_E_APHYBD_2024_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_APHYBD_2024_METRICS table. |
