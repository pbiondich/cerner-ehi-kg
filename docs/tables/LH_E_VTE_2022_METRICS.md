# LH_E_VTE_2022_METRICS

> Stores data gathered by the LH_E_VTE_2022 script.

**Description:** Lighthouse eMeasures VTE 2022 Metrics  
**Table type:** ACTIVITY  
...
| 68 | `LH_E_VTE_2022_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_VTE_2022_METRICS table. |
