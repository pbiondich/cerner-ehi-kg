...
> Transactions from ESO for standard batch interfaces are placed in this table and read by the outbound comserver.
...
| 4 | `CONTRIBUTOR_ID` | DOUBLE | NOT NULL |  | This is the value of hte unique primary identifier of the CQM contributor configuration table. It is an internal system assigned number. |
...
| 20 | `TRIG_MODULE_IDENTIFIER` | VARCHAR(16) |  |  | Trigger Module Identifier. |
