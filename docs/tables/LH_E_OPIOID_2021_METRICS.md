# LH_E_OPIOID_2021_METRICS

> Stores data gathered by the LH_E_OPIOID_2021 script.

**Description:** Lighthouse eMeasures Safe Use of Opioids 2021 Metrics  
**Table type:** ACTIVITY  
...
| 30 | `LH_E_OPIOID_2021_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_OPIOID_2021_METRICS table. |
...
| 44 | `SCHED_OP_DISCH_1_DT_TM` | DATETIME |  |  | The earliest date/time of medication discharge documented for Schedule II and III Opioid Medications |
| 45 | `SCHED_OP_DISCH_2_DT_TM` | DATETIME |  |  | The second earliest date/time of medication discharge documented for Schedule II and III Opioid Medications |
