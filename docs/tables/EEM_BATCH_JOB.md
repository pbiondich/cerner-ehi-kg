...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EEM_BATCH_ID` | DOUBLE | NOT NULL | FK→ | eem batch identifier |
| 2 | `EEM_BATCH_JOB_ID` | DOUBLE | NOT NULL |  | eem batch job identifier |
| 3 | `EEM_JOB_ID` | DOUBLE | NOT NULL | FK→ | eem job identifier |
