...
> This table reference the types of Counts to be performed e.g # of complications, # of Lesions etc.
...
| 6 | `COUNT_DESCRIPTION` | VARCHAR(50) |  |  | Descripes the types of different countsColumn |
| 7 | `COUNT_DESCRIPTION_KEY` | VARCHAR(50) |  |  | This descripes different types of count. It is capitalized and indexed for quick search routine |
| 8 | `COUNT_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the cv_count table. It is an internal system assigned number. |
...
| 13 | `PARENT_ENTITY_NAME` | VARCHAR(50) |  |  | Name of the Parent tableColumn |
