# PROV_PROB_PARTICIPANT

> Stores Participant information associated to the provenance PROBLEM concept

**Description:** Provenance PROBLEM Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_PROBLEM_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Problem table. |
| 9 | `PROV_PROB_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
