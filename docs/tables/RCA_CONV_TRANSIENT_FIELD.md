...
> Represents a transient field for a registration conversation within the Revenue Cycle Solution.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CODE_SET` | DOUBLE | NOT NULL |  | The code set number of the transient field if the transient field type meaning is CODE. |
| 2 | `CONV_FORM_TYPE_MEAN` | VARCHAR(100) | NOT NULL |  | The meaning of the conversation form type the field will be transient within. |
| 3 | `FIELD_TYPE_MEAN` | VARCHAR(100) | NOT NULL |  | The meaning of the type of transient field. |
...
| 5 | `RCA_CONV_TRANSIENT_FIELD_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the RCA_CONV_TRANSIENT_FIELD table. |
| 6 | `TRANSIENT_FIELD_KEY_TXT` | VARCHAR(100) | NOT NULL |  | The textual key of the transient field. |
| 7 | `TRANSIENT_FIELD_NAME` | VARCHAR(100) | NOT NULL |  | The name of the transient field. |
