...
> Stores CDF_Meaning and Indicator_cd.
...
| 6 | `CDF_MEANING` | CHAR(12) |  |  | The actual string value for the cdf meaning.Column |
...
| 11 | `INDICATOR_CD` | DOUBLE | NOT NULL |  | Indicator's code value. cdf_meaning=INDICATOR, display = "indicator"Column |
| 12 | `TASK_ASSAY_CD` | DOUBLE | NOT NULL |  | The task Assay code of the clinical event. There is a cdf_meaning associated with the "task_assay_cd" . This allows the value of an event to be retrieved from the code_value table. |
