...
> Detail for the batch denial file table
...
| 5 | `BATCH_DENIAL_FILE_DETAIL_R_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 6 | `BATCH_DENIAL_FILE_R_ID` | DOUBLE | NOT NULL | FK→ | Foreign Key to Batch_Denial_File_R table |
...
| 9 | `REMARK_CODE_ATTRIB_CD` | DOUBLE | NOT NULL |  | Remark Code Attribute |
| 10 | `REMARK_CODE_ATTRIB_VALUE` | VARCHAR(50) |  |  | value for the attribute identified by the remark_code_attrib_cd |
...
|--------|--------------|---------------|
| `BATCH_DENIAL_FILE_R_ID` | [BATCH_DENIAL_FILE_R](BATCH_DENIAL_FILE_R.md) | `BATCH_DENIAL_FILE_R_ID` |
