...
> Defines a historical record of a dataset of reference data in a growth chart
...
| 9 | `CHART_DEFINITION_ID` | DOUBLE | NOT NULL |  | This is the foreign key to the CHART_DEFINITION table. Each dataset belongs to exactly one chart definition. |
| 10 | `DISPLAY_NAME` | VARCHAR(60) | NOT NULL |  | This is the display name of the dataset. |
| 11 | `DISPLAY_TYPE_CD` | DOUBLE | NOT NULL |  | This indicates the type of line to be displayed for this dataset. |
...
| 13 | `REF_DATASET_ID` | DOUBLE | NOT NULL | FK→ | This will be the table's primary key. Foreign Key from REF_DATASET |
