...
> This table stores bill template selection information

**Description:** BILL TEMPLATE SELECTION  
**Table type:** REFERENCE  
**Primary key:** `BT_SELECTION_ID`  
**Columns:** 16  
...
| 6 | `BILL_TEMPL_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to bill_templ table |
| 7 | `BT_SELECTION_ID` | DOUBLE | NOT NULL | PK | Unique identifier of this table |
| 8 | `CONDITION_NAME` | VARCHAR(30) |  |  | Name of bill template selection condition |
...
| 10 | `PARENT_BT_SELECTION_ID` | DOUBLE | NOT NULL | FK→ | Provides parent/child relationships for records |
| 11 | `PRIORITY_SEQ` | DOUBLE | NOT NULL |  | Priority sequence of selection record |
...
| `PARENT_BT_SELECTION_ID` | [BT_SELECTION](BT_SELECTION.md) | `BT_SELECTION_ID` |

## Referenced by (2)

| From table | Column |
|------------|--------|
| [BT_SELECTION](BT_SELECTION.md) | `PARENT_BT_SELECTION_ID` |
| [BT_SELECTION_CRIT](BT_SELECTION_CRIT.md) | `BT_SELECTION_ID` |
