...
> Table containing the qualifying encounters for Meaningful Use NQF Stage 2 2020

**Description:** LH_AMB_QUAL_ENCNTR_2020  
**Table type:** ACTIVITY  
**Primary key:** `HEALTH_SYSTEM_SOURCE_ID`, `LH_AMB_QUAL_ENCNTR_2020_ID`  
**Columns:** 62  
...
| 3 | `BR_DATAM_VSET_ITEM_NEG_ID` | DOUBLE | NOT NULL |  | References the negation in BR_DATAM_VAL_SET_ITEM. |
...
| 20 | `LH_AMB_QUAL_ENCNTR_2020_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the LH_AMB_QUAL_ENCNTR_2020 table. |
...
| From table | Column |
|------------|--------|
| [LH_AMB_EP_RELTN_2020](LH_AMB_EP_RELTN_2020.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| [LH_AMB_EP_RELTN_2020](LH_AMB_EP_RELTN_2020.md) | `LH_AMB_QUAL_ENCNTR_2020_ID` |
