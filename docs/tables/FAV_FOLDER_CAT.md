...
> This table stores the parent level user defined folders.
...
| 5 | `CHILD_CAT_IND` | DOUBLE | NOT NULL |  | Child category indicator |
| 6 | `DESCRIPTION` | VARCHAR(200) | NOT NULL |  | Description |
