...
> Stores information about entities associated to the provenanceMICROBIOLOGY concept

**Description:** PROV_MICRO_ENTITY  
**Table type:** ACTIVITY  
**Primary key:** `PROV_MICRO_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_MICROBIOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_MICROBIOLOGY table. |
| 7 | `PROV_MICRO_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_MICROBIOLOGY_ID` | [PROVENANCE_MICROBIOLOGY](PROVENANCE_MICROBIOLOGY.md) | `PROVENANCE_MICROBIOLOGY_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_MICRO_ENTY_PRTCPNT](PROV_MICRO_ENTY_PRTCPNT.md) | `PROV_MICRO_ENTITY_ID` |
