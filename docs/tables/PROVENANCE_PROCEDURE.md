...
> Stores provenance information for the prcedures concept

**Description:** Provenance for procedures  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_PROCEDURE_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (PROCEDURE - PROCEDURE_EXT_DATA) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_PROCEDURE_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_PROC_ENTITY](PROV_PROC_ENTITY.md) | `PROVENANCE_PROCEDURE_ID` |
| [PROV_PROC_PARTICIPANT](PROV_PROC_PARTICIPANT.md) | `PROVENANCE_PROCEDURE_ID` |
