...
| 8 | `PROV_VITAL_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_VITAL_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_VITAL_ENTITY_ID` | [PROV_VITAL_ENTITY](PROV_VITAL_ENTITY.md) | `PROV_VITAL_ENTITY_ID` |
