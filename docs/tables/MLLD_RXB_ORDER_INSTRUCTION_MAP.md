# MLLD_RXB_ORDER_INSTRUCTION_MAP
...
**Description:** MLLD_RXB_ORDER_INSTRUCTION_MAP  
...
| 2 | `INSTRUCTION_DICTIONARY_ID` | DOUBLE | NOT NULL |  | This field contains an identifier that represents a prescription instruction such as "with food". |
