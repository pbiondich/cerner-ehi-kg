...
> Stores information about entities associated to the provenance ORDERS concept

**Description:** Provenance ORDERS Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_ORDER_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_ORDER_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Order table. |
| 7 | `PROV_ORDER_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_ORDER_ID` | [PROVENANCE_ORDER](PROVENANCE_ORDER.md) | `PROVENANCE_ORDER_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_ORDER_ENTY_PRTCPNT](PROV_ORDER_ENTY_PRTCPNT.md) | `PROV_ORDER_ENTITY_ID` |
