# PROV_PATH_PARTICIPANT

> Stores Participant information associated to the provenance PATHOLOGY concept

**Description:** PROV_PATH_PARTICIPANT  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_PATHOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_PATHOLOGY table. |
| 9 | `PROV_PATH_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
