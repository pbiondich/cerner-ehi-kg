...
> Tracks orderables capable of triggering a case.
...
| 4 | `CATALOG_CD` | DOUBLE | NOT NULL |  | Stores the orderable procedure that represents the trigger. |
...
| 6 | `UCMR_CASE_TRIGGER_ID` | DOUBLE | NOT NULL |  | Uniquely identifies an orderable capable of triggering a case. |
| 7 | `UCMR_CASE_TYPE_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the case type associated with this record. |
