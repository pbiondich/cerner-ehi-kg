# LH_E_HWR_2021_METRICS

> Stores data gathered by the LH_E_HWR_2021 script.

**Description:** Lighthouse eMeasures HWR 2021 Metrics  
**Table type:** ACTIVITY  
...
| 44 | `LAST_PROCESS_DT_TM` | DATETIME |  |  | The date/time that the last ETL process started that updated this record. |
| 45 | `LH_E_HWR_2021_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_HWR_2021_METRICS table. |
...
| 47 | `O2_SAT_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first O2 saturation in arterial blood by pulse oximetry recorded for the episode of care. |
| 48 | `O2_SAT_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first O2 saturation in arterial blood by pulse oximetry recorded for the episode of care. |
| 49 | `OBS_SERV_ARRIVAL_DT_TM` | DATETIME |  |  | The start of the observation encounter. |
| 50 | `OBS_SERV_DEPART_DT_TM` | DATETIME |  |  | The end of the observation encounter. |
| 51 | `OBS_SERV_ENCNTR_ID` | DOUBLE | NOT NULL |  | The ID of the observation services encounter associated to the record. |
| 52 | `ORG_MRN_TXT` | VARCHAR(50) |  |  | Medical Record Number of the record. |
| 53 | `PARTITION_DT_TM` | DATETIME |  |  | The date/time the encounter was discharged from the facility. |
| 54 | `PATIENT_IDENT` | VARCHAR(50) |  |  | Identifies the earliest documented medical record number of the patient. |
...
| 60 | `POTAS_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first potassium lab test for the episode of care. |
| 61 | `POTAS_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first potassium lab test for the episode of care. |
| 62 | `RESP_RATE_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first respiratory rate recorded for the episode of care. |
| 63 | `RESP_RATE_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first respiratory rate recorded for the episode of care. |
| 64 | `RESULT_IND` | DOUBLE |  |  | Indicates that at least one of the results exists. |
| 65 | `SBP_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first systolic blood pressure recorded for the episode of care. |
| 66 | `SBP_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first systolic blood pressure recorded for the episode of care. |
| 67 | `SCRIPT_VERSION` | DOUBLE |  |  | The version number of the script that populated the row |
| 68 | `SOD_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first sodium lab test for the episode of care. |
| 69 | `SOD_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first sodium lab test for the episode of care. |
| 70 | `SRC_UPDT_DT_TM` | DATETIME |  |  | The date and time the row was last inserted or updated to be preserved during extracts. |
| 71 | `SRC_UPDT_SOURCE` | VARCHAR(50) |  |  | The script name responsible for updating the record to be preserved during extracts. |
| 72 | `TIMEZONE_TXT` | VARCHAR(300) |  |  | The timezone of the record in ""America/Chicago"" format. |
...
| 77 | `WBC_LAB_RSLT_DT_TM` | DATETIME |  |  | The date/time of the first white blood cells count lab test for the episode of care. |
| 78 | `WBC_LAB_RSLT_TXT` | VARCHAR(30) |  |  | The result of the first white blood cells count lab test for the episode of care. |
