...
> Stores the mapping between the ECG Classification Statements and Normalcy Indicator
...
| 2 | `ACTIVITY_SUBTYPE_CD` | DOUBLE | NOT NULL |  | Used to determine for what modality (Activity sub type) the corresponding interpretation would be used to calculate the normalcy |
...
| 4 | `CLASSIFICATION_STATEMENT` | VARCHAR(400) | NOT NULL |  | System generated/Cardiologist provided interpretation of the study |
| 5 | `CV_NORMALCY_CLASSIFICATION_ID` | DOUBLE | NOT NULL |  | Primary Key |
...
| 7 | `NORMALCY_INDICATOR_CD` | DOUBLE | NOT NULL |  | States whether the result is normal, critical or abnormal. |
