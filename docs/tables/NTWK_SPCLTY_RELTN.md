...
> Makes one to many relationship between a network and specialties.
...
| 10 | `NETWORK_ID` | DOUBLE | NOT NULL |  | unique identifier for the network table |
| 11 | `NTWK_SPCLTY_RELTN_ID` | DOUBLE | NOT NULL |  | Unique Identifier for the ntwk_spclty_reltn table |
| 12 | `SPECIALTY_CD` | DOUBLE | NOT NULL |  | Code value that describes a person_provider's specialty within a specified provider |
