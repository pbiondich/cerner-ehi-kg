...
> Table used to store RxBuilder information for a frequency and duration factor.
...
| From table | Column |
|------------|--------|
| [MLTM_RXB_CALC_DISP_RULE_ORDMAP](MLTM_RXB_CALC_DISP_RULE_ORDMAP.md) | `FREQUENCY_DURATION_RULE_ID` |
| [MLTM_RXB_CALC_DUR_RULE_ORD_MAP](MLTM_RXB_CALC_DUR_RULE_ORD_MAP.md) | `FREQUENCY_DURATION_RULE_ID` |
