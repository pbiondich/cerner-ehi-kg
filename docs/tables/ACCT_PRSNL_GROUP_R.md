...
> Contains information about the relationship between an account and a personnel group.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCT_ID` | DOUBLE | NOT NULL | FK→ | Account ID - ProFit |
| 2 | `ACCT_PRSNL_GROUP_R_ID` | DOUBLE | NOT NULL |  | Account Personnel Group Relation ID |
...
| 9 | `PFT_PRSNL_GROUP_ID` | DOUBLE | NOT NULL | FK→ | ProFit Personnel Group ID |
