...
> Categorizes individual PRSNL IDs
...
| 5 | `PROVIDER_SEQUENCE` | DOUBLE | NOT NULL |  | The sequence of the provider in the category |
| 6 | `PRSNL_ID` | DOUBLE | NOT NULL |  | Provider Id for person being categorized |
| 7 | `SA_REF_CAT_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Category provider belongs to |
| 8 | `SA_REF_CAT_PRSNL_PROVIDER_ID` | DOUBLE | NOT NULL |  | Unique identifier for row |
