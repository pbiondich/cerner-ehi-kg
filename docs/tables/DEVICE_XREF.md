...
> Lists hardware devices resident on the system.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DEVICE_CD` | DOUBLE | NOT NULL |  | Device code specific to host type |
| 2 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | Parent entity id for device |
| 3 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | name of parent entity device |
...
| 9 | `USAGE_TYPE_CD` | DOUBLE | NOT NULL |  | Unit of measure code |
