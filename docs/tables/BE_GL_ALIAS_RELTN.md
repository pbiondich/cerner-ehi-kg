...
> Contains information about the relationship between a Billing Entity and a General Ledger Alias.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCT_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the related account. |
...
| 7 | `BE_GL_ALIAS_RELTN_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 8 | `BILLING_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | FK to the billing_entity table |
...
| 10 | `GL_ALIAS_ID` | DOUBLE | NOT NULL | FK→ | FK to the gl_alias table |
| 11 | `LOCATION_CD` | DOUBLE | NOT NULL |  | Location code related to the given GL alias. |
