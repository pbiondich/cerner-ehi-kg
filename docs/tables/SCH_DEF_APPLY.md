...
> Contains the instance on which a default schedule was applied to a resource.

**Description:** Scheduling Default Apply  
**Table type:** ACTIVITY  
**Primary key:** `DEF_APPLY_ID`  
**Columns:** 27  
...
| 5 | `APPLY_DT_TM` | DATETIME | NOT NULL |  | Date and Time the default schedule application string was applied. |
| 6 | `APPLY_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | The PERSON_ID of the person from the personnel table (PRSNL) that performed the action. |
...
| 10 | `DAYS_OF_WEEK` | VARCHAR(10) | NOT NULL |  | A 7-char string representing the days of the week. |
| 11 | `DEF_APPLY_ID` | DOUBLE | NOT NULL | PK | The unique identifier for the default schedule application. |
| 12 | `DEF_SCHED_ID` | DOUBLE | NOT NULL | FK→ | The identifier for a default schedule. |
| 13 | `DEF_STATE_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the current state of the default schedule application. |
| 14 | `DEF_STATE_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the default schedule state. |
| 15 | `END_DT_TM` | DATETIME | NOT NULL |  | End Date and Time value |
...
| 17 | `FREQUENCY_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for a scheduling frequency. |
| 18 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The location associcted to the scheduling default template. |
| 19 | `NULL_DT_TM` | DATETIME | NOT NULL |  | contains 31-DEC-2100 00:00:00.00 |
| 20 | `RESOURCE_CD` | DOUBLE | NOT NULL | FK→ | The identifier for the resource. A resource is an item of limited availability. |
| 21 | `SCH_CLINIC_ID` | DOUBLE | NOT NULL | FK→ | Clinic Id assoiciated to the location and schedule. |
...
| From table | Column |
|------------|--------|
| [SCH_APPLY_LIST](SCH_APPLY_LIST.md) | `DEF_APPLY_ID` |
| [SCH_DISPLACED_APPT](SCH_DISPLACED_APPT.md) | `DEF_APPLY_ID` |
