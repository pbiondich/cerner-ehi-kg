...
> GLOBAL TEMPORARY TABLE FOR ADS EXTRACT
...
| 4 | `DM_ADS_EXTRACT_ID` | DOUBLE | NOT NULL |  | Sequence based unique identifier for table. |
...
| 18 | `WHERE_CLAUSE` | VARCHAR(4000) |  |  | The where_clause the extract will use to get the intended data, either for an activity based sample, referenced-mixed data,etc.. |
