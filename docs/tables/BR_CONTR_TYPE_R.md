...
> This table stores the HL7 inteface types chosen for each contributor system
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `BR_CONTR_TYPE_R_ID` | DOUBLE | NOT NULL |  | Unique ID |
...
| 3 | `INTERFACE_TYPE` | VARCHAR(60) | NOT NULL |  | the type of HL7 interface, i.e. ADT, Orders, Results |
| 4 | `IN_OUT_FLG` | DOUBLE | NOT NULL |  | the interface direction - 1=inbound, 2=outbound, 3=both |
