...
> The root of the data base. Simply serves as the anchor in a hierarchical format.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ENTRY_ID` | DOUBLE | NOT NULL |  | Entry id of the root. |
...
| 7 | `VALUE` | VARCHAR(64) | NOT NULL |  | An upper case version of the value is stored for string comparison purposes for an equality search. |
