...
> Contains information about the payment plan

**Description:** Profit payment plan  
**Table type:** ACTIVITY  
**Primary key:** `PFT_PAYMENT_PLAN_ID`  
**Columns:** 31  
...
| 8 | `BILLING_ENTITY_GROUP_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the related billing entity group. |
...
| 20 | `MINIMUM_INSTALLMENT_AMT` | DOUBLE |  |  | This table stores the minimum instalment amount. |
| 21 | `NUMBER_OF_PAYMENTS` | DOUBLE |  |  | The number of payments that will be made under the current plan. |
| 22 | `OVERRIDE_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | This stores the overridding fpp installment amount person identifier. |
...
| 25 | `PFT_PAYMENT_PLAN_ID` | DOUBLE | NOT NULL | PK | The unique identifier to the table |
| 26 | `TOTAL_AMOUNT_DUE` | DOUBLE | NOT NULL |  | The total amount due when the formal payment plan originated |
...
| From table | Column |
|------------|--------|
| [BATCH_TRANS_FILE](BATCH_TRANS_FILE.md) | `PFT_PAYMENT_PLAN_ID` |
| [CREDIT_CARD_RELTN](CREDIT_CARD_RELTN.md) | `PFT_PAYMENT_PLAN_ID` |
| [EXT_PAY_PLAN_PE_RELTN](EXT_PAY_PLAN_PE_RELTN.md) | `PFT_PAYMENT_PLAN_ID` |
| [PFT_PAY_PLAN_HIST](PFT_PAY_PLAN_HIST.md) | `PFT_PAYMENT_PLAN_ID` |
| [PFT_PAY_PLAN_PE_RELTN](PFT_PAY_PLAN_PE_RELTN.md) | `PFT_PAYMENT_PLAN_ID` |
