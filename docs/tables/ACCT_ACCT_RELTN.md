...
> Contains information about the relationship between accounts.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCT_ACCT_RELTN_ID` | DOUBLE | NOT NULL |  | Account Account Relation |
| 2 | `ACCT_REASON_CD` | DOUBLE | NOT NULL |  | Account Reason |
...
| 9 | `PRIMARY_ACCT_ID` | DOUBLE | NOT NULL |  | Primary Account ID |
| 10 | `RELATED_ACCT_ID` | DOUBLE | NOT NULL |  | Related Account ID |
