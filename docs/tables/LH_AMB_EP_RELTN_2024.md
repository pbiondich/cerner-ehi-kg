# LH_AMB_EP_RELTN_2024

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2024.

**Description:** LH_AMB_EP_RELTN_2024  
**Table type:** ACTIVITY  
...
| 10 | `LH_AMB_EP_RELTN_2024_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2024 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2024_ID` | DOUBLE |  | FK→ | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2024 that matches. |
...
|--------|--------------|---------------|
| `HEALTH_SYSTEM_SOURCE_ID` | [LH_AMB_QUAL_ENCNTR_2024](LH_AMB_QUAL_ENCNTR_2024.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| `LH_AMB_QUAL_ENCNTR_2024_ID` | [LH_AMB_QUAL_ENCNTR_2024](LH_AMB_QUAL_ENCNTR_2024.md) | `LH_AMB_QUAL_ENCNTR_2024_ID` |
