...
> This table holds the possible values associated to a preference entry. The preference service management application restricts values to this set when adding or modifying values.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ENTRY_ID` | DOUBLE | NOT NULL |  | Entry id that we are setting allowed values for. |
...
| 7 | `VALUE` | VARCHAR(2000) | NOT NULL |  | Normalized attribute values |
