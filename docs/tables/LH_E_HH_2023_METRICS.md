...
> Stores data gathered by the LH_E_HH_2023 script.
...
| 66 | `LH_E_HH_2023_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_HH_2023_METRICS table. |
