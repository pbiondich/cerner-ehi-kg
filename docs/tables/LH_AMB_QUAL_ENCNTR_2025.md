# LH_AMB_QUAL_ENCNTR_2025

> Table containing the qualifying encounters for Meaningful Use NQF Stage 2 2025

**Description:** LH_AMB_QUAL_ENCNTR_2025  
**Table type:** ACTIVITY  
**Primary key:** `HEALTH_SYSTEM_SOURCE_ID`, `LH_AMB_QUAL_ENCNTR_2025_ID`  
**Columns:** 62  
...
| 7 | `D_PERSON_ID` | DOUBLE | NOT NULL |  | Identifies the person associated with the quality measure. Foreign key to the LH_D_PERSON table. |
...
| 17 | `HEALTH_SYSTEM_SOURCE_ID` | DOUBLE | NOT NULL | PK | Identifies the unique source within the delivery network responsible for supplying the data. |
...
| 20 | `LH_AMB_QUAL_ENCNTR_2025_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the LH_AMB_QUAL_ENCNTR_2025 table. |
...
| 23 | `NEGATION_IND` | DOUBLE | NOT NULL |  | Indicates whether the given result code is a negation or not (QRDA) |
...
| 45 | `PQRS_IND` | DOUBLE | NOT NULL |  | Indicates whether the patient qualifies for PQRS. |
...
| From table | Column |
|------------|--------|
| [LH_AMB_EP_RELTN_2025](LH_AMB_EP_RELTN_2025.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| [LH_AMB_EP_RELTN_2025](LH_AMB_EP_RELTN_2025.md) | `LH_AMB_QUAL_ENCNTR_2025_ID` |
