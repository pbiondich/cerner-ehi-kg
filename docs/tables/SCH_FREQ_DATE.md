...
> The table hold the information about the instance of recurring entity in sch_freq table.
...
| 7 | `DATE_DT_TM` | DATETIME | NOT NULL |  | The date and time generated for this instance of a frequency. |
...
| 9 | `FREQUENCY_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for a scheduling frequency. |
| 10 | `INSTANCE_STATUS_CD` | DOUBLE | NOT NULL |  | Indicates the instance status. Some examples are Active, Scheduled or Requested. |
...
| 12 | `OCCURANCE` | DOUBLE | NOT NULL |  | The sequence of the object in an ordered list. (1 of 2, etc.) |
| 13 | `SCH_ACTION_ID` | DOUBLE | NOT NULL | FK→ | The identifier to uniquely identify the action being performed. |
| 14 | `SCH_EVENT_RECUR_LIST_ID` | DOUBLE | NOT NULL | FK→ | The ID of the row from the SCH_EVENT_RECUR_LIST table that is associated to the frequency date. |
...
| `SCH_ACTION_ID` | [SCH_ACTION](SCH_ACTION.md) | `SCH_ACTION_ID` |
