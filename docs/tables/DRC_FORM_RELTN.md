...
> Table stores current relationships between a Formulation to a DOSE_RANGE_CHECK_ID. The table is initially populated with Multum content but a client has the ability to modify the Multum content and build their own.
...
| 4 | `DRC_FORM_RELTN_ID` | DOUBLE | NOT NULL |  | Unique identifier |
