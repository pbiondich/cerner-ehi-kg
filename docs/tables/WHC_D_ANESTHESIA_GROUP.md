# WHC_D_ANESTHESIA_GROUP

> A Dimension Group table to allow the connection the Fact table row to many Anesthesia Dimensions via the Bridge Table relationship

**Description:** WHC_D_ANESTHESIA_GROUP  
**Table type:** REFERENCE  
**Primary key:** `WHC_D_ANESTHESIA_GROUP_ID`  
**Columns:** 6  
...
| 6 | `WHC_D_ANESTHESIA_GROUP_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
| From table | Column |
|------------|--------|
| [WHC_D_ANESTHESIA_BRIDGE](WHC_D_ANESTHESIA_BRIDGE.md) | `WHC_D_ANESTHESIA_GROUP_ID` |
| [WHC_F_CHILD](WHC_F_CHILD.md) | `ANESTHESIA_GROUP_ID` |
| [WHC_F_DELIVERY](WHC_F_DELIVERY.md) | `ANESTHESIA_GROUP_ID` |
