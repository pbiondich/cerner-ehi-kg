...
> Scheduling Resource Group Types
...
| 9 | `RES_GROUP_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the scheduling resource group type. |
| 10 | `RES_GROUP_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for the resource group. |
| 11 | `RES_GROUP_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the scheduling resource group type. |
...
|--------|--------------|---------------|
| `RES_GROUP_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
