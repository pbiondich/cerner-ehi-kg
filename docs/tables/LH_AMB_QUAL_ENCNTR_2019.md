...
> Table containing the qualifying encounters for Meaningful Use NQF Stage 2 2019
...
| 20 | `LH_AMB_QUAL_ENCNTR_2019_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_QUAL_ENCNTR_2019 table. |
