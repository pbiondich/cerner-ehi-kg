...
> A Dimension Group table to allow the connection the Fact table row to many Induction Method Dimensions via the Bridge Table relationship

**Description:** WHC_D_INDCTN_METHOD_GROUP  
**Table type:** REFERENCE  
**Primary key:** `WHC_D_INDCTN_METHOD_GROUP_ID`  
**Columns:** 6  
...
| 6 | `WHC_D_INDCTN_METHOD_GROUP_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
| From table | Column |
|------------|--------|
| [WHC_D_INDCTN_METHOD_BRIDGE](WHC_D_INDCTN_METHOD_BRIDGE.md) | `WHC_D_INDCTN_METHOD_GROUP_ID` |
| [WHC_F_DELIVERY_CHILD](WHC_F_DELIVERY_CHILD.md) | `INDUCTION_METHOD_GROUP_ID` |
