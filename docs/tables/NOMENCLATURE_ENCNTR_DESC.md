...
> This stores nomenclature id, encounter id and a description
...
| 6 | `DESCRIPTION` | VARCHAR(255) |  |  | This is the users description for this nomenclature code for this encounter. |
...
| 10 | `NOMENCLATURE_ENCNTR_DESC_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the nomenclature encounter description table. It is an internal system assigned number |
| 11 | `NOMENCLATURE_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the nomenclature table. It is an internal system assigned number |
...
| 13 | `SVC_CAT_HIST_ID` | DOUBLE | NOT NULL | FK→ | This is the unique identifier for the service category history table. |
