...
> This table will be used to group MPage Worklist related settings

**Description:** mp_worklist_criteria  
**Table type:** REFERENCE  
**Primary key:** `WL_CRITERIA_ID`  
**Columns:** 14  
...
| 2 | `CRITERIA_NAME` | VARCHAR(100) | NOT NULL |  | The name of the worklist criteria group |
| 3 | `CRITERIA_NAME_KEY` | VARCHAR(100) | NOT NULL |  | The name_key of the worklist criteria grouping. |
...
| 6 | `LONG_TEXT_ID` | DOUBLE | NOT NULL | FK→ | Criteria as defined in the LONG_TEXT_REFERENCE table |
| 7 | `ORIG_WL_CRITERIA_ID` | DOUBLE | NOT NULL | FK→ | The original WL_CRITERIA_ID which is used to group versions |
...
| 13 | `WL_CRITERIA_ID` | DOUBLE | NOT NULL | PK | PRIMARY KEY |
| 14 | `WORKLIST_CD` | DOUBLE | NOT NULL |  | IDENTIFIES THE TYPE OF WORKLIST |
...
| `ORIG_WL_CRITERIA_ID` | [WL_CRITERIA](WL_CRITERIA.md) | `WL_CRITERIA_ID` |

## Referenced by (2)

| From table | Column |
|------------|--------|
| [WL_ACTIVITY](WL_ACTIVITY.md) | `WL_CRITERIA_ID` |
| [WL_CRITERIA](WL_CRITERIA.md) | `ORIG_WL_CRITERIA_ID` |
