# WH_BR_CPC_ELIG_PROV_RELTN

> This table Stores the relationship between CPCs and eligible providers.

**Description:** WH_BR_CPC_ELIG_PROV_RELTN  
**Table type:** ACTIVITY  
...
| 3 | `BR_CPC_ELIG_PROV_RELTN_ID` | DOUBLE | NOT NULL |  | Unique, generated number that identifies a single row on the BR_CPC_ELIG_PROV_RELTN table. |
| 4 | `BR_CPC_ID` | DOUBLE | NOT NULL |  | The CPC group that this eligible provider belongs to. |
| 5 | `BR_ELIGIBLE_PROVIDER_ID` | DOUBLE | NOT NULL |  | The eligible provider that is a part of this CPC group. |
...
| 12 | `ORIG_BR_CPC_ELIG_PROV_RELTN_ID` | DOUBLE | NOT NULL |  | Used for versioning. Contains the original PK value for BR_CPC_ELIG_PROV_RELTN_ID |
