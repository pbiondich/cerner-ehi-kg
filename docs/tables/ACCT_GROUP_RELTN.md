...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCT_GROUP_R_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 2 | `ACCT_ID` | DOUBLE | NOT NULL | FK→ | Foreign Key to the Account table. |
...
| 8 | `BT_COND_CRIT_R_ID` | DOUBLE | NOT NULL |  | Foreign Key to the BT_Cond_Crit_Reltn table. |
