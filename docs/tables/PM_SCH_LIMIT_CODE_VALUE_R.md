...
> Contains the search limit for specific code values.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `LIMIT_CD` | DOUBLE |  |  | Code value to be limited. |
| 2 | `PM_SCH_LIMIT_CODE_VALUE_R_ID` | DOUBLE | NOT NULL |  | A system generated number used to uniquely identify a row on the PM_SCH_LIMIT_CODE_VALUE_R table. |
| 3 | `SETUP_ID` | DOUBLE |  | FK→ | Uniquely identifies the related row on the PM_SHC_SETUP table. |
