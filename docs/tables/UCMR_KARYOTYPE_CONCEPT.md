...
> This table contains the relationships between concept and a karyotype template.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DESCRIPTOR_CD` | DOUBLE | NOT NULL |  | Identifies the corresponding descriptor. |
...
| 6 | `SECTION_NBR` | DOUBLE | NOT NULL |  | Section of the karyotype where the concept originated from. |
| 7 | `UCMR_KARYOTYPE_CONCEPT_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a relationship between a concept and a karyotype template. |
| 8 | `UCMR_KARYOTYPE_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the karyotype template corresponding to this row. |
