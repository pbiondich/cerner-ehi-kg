...
> This table stores the susceptibility panel(s) associated with an individual breakpoint worklist.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `PANEL_CD` | DOUBLE | NOT NULL |  | Internal identification code for the susceptibility panel. (CS 1010) |
...
| 7 | `WORKLIST_ID` | DOUBLE | NOT NULL | FK→ | Internal identification code assigned to each breakpoint worklist. |
