...
> Table to store the position assigned to a role type.
...
| 9 | `POSITION_CD` | DOUBLE | NOT NULL |  | position code |
| 10 | `POSITION_ROLE_TYPE_ID` | DOUBLE | NOT NULL |  | position role type identifier |
