...
> Table to store user logons of bedrock wizards
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `BR_WIZARD_HIST_ID` | DOUBLE | NOT NULL |  | Unique id for the table |
| 2 | `LOG_DT_TM` | DATETIME |  |  | Date and time the user logged into the wizard |
| 3 | `PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Unique id of the user that logged into the wizard |
| 4 | `SOLUTION_MEAN` | VARCHAR(100) |  |  | Solution meaning column |
...
| 10 | `WIZARD_MEAN` | VARCHAR(100) |  |  | Wizard meaning column |
