...
> This table Stores a group of personnel that are associated to a particular CCN.
...
| 3 | `BR_CCN_ID` | DOUBLE | NOT NULL |  | The CCN that is associated to this personnel. |
| 4 | `BR_PRSNL_CCN_RELTN_ID` | DOUBLE | NOT NULL |  | Unique, generated number that identifies a single row on the BR_PRSNL_CCN_RELTN table. |
...
| 11 | `PRSNL_GROUP_RELTN_ID` | DOUBLE | NOT NULL |  | The Personnel Group that this personnel for this CCN is part of. |
