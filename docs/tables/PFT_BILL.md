...
| 5 | `BALANCE_DUE` | DOUBLE |  |  | Balance Due |
| 6 | `BALANCE_FWD` | DOUBLE |  |  | Balance Forward |
| 7 | `BAL_DUE_DR_CR_FLAG` | DOUBLE | NOT NULL |  | Debit or Credit flag for the Balance_due field |
| 8 | `BAL_FWD_DR_CR_FLAG` | DOUBLE | NOT NULL |  | Debit or credit flag for the Balance_fwd field |
...
| 10 | `BILL_VRSN_NBR` | DOUBLE | NOT NULL | FK→ | Part of Primary Key |
| 11 | `CORSP_ACTIVITY_ID` | DOUBLE | NOT NULL | FK→ | Correspondence Activity ID value |
...
| 13 | `INTERIM_BILL_FLAG` | DOUBLE |  |  | Interim Bill Flag |
| 14 | `NEW_AMOUNT` | DOUBLE |  |  | New Amount on Bill |
| 15 | `NEW_AMT_DR_CR_FLAG` | DOUBLE | NOT NULL |  | Debit or credit flag for the New_balance field |
| 16 | `PFT_BILL_ID` | DOUBLE | NOT NULL |  | Primary Key |
