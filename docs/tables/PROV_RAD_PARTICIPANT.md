...
> Stores Participant information associated to the provenance RADIOLOGY concept
...
| 8 | `PROVENANCE_RADIOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_RADIOLOGY table. |
| 9 | `PROV_RAD_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
