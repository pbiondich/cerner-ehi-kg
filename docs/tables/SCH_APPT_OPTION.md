...
> Scheduling Appointment Type Option
...
| 10 | `OPTION_MEANING` | VARCHAR(12) |  |  | A 12-char description corresponding to the Scheduling Processing Option Code |
| 11 | `SCH_OPTION_CD` | DOUBLE | NOT NULL | FK→ | A unique identifier of the Scheduling Processing Option |
...
| `SCH_OPTION_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
