...
> This table is used for defining quota for a location.
...
| 3 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The location the quota is for. |
| 4 | `SCH_LOC_QUOTA` | DOUBLE | NOT NULL |  | The quota for the location. |
| 5 | `SCH_LOC_QUOTA_ID` | DOUBLE | NOT NULL |  | The unique primary key of this table. |
| 6 | `SCH_LOC_QUOTA_OVERBOOK_QTY` | DOUBLE | NOT NULL |  | The number above sch_loc_quota that can be overbooked. |
