...
| 7 | `HEALTH_PLAN_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier in the health plan table for a health plan |
| 8 | `LOCATION_CD` | DOUBLE | NOT NULL |  | Location Code |
...
| 10 | `PFT_PRSNL_ALIAS_ID` | DOUBLE | NOT NULL |  | ProFit Personnel Alias ID |
| 11 | `PRSNL_ALIAS` | VARCHAR(250) |  |  | Personnel Alias |
| 12 | `PRSNL_ALIAS_TYPE_CD` | DOUBLE | NOT NULL |  | Personnel Alias Type Code |
