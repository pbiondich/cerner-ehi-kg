...
| 6 | `BT_COND_CRIT_R_ID` | DOUBLE | NOT NULL | FK→ | Bill Template Condition Criteria ID |
...
| 8 | `ORGANIZATION_ID` | DOUBLE | NOT NULL | FK→ | Organization ID |
| 9 | `ORG_GROUP_R_ID` | DOUBLE | NOT NULL |  | Organization Group Relation ID |
| 10 | `ORG_TYPE_CD` | DOUBLE | NOT NULL |  | Organization Type Code |
