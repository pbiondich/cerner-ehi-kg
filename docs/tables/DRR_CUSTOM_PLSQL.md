...
> Reference table store custom PLSQL function
...
| 2 | `DRR_CUSTOM_PLSQL_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY. |
| 3 | `EXEC_ORDER` | DOUBLE | NOT NULL |  | execution order 0 -- execute before core process, 99 - execute after core process |
| 4 | `EXEC_STMT` | VARCHAR(200) | NOT NULL |  | statement execute for custom process |
| 5 | `PARENT_TABLE` | VARCHAR(30) |  |  | parent table name |
