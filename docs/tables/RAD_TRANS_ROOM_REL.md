...
> This table describles the relationship between a transporter and a default tranport location.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | Identifies the transport location associated with this relationship. |
