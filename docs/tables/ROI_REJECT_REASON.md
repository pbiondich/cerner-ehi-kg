...
> This table stores zero to many reject reasons for roi requests
...
| 6 | `CREATE_PRSNL_ID` | DOUBLE |  |  | This is the unique identifier for the person who created this row |
...
| 8 | `HIM_REQUEST_ID` | DOUBLE |  | FK→ | The ID of him_request |
| 9 | `LAST_UPDATE_PRSNL_ID` | DOUBLE |  |  | This is the unique identifier for the person who last updated this row |
| 10 | `REJECTED_REASON_CD` | DOUBLE |  |  | This is the reason that the roi request was rejected |
| 11 | `ROI_REJECT_REASON_ID` | DOUBLE | NOT NULL |  | This is the unique identifier for the table. |
| 12 | `ROI_REQUEST_ID` | DOUBLE |  | FK→ | This is the unique identifier for the roi request table |
