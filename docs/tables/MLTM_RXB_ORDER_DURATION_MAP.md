...
> Multum Rx Builder Order Duration Map Table
...
| 4 | `DURATION_DICTIONARY_ID` | DOUBLE | NOT NULL | FK→ | This field contains an identifier that represents the duration for a prescription, such as hours or days. |
...
| `DURATION_DICTIONARY_ID` | [MLTM_RXB_DICTIONARY](MLTM_RXB_DICTIONARY.md) | `DICTIONARY_ID` |
