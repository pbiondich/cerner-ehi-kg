# LH_E_STROKE_2021_METRICS

> Stores data gathered by the LH_E_STROKE_2021 script.

**Description:** Lighthouse eMeasures STK 2021 Metrics  
**Table type:** ACTIVITY  
...
| 68 | `LH_E_STROKE_2021_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_STROKE_2021_METRICS table. |
...
| 84 | `PERSON_ID` | DOUBLE | NOT NULL |  | The ID of the person associated to the record. |
