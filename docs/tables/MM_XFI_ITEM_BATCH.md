...
> Used to group a set of MM_XFI_ITEM rows for batch processing.
...
| 3 | `MM_XFI_ITEM_BATCH_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the MM_XFI_ITEM_BATCH table. |
