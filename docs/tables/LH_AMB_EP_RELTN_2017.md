# LH_AMB_EP_RELTN_2017

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2017

**Description:** LH_AMB_EP_RELTN_2017  
**Table type:** ACTIVITY  
...
| 10 | `LH_AMB_EP_RELTN_2017_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2017 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2017_ID` | DOUBLE | NOT NULL |  | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2017 that matches. |
