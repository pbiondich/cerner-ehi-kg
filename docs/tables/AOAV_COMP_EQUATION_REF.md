...
> AOAV COMPONENT EQUATION REFERENCE
...
| 2 | `AOAV_COMP_CD` | DOUBLE | NOT NULL |  | Code value for the AOAV component |
| 3 | `AOAV_COMP_EQUATION_REF_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 4 | `COEFFICIENT_VALUE` | DOUBLE |  |  | The coefficient value |
| 5 | `EQUATION_CD` | DOUBLE | NOT NULL |  | Code value for the AOAV equation |
