...
> The Temporary_Folder table contains information about temporary folders that exists within the image management area.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `SEQ_OBJECT_ID` | DOUBLE | NOT NULL | PK FK→ | The Seq_Object_Id is a foreign key to the Image_Class table. |
...
| From table | Column |
|------------|--------|
| [TEMPORARY_EXAM](TEMPORARY_EXAM.md) | `SEQ_OBJECT_ID` |
