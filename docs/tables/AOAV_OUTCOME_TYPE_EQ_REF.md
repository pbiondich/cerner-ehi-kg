# AOAV_OUTCOME_TYPE_EQ_REF

> Table that stores the type of outcome equations reference data

**Description:** AOAV OUTCOME TYPE EQUATION REFERENCE  
...
| 2 | `AOAV_OUTCOME_TYPE_CD` | DOUBLE | NOT NULL |  | Code value for the outcome type |
| 3 | `AOAV_OUTCOME_TYPE_EQ_REF_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 6 | `EQUATION_CD` | DOUBLE | NOT NULL |  | Code value for the equation |
| 7 | `EQUATION_VERSION_NBR` | DOUBLE |  |  | Version of the equation |
