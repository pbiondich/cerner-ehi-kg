# LH_AMB_EP_RELTN_2022

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2022.

**Description:** LH_AMB_EP_RELTN_2022  
**Table type:** ACTIVITY  
...
| 7 | `HEALTH_SYSTEM_ID` | DOUBLE |  |  | Identifies the delivery network responsible for supplying the data. |
...
| 10 | `LH_AMB_EP_RELTN_2022_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2022 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2022_ID` | DOUBLE |  | FK→ | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2022 that matches. |
...
|--------|--------------|---------------|
| `HEALTH_SYSTEM_SOURCE_ID` | [LH_AMB_QUAL_ENCNTR_2022](LH_AMB_QUAL_ENCNTR_2022.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| `LH_AMB_QUAL_ENCNTR_2022_ID` | [LH_AMB_QUAL_ENCNTR_2022](LH_AMB_QUAL_ENCNTR_2022.md) | `LH_AMB_QUAL_ENCNTR_2022_ID` |
