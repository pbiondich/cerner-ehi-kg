...
| 8 | `MEDIA_ENCNTR_RELTN_ID` | DOUBLE | NOT NULL |  | This is the unique identifier for this table |
| 9 | `MEDIA_MASTER_ID` | DOUBLE | NOT NULL | FK→ | This is the unique identifier for the media master table |
