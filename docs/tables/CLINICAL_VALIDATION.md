...
> This table groups Validation_Detail rows using a unique string.

**Description:** Clinical Validation  
**Table type:** REFERENCE  
**Primary key:** `CLINICAL_VALIDATION_ID`  
**Columns:** 9  
...
| 2 | `CLINICAL_VALIDATION_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the Clinical_Validation table. |
| 3 | `MEASUREMENT_TYPE_CD` | DOUBLE | NOT NULL |  | This is the measurement type code value for the grouping. |
...
| 9 | `VALIDATION_NAME` | VARCHAR(100) |  |  | The Validation string identiifer for the Validation_Detail grouping. |
...
| From table | Column |
|------------|--------|
| [CLINICAL_VALIDATION_DETAIL](CLINICAL_VALIDATION_DETAIL.md) | `CLINICAL_VALIDATION_ID` |
| [CLINICAL_VALIDATION_FAC_R](CLINICAL_VALIDATION_FAC_R.md) | `CLINICAL_VALIDATION_ID` |
