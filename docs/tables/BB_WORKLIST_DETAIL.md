...
> Stores the order-level information for a particular Blood Bank worklist.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ORDER_ID` | DOUBLE | NOT NULL | FK→ | Contains the internal identification code that uniquely identifies the associated order. |
...
| 7 | `WORKLIST_DETAIL_ID` | DOUBLE | NOT NULL |  | Contains the internal identification code that uniquely identifies the worklist and order relationship. |
| 8 | `WORKLIST_ID` | DOUBLE | NOT NULL | FK→ | Contains the internal identification code that uniquely identifiers the associated worklist |
...
| `WORKLIST_ID` | [BB_WORKLIST](BB_WORKLIST.md) | `WORKLIST_ID` |
