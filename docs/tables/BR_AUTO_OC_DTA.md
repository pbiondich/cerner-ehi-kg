...
> autobuild dta relationships

**Description:** BEDROCK AUTO ODER CATALOG DTA  
...
| 2 | `CATALOG_CD` | DOUBLE | NOT NULL |  | order catalog id |
| 3 | `SEQUENCE` | DOUBLE |  |  | Sequence |
| 4 | `TASK_ASSAY_CD` | DOUBLE | NOT NULL |  | dta id |
