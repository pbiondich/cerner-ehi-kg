# EVENT_SIGNATURE_FLEX

> Table stores position codes that we are requiring co signatures from

**Description:** EVENT SIGNATURE FLEX  
...
| 7 | `EVENT_SIGNATURE_FLEX_ID` | DOUBLE | NOT NULL |  | Unique ID for table |
| 8 | `POSITION_CD` | DOUBLE |  |  | Position of the personnel requiring co-signatures |
