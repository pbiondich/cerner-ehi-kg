...
> A table to indicate the rsnl that can work on a work plan for the change management process.
...
| 4 | `DM_DCM_WP_PRSNL_R_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 6 | `PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Points to the PRSNL that can work on the work plan |
