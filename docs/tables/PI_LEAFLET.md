...
| 5 | `LANGUAGE_CD` | DOUBLE | NOT NULL |  | Language code (i.e. English, spanish, etc.) |
| 6 | `LONG_TEXT_ID` | DOUBLE | NOT NULL |  | the long text id for the long text table |
| 7 | `NOMENCLATURE_ID` | DOUBLE | NOT NULL | FK→ | nomenclature id |
| 8 | `PI_LEAFLET_ID` | DOUBLE | NOT NULL |  | pi leaflet id |
| 9 | `PRINT_TYPE_FLAG` | DOUBLE |  |  | print type flag |
