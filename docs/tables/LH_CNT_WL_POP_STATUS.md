...
> This table stores the addition/removal history of a population.
...
| 4 | `LH_CNT_WL_POP_ID` | DOUBLE | NOT NULL | FK→ | Foreign key of the associated population member. |
| 5 | `LH_CNT_WL_POP_STATUS_ID` | DOUBLE | NOT NULL |  | Primary key of the table. |
| 6 | `REMOVED_REASON_CD` | DOUBLE | NOT NULL |  | Reason the patient was removed. |
