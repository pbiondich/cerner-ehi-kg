# PROV_IMMUN_PARTICIPANT

> Stores Participant information associated to the provenance IMMUNIZATION concept

**Description:** Provenance IMMUNIZATION Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_IMMUNIZATION_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Immunization table. |
| 9 | `PROV_IMMUN_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
