...
> This table stores information about the relationships between parameter sets and room and bed charge criteria.

**Description:** Person Management Room and Bed Charge Parameter Set Relationship  
**Table type:** REFERENCE  
**Primary key:** `PM_RBC_PARM_SET_R_ID`  
**Columns:** 17  
...
| 6 | `CREATE_DT_TM` | DATETIME | NOT NULL |  | The date and time this row was inserted on the table. |
| 7 | `CREATE_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | The personnel ID of the person who created the row in the table |
...
| 10 | `LOC_FACILITY_CD` | DOUBLE | NOT NULL | FK→ | This field is the patient location with a location type of facility. |
| 11 | `PM_RBC_PARM_SET_R_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a unique row on the PM_RBC_PARM_SET table. |
| 12 | `RC_PARAMETER_SET_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the RC_PARAMETER_SET table. It is an internal system assigned number. |
...
| From table | Column |
|------------|--------|
| [PM_RBC_RUN_SET](PM_RBC_RUN_SET.md) | `PM_RBC_PARM_SET_R_ID` |
