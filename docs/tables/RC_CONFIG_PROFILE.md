...
> This table will define a configuration profile path. Example: revcycle/ares/patientsearch

**Description:** Revenue Cycle Configuration Profile  
**Table type:** REFERENCE  
**Primary key:** `RC_CONFIG_PROFILE_ID`  
**Columns:** 10  
...
| 4 | `PROFILE_PATH` | VARCHAR(500) | NOT NULL |  | Contains the configuration profile path. This path will be the same across all domains. |
| 5 | `RC_CONFIG_PROFILE_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the RC_CONFIG_PROFILE table. |
...
| From table | Column |
|------------|--------|
| [RC_CONFIG_DOCUMENT](RC_CONFIG_DOCUMENT.md) | `RC_CONFIG_PROFILE_ID` |
