...
|--:|--------|------|:-----:|-------|------------|
| 1 | `RESULT_UNIT_DESC` | VARCHAR(60) |  |  | The description for the result unit |
| 2 | `RESULT_UNIT_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines a result unit |
