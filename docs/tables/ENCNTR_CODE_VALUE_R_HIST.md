...
> Holds the multiple select code values on the encounter level.
...
| 6 | `CODE_SET` | DOUBLE | NOT NULL |  | This is a code set that can have multiple values for one encounter. |
| 7 | `CODE_VALUE` | DOUBLE | NOT NULL |  | This is the code value for certain code sets that allow multiple selects. |
...
| 9 | `ENCNTR_CODE_VALUE_R_HIST_ID` | DOUBLE | NOT NULL |  | The unique primary key of this table. It is internally generated. |
| 10 | `ENCNTR_CODE_VALUE_R_ID` | DOUBLE | NOT NULL |  | This is the value of the unique identifier of the encntr_code_value_r table. |
| 11 | `ENCNTR_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the encounter table that the code values are related to. |
