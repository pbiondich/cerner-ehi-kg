...
> Defines a rule service for RCA.

**Description:** Revenue Cycle Ambulatory  
**Table type:** REFERENCE  
**Primary key:** `RCA_RULE_SERVICE_ID`  
**Columns:** 13  
...
| 2 | `DESCRIPTION_TXT` | VARCHAR(500) | NOT NULL |  | The textual description of the rule service. |
...
| 4 | `RCA_RULE_SERVICE_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the rca_rule_service table. |
| 5 | `RULE_CATEGORY_MEANING_TXT` | VARCHAR(100) | NOT NULL |  | The meaning of the rule category with which this service is associated. |
| 6 | `RULE_TYPE_MEANING_TXT` | VARCHAR(100) | NOT NULL |  | The meaning of the rule type this service is associated with. |
| 7 | `SERVICE_DISPLAY_NAME` | VARCHAR(100) | NOT NULL |  | The user facing display of the rule service. |
| 8 | `SERVICE_NAME` | VARCHAR(100) | NOT NULL |  | The technical name of the rule service. |
...
| From table | Column |
|------------|--------|
| [RCA_RULE_SERVICE_PARAM](RCA_RULE_SERVICE_PARAM.md) | `RCA_RULE_SERVICE_ID` |
| [RCA_RULE_SERVICE_RELTN](RCA_RULE_SERVICE_RELTN.md) | `RCA_RULE_SERVICE_ID` |
| [RCA_RULE_SERVICE_RESULT](RCA_RULE_SERVICE_RESULT.md) | `RCA_RULE_SERVICE_ID` |
