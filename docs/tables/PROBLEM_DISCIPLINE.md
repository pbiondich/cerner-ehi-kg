...
> The Problem Discipline table records the management disciplines which have an interest in this problem.
...
| 11 | `MANAGEMENT_DISCIPLINE_CD` | DOUBLE | NOT NULL |  | Indicates the category of care providers that have responsibility for managing this specific problem. |
| 12 | `PROBLEM_DISCIPLINE_ID` | DOUBLE | NOT NULL |  | Unique identifier for problem discipline. |
| 13 | `PROBLEM_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier of the problem that this discipline was created. |
