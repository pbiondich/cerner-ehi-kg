...
> Stores coded data linked to abstract data from ProFile.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ABSTRACT_DEF_CD` | DOUBLE | NOT NULL |  | The unique identifier to the omf_abstract_def table. |
| 2 | `ABST_CODING_RELTN_ID` | DOUBLE | NOT NULL |  | The unique identifier for the omf_abst_coding_reltn_st |
...
| 7 | `NOMENCLATURE_ID` | DOUBLE | NOT NULL |  | The unique identifier to the nomenclature table. |
| 8 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | The unique identifier for the diagnosis/nomenclature/drg. |
| 9 | `PARENT_ENTITY_NAME` | VARCHAR(255) |  |  | The table name associated with the parent_entity_id |
