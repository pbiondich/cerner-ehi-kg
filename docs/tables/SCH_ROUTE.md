...
| 16 | `ROUTE_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the ROUTING_ID |
| 17 | `ROUTE_TYPE_CD` | DOUBLE | NOT NULL | FK→ | A unique identifier for the scheduling routing type. |
| 18 | `SCH_ROUTE_ID` | DOUBLE | NOT NULL | PK | The unique identifier for a scheduling route. |
...
| `ROUTE_TYPE_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |

## Referenced by (5)

| From table | Column |
|------------|--------|
| [SCH_ACTION_NOTIFY](SCH_ACTION_NOTIFY.md) | `BASE_ROUTE_ID` |
| [SCH_APPT_NOTIFY](SCH_APPT_NOTIFY.md) | `SCH_ROUTE_ID` |
| [SCH_NOTIFY](SCH_NOTIFY.md) | `SCH_ROUTE_ID` |
| [SCH_ROUTE_LIST](SCH_ROUTE_LIST.md) | `CHILD_SCH_ROUTE_ID` |
| [SCH_ROUTE_LIST](SCH_ROUTE_LIST.md) | `SCH_ROUTE_ID` |
