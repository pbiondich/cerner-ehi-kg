...
> Defines which positions can perform a specific task.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `POSITION_CD` | DOUBLE | NOT NULL |  | The position_cd used to identify what positions may perform action against this task. |
| 2 | `REFERENCE_TASK_ID` | DOUBLE | NOT NULL | FK→ | The reference_task_id from the order_task table. |
