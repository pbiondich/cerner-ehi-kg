...
> This reference table stores security relationships between certain entities and billing entities
...
| 6 | `BE_SECURITY_RELTN_ID` | DOUBLE | NOT NULL |  | Unique Identifier of this table |
...
| 9 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | ID of the related entity identified in the parent_entity_name |
| 10 | `PARENT_ENTITY_NAME` | VARCHAR(32) | NOT NULL |  | Name of related entity whos id is identified in the parent_entity_id |
