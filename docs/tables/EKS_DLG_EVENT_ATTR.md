...
> Contains attributes of an event in the EKS_DLG_EVENT table
...
| 2 | `ATTR_ID` | DOUBLE | NOT NULL |  | ID of attribute |
| 3 | `ATTR_NAME` | CHAR(32) |  |  | The name of the table which contains the identifiers for the event attribute |
| 4 | `ATTR_VALUE` | VARCHAR(255) |  |  | The value of the attribute identifier. Relates to the ATTR_NAME table |
| 5 | `DLG_EVENT_ATTR_ID` | DOUBLE | NOT NULL |  | Unique identifier for an event attribute. |
| 6 | `DLG_EVENT_ID` | DOUBLE | NOT NULL | FK→ | The identifier of the event for which these attributes were generated |
...
|--------|--------------|---------------|
| `DLG_EVENT_ID` | [EKS_DLG_EVENT](EKS_DLG_EVENT.md) | `DLG_EVENT_ID` |
