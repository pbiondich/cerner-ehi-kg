# PROV_PROC_ENTY_PRTCPNT

> Stores Participant relationships to the concept entity

**Description:** PROV_PROC_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_PROC_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_PROC_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_PROC_ENTITY_ID` | [PROV_PROC_ENTITY](PROV_PROC_ENTITY.md) | `PROV_PROC_ENTITY_ID` |
