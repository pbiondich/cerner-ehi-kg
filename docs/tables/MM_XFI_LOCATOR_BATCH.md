...
> Used to group a set of MM_XFI_LOCATOR rows for batch processing.
...
| 3 | `MM_XFI_LOCATOR_BATCH_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the MM_XFI_LOCATOR_BATCH table. |
