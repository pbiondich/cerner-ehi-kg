...
> A Dimension Group table to allow the connection the Fact table row to many Diagnosis Dimensions via the Bridge Table relationship

**Description:** WHC_D_DIAGNOSIS_GROUP  
**Table type:** REFERENCE  
**Primary key:** `WHC_D_DIAGNOSIS_GROUP_ID`  
**Columns:** 6  
...
| 6 | `WHC_D_DIAGNOSIS_GROUP_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
| From table | Column |
|------------|--------|
| [WHC_D_DIAGNOSIS_BRIDGE](WHC_D_DIAGNOSIS_BRIDGE.md) | `WHC_D_DIAGNOSIS_GROUP_ID` |
| [WHC_F_MOTHER_PREGNANCY](WHC_F_MOTHER_PREGNANCY.md) | `DIAGNOSIS_GROUP_ID` |
