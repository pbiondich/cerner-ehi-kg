...
> Profit's encounter alias table
...
| 5 | `ALIAS` | VARCHAR(100) |  |  | Identifier for the encounter |
...
| 14 | `PFT_ENCNTR_ALIAS_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the encounter alias table. It is an internal system assigned number |
| 15 | `PFT_ENCNTR_ALIAS_TYPE_CD` | DOUBLE | NOT NULL |  | Encounter alias type code identifies a kind or type of alias |
| 16 | `PFT_ENCNTR_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to PFT_Encntr table |
