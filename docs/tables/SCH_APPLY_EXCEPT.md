...
> Scheduling Application Exceptions
...
| 5 | `BEG_DT_TM` | DATETIME | NOT NULL |  | Begin Date and Time value |
...
| 8 | `END_DT_TM` | DATETIME | NOT NULL |  | End Date and Time value |
...
| 11 | `SCH_APPLY_ID` | DOUBLE | NOT NULL | FK→ | Scheduling Application Identifier |
