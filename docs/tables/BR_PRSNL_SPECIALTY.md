...
> speciality associated with the personnel
...
| 2 | `PRSNL_ID` | DOUBLE | NOT NULL |  | Unique identifier for the table |
| 3 | `SPECIALTY_ID` | DOUBLE | NOT NULL |  | The specialty associated to the personnel |
