...
> This table stores the status of various AOAV processes
...
| 2 | `AOAV_PROCESS_STS_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `LOC_FACILITY_CD` | DOUBLE | NOT NULL |  | Code value for location facility |
| 4 | `PROCESS_DT_TM` | DATETIME |  |  | Date time the process was done |
| 5 | `PROCESS_NAME` | VARCHAR(40) |  |  | The name of the process ("PERSON_FINALIZE","OUTCOMES_SUMMARY","PERSON_RETRIEVE") |
| 6 | `PROCESS_STS_FLAG` | DOUBLE | NOT NULL |  | Status of the given process (0:NOT-STARTED, 1: IN-PROGRESS, 2: COMPLETE, 3: ERROR) |
