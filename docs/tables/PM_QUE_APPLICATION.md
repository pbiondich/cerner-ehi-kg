...
| 2 | `APPLICATION_ID` | DOUBLE | NOT NULL |  | Primary key. |
...
| 4 | `DESCRIPTION` | VARCHAR(255) |  |  | Free-text description of the work queue application |
| 5 | `DISPLAY` | VARCHAR(100) | NOT NULL |  | Display value for the work queue application |
| 6 | `DISPLAY_KEY` | VARCHAR(100) | NOT NULL |  | Display key for the work queue application. |
...
| 8 | `NAME` | VARCHAR(100) |  |  | Name of the application the work queue will invoke. |
