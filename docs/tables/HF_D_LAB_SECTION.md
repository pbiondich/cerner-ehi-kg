...
> This is the HealthFacts dimension table that contains standard values for lab sections
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `LAB_SECTION_DESC` | VARCHAR(60) |  |  | The description of the lab section. This might be General Lab, Microbiology, AP, etc. |
| 2 | `LAB_SECTION_ID` | DOUBLE | NOT NULL |  | Primary key to the table. |
