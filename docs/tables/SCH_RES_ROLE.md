...
| 9 | `RESOURCE_CD` | DOUBLE | NOT NULL | FK→ | The identifier for the resource. A resource is an item of limited availability. |
| 10 | `ROLE_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the scheduling role. |
| 11 | `SCH_ROLE_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the scheduling role. |
