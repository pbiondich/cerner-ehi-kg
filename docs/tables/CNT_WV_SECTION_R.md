...
> Contains details about working views and section relations. Imported using content manager tool.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CNT_WV_SECTION_R_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the CNT_WV_SECTION_R table. |
...
| 7 | `WORKING_VIEW_UID` | VARCHAR(100) | NOT NULL |  | Working view UID used to relate the working view with a section. |
| 8 | `WV_SECTION_UID` | VARCHAR(100) | NOT NULL |  | Working view section UID used to relate the working view section with working view |
