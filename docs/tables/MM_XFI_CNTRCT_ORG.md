...
> Table used to store relationships between contracts and organizations. Data is moved from this table to MM_CNTRCT_ORG.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTION_FLAG` | DOUBLE |  |  | Organization action flag |
...
| 6 | `ORG` | VARCHAR(100) |  |  | Organization |
| 7 | `ORG_ID` | DOUBLE | NOT NULL | FK→ | Organization key |
| 8 | `PROCESS_FLAG` | DOUBLE |  |  | Flag used to determine the processing status of the line |
| 9 | `TRANSACTION_ID` | DOUBLE | NOT NULL |  | Transaction primary key |
| 10 | `TRANS_PARENT_ID` | DOUBLE | NOT NULL | FK→ | Transaction Parent Identifier |
