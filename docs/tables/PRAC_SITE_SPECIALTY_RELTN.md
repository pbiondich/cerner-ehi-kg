...
> Defines the specialties that are associated with practice sites
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `PRACTICE_SITE_ID` | DOUBLE | NOT NULL | FK→ | Foreign key relation to the PRACTICE_SITE table |
| 2 | `PRAC_SITE_SPECIALTY_RELTN_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `SPECIALTY_CD` | DOUBLE | NOT NULL | FK→ | Specialty associated with given practice site |
