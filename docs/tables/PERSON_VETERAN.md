...
> Stores information specific to military veterans.
...
| 6 | `SERVICE_RLTD_DISABILITY_CD` | DOUBLE | NOT NULL |  | Defines the status that indicates whether or not the patient has a service related disability. |
| 7 | `SERVICE_RLTD_DISABILITY_PCT` | DOUBLE |  |  | Determines the percentage of benefits a veteran receives for their service related disability. |
