# PROV_GEN_LAB_PARTICIPANT

> Stores Participant information associated to the provenance GEN_LAB concept

**Description:** Provenance GEN_LAB Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_GEN_LAB_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Gen_Lab table. |
| 9 | `PROV_GEN_LAB_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
