...
> The CQM listener trigger table contains the administrative data for the processing of a trigger exploded CQM transaction by a listener application. This table contains data for the MDI Results application.
...
| 14 | `QUEUE_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the CQM queue table. It is an internal system assigned number. |
...
| From table | Column |
|------------|--------|
| [CQM_MDRESULTS_LOG](CQM_MDRESULTS_LOG.md) | `TRIGGER_ID` |
