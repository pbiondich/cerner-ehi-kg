...
> Ties a person to a specific location view.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The location which the person has been related to. |
| 2 | `LOCATION_TYPE_CD` | DOUBLE | NOT NULL |  | The type of location. |
