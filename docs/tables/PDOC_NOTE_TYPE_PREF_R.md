...
> This table captures groupings of note type for use in Bedrock configuration.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CONTEXT_NAME` | VARCHAR(255) | NOT NULL |  | The context under which the preference name is established, for example "DEFAULT", "POSITION", or "FACILITY". |
| 2 | `NOTE_TYPE_ID` | DOUBLE | NOT NULL | FK→ | A note type related a preference. |
| 3 | `PARENT_ENTITY_ID` | DOUBLE |  |  | The context table id under which the preference name is established. Will be null for the default context. |
| 4 | `PARENT_ENTITY_NAME` | VARCHAR(30) |  |  | The context table name under which the preference name is established. Will be null for the default context. |
| 5 | `PDOC_NOTE_TYPE_PREF_R_ID` | DOUBLE | NOT NULL |  | Unique, generated number that identifies a single row on the PDOC_NOTE_TYPE_PREF_R table. |
| 6 | `PREF_NAME` | VARCHAR(255) | NOT NULL |  | The name of the preference related to the note type. |
