# LH_AMB_EP_RELTN_2023

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2023

**Description:** LH_AMB_EP_RELTN_2023  
**Table type:** ACTIVITY  
...
| 10 | `LH_AMB_EP_RELTN_2023_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2023 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2023_ID` | DOUBLE |  | FK→ | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2023 that matches. |
...
|--------|--------------|---------------|
| `HEALTH_SYSTEM_SOURCE_ID` | [LH_AMB_QUAL_ENCNTR_2023](LH_AMB_QUAL_ENCNTR_2023.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| `LH_AMB_QUAL_ENCNTR_2023_ID` | [LH_AMB_QUAL_ENCNTR_2023](LH_AMB_QUAL_ENCNTR_2023.md) | `LH_AMB_QUAL_ENCNTR_2023_ID` |
