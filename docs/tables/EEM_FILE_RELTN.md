...
| 8 | `FILE_RELTN_ID` | DOUBLE | NOT NULL |  | c |
| 9 | `PARENT1_CD` | DOUBLE | NOT NULL | FK→ | Parent1 Code |
| 10 | `PARENT1_ID` | DOUBLE | NOT NULL |  | Parent1 Identifier |
| 11 | `PARENT1_MEANING` | VARCHAR(12) |  |  | Parent1 Meaning |
| 12 | `PARENT1_TABLE` | VARCHAR(30) |  |  | Parent1 Table |
| 13 | `PARENT2_CD` | DOUBLE | NOT NULL | FK→ | Parent1 Code |
| 14 | `PARENT2_ID` | DOUBLE | NOT NULL |  | Parent2 Identifier |
| 15 | `PARENT2_MEANING` | VARCHAR(12) |  |  | Parent2 Meaning |
| 16 | `PARENT2_TABLE` | VARCHAR(30) |  |  | Parent2 Table |
| 17 | `PARENT3_CD` | DOUBLE | NOT NULL | FK→ | Parent3 Code |
| 18 | `PARENT3_ID` | DOUBLE | NOT NULL |  | Parent3 Identifier |
| 19 | `PARENT3_MEANING` | VARCHAR(12) |  |  | Parent3 Meaning |
| 20 | `PARENT3_TABLE` | VARCHAR(30) |  |  | Parent3 Table |
...
| `PARENT1_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
| `PARENT2_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
| `PARENT3_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
