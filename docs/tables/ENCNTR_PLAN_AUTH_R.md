...
> Relates Encounter/Plan relationships to cooresponding Authorization information sets.

**Description:** Encounter Plan Authorization Relation  
**Table type:** ACTIVITY  
**Primary key:** `ENCNTR_PLAN_AUTH_R_ID`  
**Columns:** 15  
...
| 5 | `AUTHORIZATION_ID` | DOUBLE | NOT NULL | FK→ | Authorization Row Identifier |
...
| 8 | `ENCNTR_PLAN_AUTH_R_ID` | DOUBLE | NOT NULL | PK | Encounter Plan Authorization Relation Identifier |
| 9 | `ENCNTR_PLAN_RELTN_ID` | DOUBLE | NOT NULL | FK→ | Encounter Plan Relation Identifier |
...
| From table | Column |
|------------|--------|
| [ENCNTR_PLAN_AUTH_R_HIST](ENCNTR_PLAN_AUTH_R_HIST.md) | `ENCNTR_PLAN_AUTH_R_ID` |
