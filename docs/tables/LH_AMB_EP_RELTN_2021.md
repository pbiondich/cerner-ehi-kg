# LH_AMB_EP_RELTN_2021

> Table containing the relationships of providers to encounters for Meaningful Use NQF Stage 2 2021

**Description:** LH_AMB_EP_RELTN_2021  
**Table type:** ACTIVITY  
...
| 10 | `LH_AMB_EP_RELTN_2021_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EP_RELTN_2021 table. |
| 11 | `LH_AMB_QUAL_ENCNTR_2021_ID` | DOUBLE | NOT NULL | FK→ | Identifies the unique record in LH_AMB_QUAL_ENCNTR_2021 that matches. |
| 12 | `PROVIDER_ID` | DOUBLE | NOT NULL |  | The unique provider id from PRSNL. |
...
|--------|--------------|---------------|
| `HEALTH_SYSTEM_SOURCE_ID` | [LH_AMB_QUAL_ENCNTR_2021](LH_AMB_QUAL_ENCNTR_2021.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| `LH_AMB_QUAL_ENCNTR_2021_ID` | [LH_AMB_QUAL_ENCNTR_2021](LH_AMB_QUAL_ENCNTR_2021.md) | `LH_AMB_QUAL_ENCNTR_2021_ID` |
