...
> Scheduling Appointment Notifications
...
| 19 | `SCH_FLEX_ID` | DOUBLE | NOT NULL | FK→ | Scheduling Flexing Identifier |
| 20 | `SCH_ROUTE_ID` | DOUBLE | NOT NULL | FK→ | The internal unique identifier for a scheduling route. |
