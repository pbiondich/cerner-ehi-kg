...
| 5 | `CHART_REQUEST_ENCNTR_ID` | DOUBLE | NOT NULL |  | primary key for the table |
| 6 | `CHART_REQUEST_ID` | DOUBLE | NOT NULL | FK→ | Primary key to the chart_request table |
| 7 | `CR_ENCNTR_SEQ` | DOUBLE | NOT NULL |  | sequence of encounters |
