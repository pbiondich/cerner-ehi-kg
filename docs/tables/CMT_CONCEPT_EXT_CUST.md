...
| 6 | `CMT_CONCEPT_EXT_CUST_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 7 | `CONCEPT_CKI` | VARCHAR(255) |  |  | Functional unique identifier from cmt_concept_table. |
...
| 9 | `EXTENSION_DATA_TYPE_FLAG` | DOUBLE |  |  | The value associated with the extension_type_meaning; 1 alphanumeric; 2 double; 3 integer; |
| 10 | `EXTENSION_TYPE_MEAN` | VARCHAR(12) |  |  | Value from code Set 29746 - CDF Meaning; |
| 11 | `EXTENSION_VALUE` | VARCHAR(255) |  |  | The text value associated with the extension type mean |
