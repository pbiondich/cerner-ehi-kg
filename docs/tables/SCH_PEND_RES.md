...
> Contains resource information about an appointment which will be created.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `RESOURCE_CD` | DOUBLE | NOT NULL |  | The resource to be considered for this pending event. |
| 2 | `SCH_PEND_LOC_ID` | DOUBLE | NOT NULL | FK→ | The pend location identifier that this data belongs to |
| 3 | `SCH_PEND_RES_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the SCH_PEND_RES table.; |
...
|--------|--------------|---------------|
| `SCH_PEND_LOC_ID` | [SCH_PEND_LOC](SCH_PEND_LOC.md) | `SCH_PEND_LOC_ID` |
