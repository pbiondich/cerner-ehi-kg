...
> Contains details about working section and item relations. Imported using content manager tool.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CNT_WV_SECTION_ITEM_R_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the CNT_WV_SECTION_R table. |
...
| 7 | `WV_ITEM_UID` | VARCHAR(100) | NOT NULL |  | Working view item UID used to relate the working view item with working view section |
| 8 | `WV_SECTION_UID` | VARCHAR(100) | NOT NULL |  | Working view section UID used to relate the working view section with working view item. |
