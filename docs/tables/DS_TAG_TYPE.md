...
> The tag types for Referral Service Directory. Tag Types could be like 'Network', 'EAST' etc¿ to identify providers when referring.

**Description:** Directory Search Tag Type  
**Table type:** ACTIVITY  
**Primary key:** `DS_TAG_TYPE_ID`  
**Columns:** 8  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DS_TAG_TYPE_ID` | DOUBLE | NOT NULL | PK | PRIMARY KEY |
...
| 3 | `TAG_TYPE_TXT` | VARCHAR(255) | NOT NULL |  | The value of the tag type |
...
| From table | Column |
|------------|--------|
| [DS_TAG](DS_TAG.md) | `DS_TAG_TYPE_ID` |
