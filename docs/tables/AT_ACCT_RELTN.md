...
> Account Template Account Relation
...
| 2 | `ACCT_TEMPL_ID` | DOUBLE | NOT NULL | FK→ | Foreign Key to the Acct_Template table. |
...
| 7 | `AT_ACCT_RELTN_ID` | DOUBLE | NOT NULL |  | Primary Key |
...
| 9 | `CREATED_DT_TM` | DATETIME |  |  | Date and time the record was created. |
| 10 | `CREATED_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Unique identifier of the person that created the record. |
