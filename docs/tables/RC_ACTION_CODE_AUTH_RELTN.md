...
> Stores authorization relationship between action code and entity.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTION_CD` | DOUBLE | NOT NULL |  | The client defined action code. |
...
| 5 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | id number of the selected criteria located on table . |
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Identifies the name of the related entity. |
| 7 | `RC_ACTION_CODE_AUTH_RELTN_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a relationship between the action code and the entity |
