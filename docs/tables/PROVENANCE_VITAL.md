...
> Stores provenance information for the VITALS concept

**Description:** Provenance for VITALS  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_VITAL_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (CLINICAL_EVENT - VITALS_EXT_DATA) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_RECORDED_DT_TM` | DATETIME | NOT NULL |  | The Date that the Provenance data was written into Millennium. |
| 9 | `PROVENANCE_VITAL_ID` | DOUBLE | NOT NULL | PK | PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_VITAL_ENTITY](PROV_VITAL_ENTITY.md) | `PROVENANCE_VITAL_ID` |
| [PROV_VITAL_PARTICIPANT](PROV_VITAL_PARTICIPANT.md) | `PROVENANCE_VITAL_ID` |
