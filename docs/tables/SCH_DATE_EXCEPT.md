...
> Stores date exceptions for a given scheduling request date range.
...
| 10 | `EXC_SEQ_NBR` | DOUBLE | NOT NULL |  | This field is used to keep the records unique |
...
| 13 | `SCH_ACTION_ID` | DOUBLE | NOT NULL |  | The identifier to uniquely identify the action being performed. |
