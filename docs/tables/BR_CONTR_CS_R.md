...
> This table stores the code sets chosen for each contributor system/segment
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `BR_CONTR_CS_R_ID` | DOUBLE | NOT NULL |  | Unique id |
| 2 | `CODESET` | DOUBLE | NOT NULL |  | the code set chosen for the segment |
...
| 4 | `SEGMENT_NAME` | VARCHAR(10) | NOT NULL |  | the name of the HL7 segment, i.e. PID, PV1, NTE |
