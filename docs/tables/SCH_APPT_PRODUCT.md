...
> This table is used to filter appointment types by product
...
| 5 | `APPT_TYPE_CD` | DOUBLE | NOT NULL |  | The identifier for an appointment type. |
...
| 10 | `PRODUCT_CD` | DOUBLE | NOT NULL |  | Scheduling Product Code |
| 11 | `PRODUCT_MEANING` | VARCHAR(12) |  |  | Product Meaning |
