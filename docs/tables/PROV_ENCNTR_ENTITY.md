...
> Stores information about entities associated to the provenance ENCNTR concept

**Description:** Provenance ENCNTR Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_ENCNTR_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_ENCOUNTER_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Encounter table. |
| 7 | `PROV_ENCNTR_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_ENCOUNTER_ID` | [PROVENANCE_ENCOUNTER](PROVENANCE_ENCOUNTER.md) | `PROVENANCE_ENCOUNTER_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_ENCNTR_ENTY_PRTCPNT](PROV_ENCNTR_ENTY_PRTCPNT.md) | `PROV_ENCNTR_ENTITY_ID` |
