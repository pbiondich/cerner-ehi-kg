...
**Description:** MLLD_CATEGORY_DRUG_XREF  
...
| 4 | `MULTUM_CATEGORY_ID` | DOUBLE | NOT NULL |  | This field is used to assign a therapeutic/chemical category to a specific drug. |
