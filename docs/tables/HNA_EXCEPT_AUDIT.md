...
> Audit trail for Reconcile Exceptions
...
| 6 | `DOB` | DATETIME |  |  | The DOB of the exception group that caused the row to be written to the table |
| 7 | `DOB_TZ` | DOUBLE |  |  | Time zone associated with the corresponding DT_TM column. |
...
| 9 | `EXCEPT_GROUP_ID` | DOUBLE | NOT NULL |  | The id of the exception group that caused the row to be written to the table |
| 10 | `FNAME` | VARCHAR(100) |  |  | The first name of the exception group that caused the row to be written to the table |
| 11 | `HNA_EXCEPT_AUDIT_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the hna_except_audit table. It is an internal system assigned number |
| 12 | `LNAME` | VARCHAR(100) |  |  | The last name of the exception group that caused the row to be written to the table |
...
| 14 | `SSN` | VARCHAR(100) |  |  | The SSN of the exception group that caused the row to be written to the table |
