# LH_E_HYBRID_2022_METRICS

> Stores data gathered by the LH_E_HYBRID_2022 script.

**Description:** Lighthouse eMeasures HWR and HWM 2022 Metrics  
**Table type:** ACTIVITY  
...
| 49 | `LH_E_HYBRID_2022_METRICS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_E_HYBRID_2022_METRICS table. |
