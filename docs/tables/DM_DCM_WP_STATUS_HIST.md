...
> A table to track status changes to work plan items for the change management solution
...
| 3 | `DM_DCM_WORK_PLAN_ID` | DOUBLE | NOT NULL | FK→ | Points to the DM_DCM_WORK_PLAN table |
| 4 | `DM_DCM_WP_STATUS_HIST_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 6 | `STATUS_CD` | DOUBLE | NOT NULL |  | Holds the status of the work plan |
