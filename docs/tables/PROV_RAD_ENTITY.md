...
> Stores information about entities associated to the provenance RADIOLOGY concept

**Description:** PROV_RAD_ENTITY  
**Table type:** ACTIVITY  
**Primary key:** `PROV_RAD_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_RADIOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_RADIOLOGY table. |
| 7 | `PROV_RAD_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_RADIOLOGY_ID` | [PROVENANCE_RADIOLOGY](PROVENANCE_RADIOLOGY.md) | `PROVENANCE_RADIOLOGY_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_RAD_ENTY_PRTCPNT](PROV_RAD_ENTY_PRTCPNT.md) | `PROV_RAD_ENTITY_ID` |
