...
> Stores the parent-child relationships for Dose Range Checking(DRC) routes
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CHILD_ROUTE_CD` | DOUBLE |  | FK→ | code_value to identify the child route. |
| 2 | `DRC_ROUTE_GROUP_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `PARENT_ROUTE_CD` | DOUBLE |  | FK→ | code_value to identify the parent route. |
