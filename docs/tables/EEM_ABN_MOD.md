...
| 8 | `MOD_NOMEN_ID` | DOUBLE | NOT NULL | FK→ | Modifier Nomenclature Identifier |
| 9 | `MOD_SEQ_NBR` | DOUBLE | NOT NULL |  | Modifier Sequence Number |
| 10 | `MOD_SOURCE_IDENT` | VARCHAR(50) | NOT NULL |  | Modifier Source Identifier |
| 11 | `MOD_VOCAB_CD` | DOUBLE | NOT NULL | FK→ | Modifier Vocabulary Code |
| 12 | `MOD_VOCAB_MEANING` | VARCHAR(12) |  |  | Modifier Vocabulary Meaning |
...
| `MOD_VOCAB_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
