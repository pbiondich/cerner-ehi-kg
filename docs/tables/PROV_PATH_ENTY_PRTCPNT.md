...
**Description:** PROV_PATH_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_PATH_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_PATH_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_PATH_ENTITY_ID` | [PROV_PATH_ENTITY](PROV_PATH_ENTITY.md) | `PROV_PATH_ENTITY_ID` |
