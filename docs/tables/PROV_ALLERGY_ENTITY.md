...
> Stores information about entities associated to the provenance ALLERGY concept

**Description:** Provenance ALLERGY Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_ALLERGY_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_ALLERGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Allergy table. |
| 7 | `PROV_ALLERGY_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
|--------|--------------|---------------|
| `PROVENANCE_ALLERGY_ID` | [PROVENANCE_ALLERGY](PROVENANCE_ALLERGY.md) | `PROVENANCE_ALLERGY_ID` |

## Referenced by (1)

| From table | Column |
|------------|--------|
| [PROV_ALLERGY_ENTY_PRTCPNT](PROV_ALLERGY_ENTY_PRTCPNT.md) | `PROV_ALLERGY_ENTITY_ID` |
