...
> Defines a historical record of a point in a reference dataset
...
| 2 | `ACTION_SEQ` | DOUBLE | NOT NULL |  | This represents the sequence number of this entry. |
...
| 10 | `REF_DATAPOINT_ID` | DOUBLE | NOT NULL | FK→ | This will be the table's primary key. |
| 11 | `REF_DATASET_ID` | DOUBLE | NOT NULL |  | This is the foreign key to the REF_DATASET table. Each data point belongs to exactly one dataset. |
...
| 17 | `X_VAL` | DOUBLE | NOT NULL |  | This is the X value of the datapoint. The unit of measure will be the unit code of the first section of the X axis in the CHART_DEFINITION table. |
| 18 | `Y_VAL` | DOUBLE | NOT NULL |  | This is the Y value of the datapoint. The unit of measure will be the unit code of the y axis in the CHART_DEFINITION table. |
...
|--------|--------------|---------------|
| `REF_DATAPOINT_ID` | [REF_DATAPOINT](REF_DATAPOINT.md) | `REF_DATAPOINT_ID` |
