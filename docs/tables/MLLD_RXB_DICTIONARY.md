...
**Description:** MLLD_RXB_DICTIONARY  
...
| 3 | `DICTIONARY_ID` | DOUBLE | NOT NULL |  | This field contains a unique identifier for each dictionary_id used in Multum's RxBuilder tables. |
