...
> Holds the multiple select code values on the person level.
...
| 6 | `CODE_SET` | DOUBLE | NOT NULL |  | This is a code set that can have multiple values for one person. |
...
| 10 | `PERSON_CODE_VALUE_R_ID` | DOUBLE | NOT NULL |  | Unique identifier for the person_code_value_r_id table. |
