...
> Clinical Reporting mask entries

**Description:** Clinical Reporting Masks  
**Table type:** REFERENCE  
**Primary key:** `CR_MASK_ID`  
**Columns:** 10  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CR_MASK_ID` | DOUBLE | NOT NULL | PK | This is a number uniquely assigned to each chart request |
| 2 | `CR_MASK_TEXT` | VARCHAR(255) | NOT NULL |  | This is the mask for the request |
| 3 | `DEFAULT_IND` | DOUBLE | NOT NULL |  | This field is used to indicate whether the mask is set as default or not |
...
| 5 | `PUBLISH_IND` | DOUBLE | NOT NULL |  | This field is used to indicate whether the mask is published or not |
...
| From table | Column |
|------------|--------|
| [CHART_REQUEST](CHART_REQUEST.md) | `CR_MASK_ID` |
