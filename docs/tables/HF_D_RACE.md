...
> This is the HealthFacts dimension table that contains standard values for race

**Description:** HF_D_RACE  
...
| 4 | `RACE_DESC` | VARCHAR(60) |  |  | The description for the race |
| 5 | `RACE_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines a race |
