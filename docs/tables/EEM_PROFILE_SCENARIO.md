...
| 5 | `INPUT_ID` | DOUBLE | NOT NULL |  | Primary key. |
| 6 | `LENGTH` | DOUBLE |  |  | Length. |
| 7 | `MASK` | VARCHAR(100) |  |  | Textual input mask. |
| 8 | `PROFILE_ID` | DOUBLE | NOT NULL | FK→ | Profile ID. |
| 9 | `SCENARIO` | DOUBLE |  |  | Scenario |
| 10 | `SEARCH_CRITERIA_CD` | DOUBLE | NOT NULL |  | Search Criteria |
| 11 | `SEQUENCE` | DOUBLE | NOT NULL |  | Column is not used. Obsolete column. |
