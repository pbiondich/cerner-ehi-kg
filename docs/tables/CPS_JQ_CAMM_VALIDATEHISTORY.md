# CPS_JQ_CAMM_VALIDATEHISTORY

> CammPlatformServices_JobQueue_VALIDATE History

**Description:** CPS_JQ_CAMM_VALIDATEHISTORY  
**Table type:** ACTIVITY  
...
| 2 | `CPS_JQ_CAMM_VALIDATEHISTORY_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 3 | `CPS_RULE_ID` | DOUBLE |  |  | Unique number that identifies a Rule in the CAMM archive system |
| 4 | `ENTITY_IDENT` | VARCHAR(200) | NOT NULL |  | Unique string that identifies the object being acted upon |
