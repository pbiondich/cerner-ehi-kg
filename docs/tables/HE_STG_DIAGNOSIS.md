...
> Stages Diagnosis data to be utilized by the Health Expert Priming job.

**Description:** Health Expert Staging Diagnosis  
**Table type:** ACTIVITY  
...
| 2 | `PRIMARY_IDENT` | DOUBLE | NOT NULL |  |  |
| 3 | `SECONDARY_IDENT` | DOUBLE | NOT NULL |  |  |
| 4 | `SORT_IDENT` | DOUBLE | NOT NULL |  | The identifier used when sorting and/or grouping rows, e.g. Person_ID. |
