...
> Scheduling Freetext Associations
...
| 8 | `CHILD_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the child object. |
| 9 | `CHILD_TYPE_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the CHILD_ID. |
...
| 11 | `FREE_TYPE_CD` | DOUBLE | NOT NULL | FK→ | A coded identifier for the free texttype. |
| 12 | `FREE_TYPE_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the free texttype. |
| 13 | `NULL_DT_TM` | DATETIME | NOT NULL |  | contains 31-DEC-2100 00:00:00.00 |
...
| `CHILD_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
| `FREE_TYPE_CD` | [CODE_VALUE](CODE_VALUE.md) | `CODE_VALUE` |
