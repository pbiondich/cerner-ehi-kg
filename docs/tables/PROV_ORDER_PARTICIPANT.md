# PROV_ORDER_PARTICIPANT

> Stores Participant information associated to the provenance ORDERS concept

**Description:** Provenance ORDERS Participant  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_ORDER_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Order table. |
| 9 | `PROV_ORDER_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
