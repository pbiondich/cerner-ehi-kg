...
> The ORG_SET_TYPE_R table holds information about org sets and their corresponding types.
...
| 7 | `ORG_SET_ID` | DOUBLE | NOT NULL | FK→ | Unique identifier for the org set |
| 8 | `ORG_SET_TYPE_CD` | DOUBLE | NOT NULL |  | The org set type, ex. Security, Emergency etc. |
| 9 | `ORG_SET_TYPE_R_ID` | DOUBLE | NOT NULL |  | Unique identifier that represents the relationship between the org set and the type of org set. |
