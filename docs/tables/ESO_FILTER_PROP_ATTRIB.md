...
> eso filter property relation Table
...
| 2 | `ATTRIB_SEQ` | DOUBLE | NOT NULL |  | attribute sequenceColumn |
...
| 6 | `FILTER_PROP_ATTRIB_CD` | DOUBLE | NOT NULL |  | filter property attribute codeColumn |
| 7 | `FILTER_PROP_ATTRIB_ID` | DOUBLE | NOT NULL |  | filter property attribute identifierColumn |
| 8 | `FILTER_PROP_ATTRIB_VALUE` | VARCHAR(255) |  |  | filter property attribute valueColumn |
| 9 | `FILTER_PROP_ID` | DOUBLE | NOT NULL | FK→ | filter property identifierColumn |
...
|--------|--------------|---------------|
| `FILTER_PROP_ID` | [ESO_FILTER_PROP](ESO_FILTER_PROP.md) | `FILTER_PROP_ID` |
