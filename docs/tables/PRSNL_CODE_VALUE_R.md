...
> A table that defines a relationship between a personnel and a code value.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CODE_SET` | DOUBLE | NOT NULL |  | The value of the code set. Code sets are groupings of code values. |
| 2 | `CODE_VALUE` | DOUBLE | NOT NULL |  | The code value associated with this code. |
| 3 | `PRSNL_CODE_VALUE_R_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the prsnl_code_value_r table. |
| 4 | `PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Identifies the personnel related to the code value. |
