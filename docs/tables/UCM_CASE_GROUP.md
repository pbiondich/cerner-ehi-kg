...
> Contains case groups.

**Description:** Unified Case Manager - Case Group  
**Table type:** ACTIVITY  
**Primary key:** `UCM_CASE_GROUP_ID`  
**Columns:** 8  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CASE_GROUP_DESCRIPTION` | VARCHAR(100) | NOT NULL |  | The description of the case group which may be different than reference. |
| 2 | `CREATE_DT_TM` | DATETIME | NOT NULL |  | Date and Time when the case group was created. |
| 3 | `UCM_CASE_GROUP_ID` | DOUBLE | NOT NULL | PK | Uniquely identifies a case group. |
...
| From table | Column |
|------------|--------|
| [UCM_CASE_GROUP_PREQUAL](UCM_CASE_GROUP_PREQUAL.md) | `UCM_CASE_GROUP_ID` |
