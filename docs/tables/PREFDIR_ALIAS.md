...
> A reference attribute to create aliases. For instance, vital signs can use the all results flowsheet preferences entries since they are both possibly implemented by the same component.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ENTRY_ID` | DOUBLE | NOT NULL |  | Entry id that we are aliasing. |
