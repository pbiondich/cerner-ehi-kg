...
> Order catalog/inventory item relationship table,
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CATALOG_CD` | DOUBLE | NOT NULL |  | Catalog code |
| 2 | `ITEM_ID` | DOUBLE | NOT NULL | FK→ | ID value of the Item |
| 3 | `SYNONYM_ID` | DOUBLE | NOT NULL | FK→ | Order catalog synonym |
