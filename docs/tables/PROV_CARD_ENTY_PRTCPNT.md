# PROV_CARD_ENTY_PRTCPNT

> Stores Participant relationships to the concept entity

**Description:** PROV_CARD_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_CARD_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_CARD_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_CARD_ENTITY_ID` | [PROV_CARD_ENTITY](PROV_CARD_ENTITY.md) | `PROV_CARD_ENTITY_ID` |
