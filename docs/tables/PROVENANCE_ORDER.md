...
> Stores provenance information for the ORDERS concept

**Description:** Provenance for ORDERS  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_ORDER_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (ORDER_STAGING - ORDERS) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_ORDER_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_ORDER_ENTITY](PROV_ORDER_ENTITY.md) | `PROVENANCE_ORDER_ID` |
| [PROV_ORDER_PARTICIPANT](PROV_ORDER_PARTICIPANT.md) | `PROVENANCE_ORDER_ID` |
