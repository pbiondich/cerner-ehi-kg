...
> A Dimension Bridge table to allow the Fact table row to be associated to many Induction Method Dimensions
...
| 6 | `WHC_D_INDCTN_METHOD_BRIDGE_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 7 | `WHC_D_INDCTN_METHOD_GROUP_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to WHC_D_INDCTN_METHOD_GROUP.WHC_D_INDCTN_METHOD_GROUP_ID. |
| 8 | `WHC_D_INDUCTION_METHOD_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to WHC_D_INDUCTION_METHOD. WHC_D_INDUCTION_METHOD_ID . |
...
|--------|--------------|---------------|
| `WHC_D_INDCTN_METHOD_GROUP_ID` | [WHC_D_INDCTN_METHOD_GROUP](WHC_D_INDCTN_METHOD_GROUP.md) | `WHC_D_INDCTN_METHOD_GROUP_ID` |
| `WHC_D_INDUCTION_METHOD_ID` | [WHC_D_INDUCTION_METHOD](WHC_D_INDUCTION_METHOD.md) | `WHC_D_INDUCTION_METHOD_ID` |
