...
> This is the HealthFacts dimension table that contains standard values for medical specialty
...
| 4 | `MEDICAL_SPECIALTY_DESC` | VARCHAR(60) |  |  | The description for the medical specialty |
| 5 | `MEDICAL_SPECIALTY_ID` | DOUBLE |  |  | Primary key to the table. Uniquely defines a medical specialty |
