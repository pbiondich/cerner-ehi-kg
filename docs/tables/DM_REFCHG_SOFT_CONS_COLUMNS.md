...
> This table will store soft constraint column information for use within the RDDS dual build detection logic.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `COLUMN_NAME` | VARCHAR(30) | NOT NULL |  | Name of the Column for which the soft constraint applies |
| 2 | `DM_REFCHG_SOFT_CONSTRAINTS_ID` | DOUBLE | NOT NULL | FK→ | Foreign Key to parent table DM_REFCHG_SOFT_CONSTRAINTS |
| 3 | `DM_REFCHG_SOFT_CONS_COLUMNS_ID` | DOUBLE | NOT NULL |  | Primary Key for table |
...
|--------|--------------|---------------|
| `DM_REFCHG_SOFT_CONSTRAINTS_ID` | [DM_REFCHG_SOFT_CONSTRAINTS](DM_REFCHG_SOFT_CONSTRAINTS.md) | `DM_REFCHG_SOFT_CONSTRAINTS_ID` |
