...
> A Dimension Bridge table to allow the Fact table row to be associated to many Diagnosis Dimensions
...
| 6 | `WHC_D_DIAGNOSIS_BRIDGE_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 7 | `WHC_D_DIAGNOSIS_GROUP_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to WHC_D_DIAGNOSIS_GROUP.WHC_D_DIAGNOSIS_GROUP_ID. |
| 8 | `WHC_D_DIAGNOSIS_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to WHC_D_DIAGNOSIS.WHC_D_DIAGNOSIS_ID. |
...
|--------|--------------|---------------|
| `WHC_D_DIAGNOSIS_GROUP_ID` | [WHC_D_DIAGNOSIS_GROUP](WHC_D_DIAGNOSIS_GROUP.md) | `WHC_D_DIAGNOSIS_GROUP_ID` |
| `WHC_D_DIAGNOSIS_ID` | [WHC_D_DIAGNOSIS](WHC_D_DIAGNOSIS.md) | `WHC_D_DIAGNOSIS_ID` |
