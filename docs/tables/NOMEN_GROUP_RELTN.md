...
| 6 | `BT_COND_CRIT_R_ID` | DOUBLE | NOT NULL | FK→ | Bill Template Condition Criteria Relation |
...
| 8 | `NOMEN_GROUP_R_ID` | DOUBLE | NOT NULL |  | Nomenclature Group Relation ID |
| 9 | `NOMEN_ID` | DOUBLE | NOT NULL | FK→ | Nomenclature ID |
| 10 | `SOURCE_VOCAB_CD` | DOUBLE | NOT NULL |  | Source Vocabulary Code |
