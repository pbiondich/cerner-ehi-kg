...
**Description:** MLLD_DUPLICATION_CATEGORIES  
...
| 3 | `MULTUM_CATEGORY_ID` | DOUBLE | NOT NULL |  | The therapeutic duplication category to a specific drug. |
