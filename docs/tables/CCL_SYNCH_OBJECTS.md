...
> Stores CCL dictionary objects for use in merging objects during upgrades and RDDS processing
...
| 2 | `CCL_SYNCH_OBJECTS_ID` | DOUBLE | NOT NULL |  | Primary Key - Unique row identifier |
...
| 9 | `ENDIAN_PLATFORM` | DOUBLE | NOT NULL |  | Indicates the endian type of the source export platform |
