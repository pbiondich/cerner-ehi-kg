...
> Corspespondence Keyword Relation
...
| 5 | `ACTIVITY_ID` | DOUBLE | NOT NULL | FK→ | The foreign key to the correspondence that this keyword is related to. |
...
| 7 | `CORSP_KEYWORD_ID` | DOUBLE | NOT NULL |  | This is the unique identifier |
...
| 9 | `KEYWORD_TXT` | VARCHAR(50) |  |  | A text field to store additional keywords that may not common enough to include in the code set. |
