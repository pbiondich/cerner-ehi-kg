...
> Associates interqual account information by organization.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ORGANIZATION_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies to which this InterQual accounts related. |
| 2 | `RCM_INTERQUAL_ACCOUNT_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the InterQual Account for which the Organization is related. |
| 3 | `RCM_INTERQUAL_ACCT_ORG_R_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a relationship between an InterQual Account and an Organization. |
...
| `RCM_INTERQUAL_ACCOUNT_ID` | [RCM_INTERQUAL_ACCOUNT](RCM_INTERQUAL_ACCOUNT.md) | `RCM_INTERQUAL_ACCOUNT_ID` |
