...
> Table containing event information for meaningful use NQF stage 2 2021
...
| 2 | `ASSOCIATED_ENTITY_ID` | DOUBLE | NOT NULL |  | The ID of the associated event from the table listed in associated_entity_name. |
...
| 5 | `BR_DATAM_VSET_ITEM_ID` | DOUBLE | NOT NULL |  | References the id in BR_DATAM_VSET_ITEM. |
| 6 | `BR_DATAM_VSET_ITEM_NEG_ID` | DOUBLE | NOT NULL |  | References the negation in BR_DATAM_VSET_ITEM. |
...
| 11 | `D_QUERY_ID` | DOUBLE | NOT NULL | FK→ | Identifies the query associated with the quality measure. Foreign key to the LH_D_QUERY table. |
| 12 | `ENCNTR_ID` | DOUBLE | NOT NULL |  | Identifies the encounter against which the quality measure is associated. |
...
| 22 | `LAST_UPDATED_PROVIDER_ID` | DOUBLE | NOT NULL |  | This gives the ID of the provider whoever has updated the row last |
| 23 | `LH_AMB_EVENT_DATA_2021_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_AMB_EVENT_DATA_2021 table. |
...
| 28 | `PERSON_ID` | DOUBLE | NOT NULL |  | Identifies the person associated with the quality measure. |
...
| 35 | `PROB_LIFE_CYCLE_STATUS_CD` | DOUBLE | NOT NULL |  | The current status of the problem. (From Problem Table) |
