...
> Deposit Record Batch Transaction Relation
...
| 5 | `BATCH_TRANS_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to the batch_trans table |
...
| 7 | `DEPOSIT_RECORD_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to the deposit_record table. |
| 8 | `DEP_REC_BATCH_TRANS_RELTN_ID` | DOUBLE | NOT NULL |  | Primary key |
...
| `DEPOSIT_RECORD_ID` | [DEPOSIT_RECORD](DEPOSIT_RECORD.md) | `DEPOSIT_RECORD_ID` |
