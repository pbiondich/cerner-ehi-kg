...
| 9 | `CHILD_ID` | DOUBLE | NOT NULL |  | The unique identifier for the child within the group. |
| 10 | `CHILD_MEANING` | VARCHAR(12) |  |  | The 12-character description corresponding the CHILD_ID. |
| 11 | `CHILD_TABLE` | VARCHAR(32) | NOT NULL |  | The parent table corresponding to the CHILD_ID. |
...
| 14 | `PARENT_ID` | DOUBLE | NOT NULL |  | The unique identifier of the parent object. |
| 15 | `PARENT_MEANING` | VARCHAR(12) |  |  | A 12-character description corresponding to the PARENT_ID |
