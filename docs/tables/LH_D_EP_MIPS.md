...
| 13 | `LH_D_EP_MIPS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the LH_D_EP_MIPS table. |
| 14 | `LOC_NURSE_UNIT_CD` | DOUBLE | NOT NULL |  | CODE SET:220 This field identifies the current permanent location of the patient. The location for an inpatient will be valued with the lowest level location type in the hierarchy of facility, building, nurse unit, room, bed. |
