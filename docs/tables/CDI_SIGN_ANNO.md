...
> This table contains information about signature annotations on CPDI images.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ANNO_VALID_IND` | DOUBLE | NOT NULL |  | Indicates if the annotation is currently valid. Will be zero if the annotation has been removed. |
| 2 | `CDI_SIGN_ANNO_ID` | DOUBLE | NOT NULL |  | The unique ID of the signature annotation. |
| 3 | `EVENT_PRSNL_ID` | DOUBLE | NOT NULL |  | The ID of the signature row on the CE_EVENT_PRSNL table. |
| 4 | `PAGE_NBR` | DOUBLE | NOT NULL |  | The page number where the annotation is located within the document. |
