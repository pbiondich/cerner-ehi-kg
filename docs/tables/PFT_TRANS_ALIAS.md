...
> Defines aliases that correspond to a transation type, subtype and reason.

**Description:** ProFit Transaction Alias  
**Table type:** REFERENCE  
**Primary key:** `PFT_TRANS_ALIAS_ID`  
**Columns:** 20  
...
| 6 | `DR_CR_FLAG` | DOUBLE |  |  | Flag identifying whether the balance is debit or credit. |
| 7 | `EDI_IND` | DOUBLE |  |  | Indicates if this trans alias should be used only for edi transactions |
...
| 10 | `PFT_TRANS_ALIAS` | VARCHAR(20) |  |  | Contains the transaction alias text. |
| 11 | `PFT_TRANS_ALIAS_CD` | DOUBLE | NOT NULL |  | transaction alias code |
| 12 | `PFT_TRANS_ALIAS_ID` | DOUBLE | NOT NULL | PK | Uniquely identifies a transaction alias. |
| 13 | `TRANS_REASON_CD` | DOUBLE | NOT NULL |  | Code value identifying the transaction reason. |
| 14 | `TRANS_SUB_TYPE_CD` | DOUBLE | NOT NULL |  | Further identifies the type and purpose of the transaction (for example, Bad Debt Adjustment) |
| 15 | `TRANS_TYPE_CD` | DOUBLE | NOT NULL |  | Transaction type code value |
...
| From table | Column |
|------------|--------|
| [BATCH_TRANS_FILE](BATCH_TRANS_FILE.md) | `TRANS_ALIAS_ID` |
| [PFT_AP_REFUND](PFT_AP_REFUND.md) | `TRANS_ALIAS_ID` |
| [PFT_CM_EVENT_LOG](PFT_CM_EVENT_LOG.md) | `TRANS_ALIAS_ID` |
| [TRANS_LOG](TRANS_LOG.md) | `TRANS_ALIAS_ID` |
