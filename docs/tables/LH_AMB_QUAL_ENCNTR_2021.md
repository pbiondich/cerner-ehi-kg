...
> Table containing the qualifying encounters for Meaningful Use NQF Stage 2 2021

**Description:** LH_AMB_QUAL_ENCNTR_2021  
**Table type:** ACTIVITY  
**Primary key:** `HEALTH_SYSTEM_SOURCE_ID`, `LH_AMB_QUAL_ENCNTR_2021_ID`  
**Columns:** 62  
...
| 20 | `LH_AMB_QUAL_ENCNTR_2021_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the LH_AMB_QUAL_ENCNTR_2021 table. |
...
| From table | Column |
|------------|--------|
| [LH_AMB_EP_RELTN_2021](LH_AMB_EP_RELTN_2021.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| [LH_AMB_EP_RELTN_2021](LH_AMB_EP_RELTN_2021.md) | `LH_AMB_QUAL_ENCNTR_2021_ID` |
