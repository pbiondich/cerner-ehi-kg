...
> This table holds the mapping objects available for use by the SI Batch piece.
...
| 3 | `MAP_ID` | DOUBLE | NOT NULL | PK | This uniquely identifies each mapping object.Column |
| 4 | `OBJECT_NAME` | VARCHAR(255) | NOT NULL |  | The name of the mapping object.Column |
| 5 | `OBJECT_TYPE_FLAG` | DOUBLE | NOT NULL |  | Identifies the type of mapping object.Column |
...
| From table | Column |
|------------|--------|
| [SI_COMSRV_MSG_MAP_R](SI_COMSRV_MSG_MAP_R.md) | `MAP_ID` |
