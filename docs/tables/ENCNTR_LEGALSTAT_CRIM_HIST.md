...
> This table will hold the history of the relationship between legal statuses and criminal codes.
...
| 3 | `LEGAL_STATUS_CRIMINAL_R_ID` | DOUBLE | NOT NULL |  | The unique identifier for the encntr_legal_stat_crim_r table. |
| 4 | `LEGAL_STAT_CRIM_HIST_ID` | DOUBLE | NOT NULL |  | The unique identifier for the encntr_legalstat_crim_hist table. |
| 5 | `OCCURRENCES_NBR` | DOUBLE |  |  | The number of occurrences of the offense. |
| 6 | `OFFENSE_DT_TM` | DATETIME |  |  | The date and time of the offense. |
