...
> This table stores the relationships between Report Static Regions (Page Masters) and organizations for a given date range.
...
| 3 | `CR_STATIC_REGION_ORG_RELTN_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 5 | `ORGANIZATION_ID` | DOUBLE | NOT NULL | FK→ | The id of the organization with which this row is associated. |
| 6 | `STATIC_REGION_ID` | DOUBLE | NOT NULL | FK→ | The id of the static region with which this row is associated.FK from CR_REPORT_STATIC_REGION |
