...
> This table Stores locations associated with an HCO Number.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `BR_HCO_ID` | DOUBLE | NOT NULL |  | The HCO related to this location |
...
| 8 | `LOCATION_CD` | DOUBLE | NOT NULL |  | The location associated with this Healthcare Organization. |
...
| 14 | `UPDT_USER` | VARCHAR(40) |  |  | The user that performs the insert or update to the record |
