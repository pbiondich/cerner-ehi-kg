...
| 9 | `OBJECT_SUB_CD` | DOUBLE | NOT NULL | FK→ | A coded identifier for the generic scheduling object sub type. |
| 10 | `OBJECT_SUB_MEANING` | VARCHAR(12) |  |  | A 12-char description corresponding to the generic scheduling object sub type code. |
| 11 | `OBJECT_TYPE_CD` | DOUBLE | NOT NULL | FK→ | A coded identifier for the generic scheduling object type. |
| 12 | `OBJECT_TYPE_MEANING` | VARCHAR(12) |  |  | A 12-char description corresponding to the generic scheduling object type. |
| 13 | `OE_FORMAT_ID` | DOUBLE | NOT NULL |  | The identifier of the accept format. |
