...
> The operations scheduled control group table stores information about a control group that has been initialized for a particular operations date.

**Description:** Operations Scheduled Control Group  
**Table type:** ACTIVITY  
**Primary key:** `OPS2_SCHED_CTRL_GROUP_ID`  
**Columns:** 15  
...
| 5 | `INITIALIZE_DT_TM` | DATETIME | NOT NULL |  | The date and time this scheduled control group was initialized. |
| 6 | `OPS2_CTRL_GROUP_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to OPS2_CTRL_GROUP. Indicates to which control group this scheduled control group represents. |
| 7 | `OPS2_SCHED_CTRL_GROUP_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the OPS2_SCHED_CTRL_GROUP table. |
| 8 | `ORIG_OPS2_SCHED_CTRL_GROUP_ID` | DOUBLE | NOT NULL | FK→ | This field is used to track versions of the scheduled control group. This field will always point back to the initial value created. This may be used to find the correct version when combined with begin and end effective dates and times. |
| 9 | `SCHEDULE_DATE_DT_TM` | DATETIME | NOT NULL |  | The scheduled day this scheduled control group processes. |
| 10 | `STATUS_CD` | DOUBLE | NOT NULL |  | State of the scheduled control group. |
...
| `ORIG_OPS2_SCHED_CTRL_GROUP_ID` | [OPS2_SCHED_CTRL_GROUP](OPS2_SCHED_CTRL_GROUP.md) | `OPS2_SCHED_CTRL_GROUP_ID` |

## Referenced by (3)

| From table | Column |
|------------|--------|
| [OPS2_SCHED_CTRL_GROUP](OPS2_SCHED_CTRL_GROUP.md) | `ORIG_OPS2_SCHED_CTRL_GROUP_ID` |
| [OPS2_SCHED_JOB](OPS2_SCHED_JOB.md) | `OPS2_SCHED_CTRL_GROUP_ID` |
| [OPS2_SCHED_JOB_GROUP](OPS2_SCHED_JOB_GROUP.md) | `OPS2_SCHED_CTRL_GROUP_ID` |
