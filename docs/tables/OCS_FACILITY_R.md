...
> Used to define which synonyms are available for which facility
...
| 2 | `SYNONYM_ID` | DOUBLE | NOT NULL | FK→ | Identifies the synonym. Foreign Key from ORDER_CATALOG_SYNONYM table. |
