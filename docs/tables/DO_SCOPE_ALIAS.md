...
> Defines an alias for the scope.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DO_SCOPE_ALIAS` | VARCHAR(1000) | NOT NULL |  | An alias name for the Scope identified by the DO_SCOPE_ID. This name is used as input to mapping requests. |
| 2 | `DO_SCOPE_ALIAS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the DO_SCOPE_ALIAS table. |
| 3 | `DO_SCOPE_ID` | DOUBLE | NOT NULL | FK→ | References the identifier in the DO_SCOPE table. |
