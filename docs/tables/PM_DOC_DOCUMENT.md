...
> Stores name, description, ccl object name of PM Documents
...
| 6 | `DOCUMENT_DESC` | CHAR(100) |  |  | Free-text description of the document |
| 7 | `DOCUMENT_ID` | DOUBLE | NOT NULL | PK | Primary key |
| 8 | `DOCUMENT_NAME` | CHAR(32) | NOT NULL |  | The Name of the document. |
...
| 10 | `PROGRAM_NAME` | CHAR(32) | NOT NULL |  | CCL object name to be executed for the PM Document |
...
| From table | Column |
|------------|--------|
| [PM_DOC_DESTINATION](PM_DOC_DESTINATION.md) | `DOCUMENT_ID` |
| [PM_DOC_PRINT_HIST](PM_DOC_PRINT_HIST.md) | `PRINTED_DOCUMENT_ID` |
