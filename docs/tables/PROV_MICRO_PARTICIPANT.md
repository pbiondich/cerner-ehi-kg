# PROV_MICRO_PARTICIPANT

> Stores Participant information associated to the provenance MICROBIOLOGY concept

**Description:** PROV_MICRO_PARTICIPANT  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_MICROBIOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_MICROBIOLOGY table. |
| 9 | `PROV_MICRO_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
