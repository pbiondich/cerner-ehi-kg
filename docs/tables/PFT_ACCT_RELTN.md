...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCT_ID` | DOUBLE | NOT NULL |  | FK to the account table |
...
| 7 | `CREATED_DT_TM` | DATETIME | NOT NULL |  | Date and time the record was created. |
| 8 | `CREATED_PRSNL_ID` | DOUBLE | NOT NULL | FK→ | FK to the person table |
...
| 10 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | FK to the account, pft_encntr or bill_rec tables |
| 11 | `PARENT_ENTITY_NAME` | CHAR(32) | NOT NULL |  | Name of the parent entity name |
| 12 | `PFT_ACCT_RELTN_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 13 | `ROLE_TYPE_CD` | DOUBLE | NOT NULL |  | Role Type Code |
