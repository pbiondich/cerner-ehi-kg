...
> Stores information about entities associated to the provenance document concept

**Description:** Provenance Document Entity  
**Table type:** ACTIVITY  
**Primary key:** `PROV_DOC_ENTITY_ID`  
**Columns:** 12  
...
| 6 | `PROVENANCE_DOCUMENT_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_Document table. |
| 7 | `PROV_DOC_ENTITY_ID` | DOUBLE | NOT NULL | PK | Primary Key |
...
| From table | Column |
|------------|--------|
| [PROV_DOC_ENTY_PRTCPNT](PROV_DOC_ENTY_PRTCPNT.md) | `PROV_DOC_ENTITY_ID` |
