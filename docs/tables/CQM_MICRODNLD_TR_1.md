...
> Trigger table for Micro interface orders.
...
| 5 | `LAST_RETRY_DT_TM` | DATETIME |  |  | not usedColumn |
...
| 7 | `L_R_PROCESS_STATUS_FLAG` | DOUBLE |  |  | not usedColumn |
...
| 12 | `PROCESS_STATUS_FLAG` | DOUBLE |  |  | The current processing state for this trigger exploded transaction row. |
...
| 14 | `QUEUE_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the CQM queue table. It is an internal system assigned number. |
