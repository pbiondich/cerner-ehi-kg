...
> Stores the protocol information assigned to an individual order.

**Description:** RadNet Protocol Activity  
**Table type:** ACTIVITY  
**Primary key:** `RAD_PROTOCOL_ACT_ID`  
**Columns:** 13  
...
| 8 | `RAD_PROTOCOL_ACT_ID` | DOUBLE | NOT NULL | PK | Unique, generated number that identifies a single row on the RAD_PROTOCOL_ACT table. |
...
| From table | Column |
|------------|--------|
| [RAD_PROTOCOL_ACT_HIST](RAD_PROTOCOL_ACT_HIST.md) | `RAD_PROTOCOL_ACT_ID` |
