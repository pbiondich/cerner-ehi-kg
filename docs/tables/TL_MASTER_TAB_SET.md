...
> Holds the define d/t and user for the application default info. for the tasklist

**Description:** TL MASTER TAB SET  
**Table type:** REFERENCE  
**Primary key:** `MASTER_TAB_ID`  
**Columns:** 8  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DEFINE_DT_TM` | DATETIME |  |  | The date and time that the application default information was originally defined. |
| 2 | `DEFINE_ID` | DOUBLE | NOT NULL |  | The id of the person who originally defined the application default information.Column |
| 3 | `MASTER_TAB_ID` | DOUBLE | NOT NULL | PK | A unique number that identifies the application default definition.Value will be either 111111 or 0 depending on option selected in tool. |
...
| From table | Column |
|------------|--------|
| [TL_MASTER_TAB_SET_XREF](TL_MASTER_TAB_SET_XREF.md) | `MASTER_TAB_ID` |
