...
| 22 | `WARN_LEVEL_CD` | DOUBLE | NOT NULL | FK→ | The coded identifier for the scheduling warning severity level. |
| 23 | `WARN_LEVEL_MEANING` | VARCHAR(12) |  |  | The 12-character description corresponding to the scheduling warning severity level. |
