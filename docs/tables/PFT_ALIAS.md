...
| 5 | `ALIAS` | VARCHAR(255) | NOT NULL |  | Alias value |
...
| 7 | `CODE_VALUE` | DOUBLE |  |  | The code value associated with this code. |
...
| 9 | `PARENT_ENTITY_ID` | DOUBLE | NOT NULL |  | Part of compound Primary key |
| 10 | `PARENT_ENTITY_NAME` | VARCHAR(32) | NOT NULL |  | Part of compound Primary key |
