...
> This table contains information about actions that are used to build conversations.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTION` | DOUBLE | NOT NULL |  | Cerner-defined action constant |
...
| 7 | `DATA_SOURCE_ID` | DOUBLE | NOT NULL |  | ID of data source from parent data source |
| 8 | `DESCRIPTION` | VARCHAR(255) |  |  | A text description of the action. |
...
| 10 | `INFO_LONG_TEXT_ID` | DOUBLE |  |  | Key to long text table where information is stored. |
