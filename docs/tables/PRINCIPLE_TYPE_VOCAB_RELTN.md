...
> This table defines the relationship between source_vocab_type & principle_vocab_type
...
| 7 | `PRINCIPLE_TYPE_CD` | DOUBLE | NOT NULL |  | The principle type cd from priciple type code set |
| 8 | `PRINCIPLE_TYPE_FLAG` | DOUBLE | NOT NULL |  | Principle Type Flag |
| 9 | `PRINCIPLE_TYPE_VOCAB_RELTN_ID` | DOUBLE | NOT NULL |  | The primary key of this table |
| 10 | `SOURCE_VOCAB_CD` | DOUBLE | NOT NULL |  | The source vocab cd from source vocab code set |
