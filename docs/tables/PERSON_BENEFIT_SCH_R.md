...
> This table allows the user to capture a range of entries specific for each person benefit sets captured per Health Plan.
...
| 10 | `MEMBER_RESP_TYPE_CD` | DOUBLE | NOT NULL |  | The responsibility type associated with the set. |
| 11 | `PERSON_BENEFIT_R_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the person benefit relation table. It is an internal system assigned number. |
| 12 | `PERSON_BENEFIT_SCH_R_ID` | DOUBLE | NOT NULL |  | Primary Key |
...
|--------|--------------|---------------|
| `PERSON_BENEFIT_R_ID` | [PERSON_BENEFIT_R](PERSON_BENEFIT_R.md) | `PERSON_BENEFIT_R_ID` |
