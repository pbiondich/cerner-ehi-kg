...
> Scheduling Appointment Routing
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACTION_MEANING` | VARCHAR(12) |  |  | A 12-char description corresponding to the Scheduling ActionCode. |
...
| 8 | `BEG_UNITS` | DOUBLE | NOT NULL |  | Gegin Units |
| 9 | `BEG_UNITS_CD` | DOUBLE | NOT NULL | FK→ | Begin Units Code |
| 10 | `BEG_UNITS_MEANING` | VARCHAR(12) |  |  | Begin Units Meaning |
...
| 13 | `END_UNITS` | DOUBLE | NOT NULL |  | End Units |
| 14 | `END_UNITS_CD` | DOUBLE | NOT NULL | FK→ | End Units Code |
| 15 | `END_UNITS_MEANING` | VARCHAR(12) |  |  | End Units Meaning |
| 16 | `LOCATION_CD` | DOUBLE | NOT NULL | FK→ | The field identifies the current permanent location of the patient. |
| 17 | `NULL_DT_TM` | DATETIME | NOT NULL |  | contains 31-DEC-2100 00:00:00.00 |
| 18 | `ROUTING_ID` | DOUBLE | NOT NULL |  | Scheduling Routing Identifier |
| 19 | `ROUTING_MEANING` | VARCHAR(12) |  |  | Scheduling Routing Meaning |
| 20 | `ROUTING_TABLE` | VARCHAR(32) | NOT NULL |  | Scheduling Routing Table |
| 21 | `SCH_ACTION_CD` | DOUBLE | NOT NULL | FK→ | A unique identifier for the Scheduling Action Code |
| 22 | `SCH_FLEX_ID` | DOUBLE | NOT NULL | FK→ | Scheduling Flexing Identifier |
