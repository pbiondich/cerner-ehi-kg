# PROV_GENLAB_ENTY_PRTCPNT

> Stores Participant relationships to the concept entity

**Description:** PROV_GENLAB_ENTY_PRTCPNT  
**Table type:** ACTIVITY  
...
| 8 | `PROV_GENLAB_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
| 9 | `PROV_GEN_LAB_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
...
|--------|--------------|---------------|
| `PROV_GEN_LAB_ENTITY_ID` | [PROV_GEN_LAB_ENTITY](PROV_GEN_LAB_ENTITY.md) | `PROV_GEN_LAB_ENTITY_ID` |
