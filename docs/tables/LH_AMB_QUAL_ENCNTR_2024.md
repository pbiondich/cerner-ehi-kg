...
> Table containing the qualifying encounters for Meaningful Use NQF Stage 2 2024.

**Description:** LH_AMB_QUAL_ENCNTR_2024  
**Table type:** ACTIVITY  
**Primary key:** `HEALTH_SYSTEM_SOURCE_ID`, `LH_AMB_QUAL_ENCNTR_2024_ID`  
**Columns:** 62  
...
| 20 | `LH_AMB_QUAL_ENCNTR_2024_ID` | DOUBLE | NOT NULL | PK | Unique generated number that identifies a single row on the LH_AMB_QUAL_ENCNTR_2024 table. |
...
| From table | Column |
|------------|--------|
| [LH_AMB_EP_RELTN_2024](LH_AMB_EP_RELTN_2024.md) | `HEALTH_SYSTEM_SOURCE_ID` |
| [LH_AMB_EP_RELTN_2024](LH_AMB_EP_RELTN_2024.md) | `LH_AMB_QUAL_ENCNTR_2024_ID` |
