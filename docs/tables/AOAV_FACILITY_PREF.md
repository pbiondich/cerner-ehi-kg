...
> Table contains the preferences for an AOAV facility
...
| 2 | `AOAV_FACILITY_PREF_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 5 | `LOC_FACILITY_CD` | DOUBLE | NOT NULL | FK→ | The code value of the facility location.Value from LOCATION table and Code Set 220 |
| 6 | `PREF_CD` | DOUBLE | NOT NULL |  | The code value of the Deterioration alerting preference. from code set 4644010 |
| 7 | `PREF_VALUE` | DOUBLE | NOT NULL |  | The numeric value of the Deterioration alerting preference. |
