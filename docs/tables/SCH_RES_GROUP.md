...
| 16 | `RES_GROUP_ID` | DOUBLE | NOT NULL | PK | The unique identifier for the resource group. |
...
| From table | Column |
|------------|--------|
| [SCH_DATE_APPLY](SCH_DATE_APPLY.md) | `RES_GROUP_ID` |
| [SCH_RES_LIST](SCH_RES_LIST.md) | `CHILD_RES_GROUP_ID` |
| [SCH_RES_LIST](SCH_RES_LIST.md) | `RES_GROUP_ID` |
| [SCH_RES_TYPE](SCH_RES_TYPE.md) | `RES_GROUP_ID` |
