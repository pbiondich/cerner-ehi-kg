...
> Holds the list of table columns that will not be extracted from during an EHI Export.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `COLUMN_NAME` | VARCHAR(30) | NOT NULL |  | Name of the column being excluded |
| 2 | `EHI_COL_EXCEPTION_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY - Unique generated number that identifies a single row |
| 3 | `TABLE_NAME` | VARCHAR(30) | NOT NULL |  | Name of the table being excluded |
