...
| 7 | `ITEM_DESC` | VARCHAR(100) |  |  | Free-text description for the work item |
| 8 | `ITEM_NAME` | VARCHAR(40) |  |  | Work item name that is displayed to the end user. |
...
| 14 | `WORK_ITEM_ID` | DOUBLE | NOT NULL |  | Primary key. |
