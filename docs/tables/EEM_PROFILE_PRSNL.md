...
| 3 | `MOH_LOCAL_USER` | VARCHAR(30) | NOT NULL |  | Local user identification |
| 4 | `MOH_USER` | VARCHAR(30) | NOT NULL |  | User identification |
| 5 | `PROFILE_ID` | DOUBLE | NOT NULL | FK→ | Profile Identifier |
| 6 | `PROFILE_PRSNL_ID` | DOUBLE | NOT NULL |  | Profile Personnel Identifier |
| 7 | `PRSNL_ID` | DOUBLE | NOT NULL | FK→ | Personnel Identifier |
