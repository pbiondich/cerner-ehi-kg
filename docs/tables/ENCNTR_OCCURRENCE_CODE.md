...
> Encounter occurrence code (UB92).

**Description:** ENCNTR OCCURRENCE CODE  
**Table type:** ACTIVITY  
**Primary key:** `OCCURRENCE_CODE_ID`  
**Columns:** 20  
...
| 12 | `OCCURRENCE_CD` | DOUBLE | NOT NULL |  | A UB92 occurrence code (Universal Billing). |
| 13 | `OCCURRENCE_CODE_ID` | DOUBLE | NOT NULL | PK | This is the value of the unique primary identifier of the encounter occurrence code table. It is an internal system assigned number. |
| 14 | `OCCURRENCE_DT_TM` | DATETIME |  |  | Date and time that the UB92 occurrence, indicated by the row, happened. |
| 15 | `SEQUENCE` | DOUBLE |  |  | **OBSOLETE** NOT USED AT THIS TIME. Placeholder for sequential order of the occurrence codes. **OBSOLETE** |
...
| From table | Column |
|------------|--------|
| [ENCNTR_OCCURRENCE_CODE_HIST](ENCNTR_OCCURRENCE_CODE_HIST.md) | `OCCURRENCE_CODE_ID` |
