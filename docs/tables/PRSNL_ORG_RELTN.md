...
> Relationship table tying prsnl to organizations
...
| 6 | `CONFID_LEVEL_CD` | DOUBLE | NOT NULL |  | Confidence level code identifies the level of security that the personnel has to the organization. (i.e. No-Access, Non-Clinical, etc.) |
...
| 8 | `ORGANIZATION_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the organization table. It is an internal system assigned number. |
...
| 10 | `PRSNL_ORG_RELTN_ID` | DOUBLE | NOT NULL |  | This is the value of the unique primary identifier of the prsnl_org_reltn table. It is an internal system assigned number. |
