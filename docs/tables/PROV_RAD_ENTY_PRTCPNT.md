...
| 8 | `PROV_RAD_ENTITY_ID` | DOUBLE | NOT NULL | FK→ | PK Value of the related row from the provenance CONCEPT entity table |
| 9 | `PROV_RAD_ENTY_PRTCPNT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
|--------|--------------|---------------|
| `PROV_RAD_ENTITY_ID` | [PROV_RAD_ENTITY](PROV_RAD_ENTITY.md) | `PROV_RAD_ENTITY_ID` |
