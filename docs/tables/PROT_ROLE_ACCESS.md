...
> Table stores the access rights each role has for various functionalities
...
| 4 | `FUNCTIONALITY_CD` | DOUBLE | NOT NULL |  | Indicates the functionality for which the access mask is being defined |
...
| 6 | `PROT_ROLE_ACCESS_ID` | DOUBLE | NOT NULL |  | Primary Key |
| 7 | `PROT_ROLE_CD` | DOUBLE | NOT NULL |  | The role for which access mask is being defined |
