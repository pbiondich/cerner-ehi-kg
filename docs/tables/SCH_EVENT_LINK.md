...
| 5 | `AUTO_GENERATED_IND` | DOUBLE | NOT NULL |  | auto generated indicator |
...
| 9 | `LINK_TYPE_CD` | DOUBLE | NOT NULL |  | link type code |
| 10 | `NULL_DT_TM` | DATETIME | NOT NULL |  | contains 31-DEC-2100 00:00:00.00 |
| 11 | `PARENT_EVENT_ID` | DOUBLE | NOT NULL |  | sch_event_id of the parent |
| 12 | `PARENT_TYPE_FLAG` | DOUBLE | NOT NULL |  | This will be used to determine which event is the parent appointment between all the linked appointments. |
| 13 | `SCH_EVENT_ID` | DOUBLE | NOT NULL | FK→ | The unique identifier for the requested/scheduled appointment. |
| 14 | `SCH_LINK_ID` | DOUBLE | NOT NULL |  | This will be used to find the linked appointments associated to a given group. |
...
| 20 | `VERSION_DT_TM` | DATETIME | NOT NULL |  | The version date and time marks the date the record became historical. |
