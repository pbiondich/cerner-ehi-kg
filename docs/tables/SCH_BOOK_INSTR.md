...
> Scheduling Booking Instruction

**Description:** Scheduling Booking Instructions  
**Table type:** REFERENCE  
**Primary key:** `BOOK_INSTR_ID`  
**Columns:** 21  
...
| 6 | `BOOK_INSTR_ID` | DOUBLE | NOT NULL | PK | The identifier for the scheduling insruction. |
...
| From table | Column |
|------------|--------|
| [SCH_INSTR_LIST](SCH_INSTR_LIST.md) | `BOOK_INSTR_ID` |
