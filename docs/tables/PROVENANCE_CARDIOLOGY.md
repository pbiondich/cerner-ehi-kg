# PROVENANCE_CARDIOLOGY

> Provenance for CARDIOLOGY

**Description:** PROVENANCE_CARDIOLOGY  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_CARDIOLOGY_ID`  
**Columns:** 14  
...
| 8 | `PROVENANCE_CARDIOLOGY_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_CARD_ENTITY](PROV_CARD_ENTITY.md) | `PROVENANCE_CARDIOLOGY_ID` |
| [PROV_CARD_PARTICIPANT](PROV_CARD_PARTICIPANT.md) | `PROVENANCE_CARDIOLOGY_ID` |
