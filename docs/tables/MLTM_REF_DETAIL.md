...
> This table contains the textual description of source information referenced by ref_id.
...
| 4 | `REF_ID` | DOUBLE | NOT NULL | PK | textual description of source information referenced by ref_id. |
...
| From table | Column |
|------------|--------|
| [MLTM_REF_DRUG](MLTM_REF_DRUG.md) | `REF_ID` |
