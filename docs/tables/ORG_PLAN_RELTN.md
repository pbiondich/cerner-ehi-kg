...
> The organization-health plan relationship table identifies the role of an organization related to ahealth plan. For example, an insurance company (organization) is the underwriter (relationship) forXYZ Medical Benefit Plan (health plan).

**Description:** Organization Health Plan Relationship  
**Table type:** REFERENCE  
**Primary key:** `ORG_PLAN_RELTN_ID`  
**Columns:** 23  
...
| 6 | `CONTRACT_CODE` | VARCHAR(100) |  |  | Insurance Plan Contract Code identifies a contract between a facility and an org_plan_relation. |
...
| 12 | `GROUP_NAME` | VARCHAR(200) |  |  | Name of the group to which this plan belongs. |
| 13 | `GROUP_NBR` | VARCHAR(100) |  |  | The group number associated with the group name to which this plan belongs. |
| 14 | `HEALTH_PLAN_ID` | DOUBLE | NOT NULL | FK→ | This is the value of the unique primary identifier of the health plan table. It is an internal system assigned number. |
...
| 16 | `ORG_PLAN_RELTN_CD` | DOUBLE | NOT NULL |  | Identifies how the organization is related to the health plan (I.e.,sponsor, underwriter, medical review organization, plan administrator, etc.) |
| 17 | `ORG_PLAN_RELTN_ID` | DOUBLE | NOT NULL | PK | This is the value of the unique primary identifier of the organization health plan relationship table. It is an internal system assigned number. |
| 18 | `POLICY_NBR` | VARCHAR(100) |  |  | Policy number associated with the plan. |
...
| From table | Column |
|------------|--------|
| [OMF_ENCNTR_ST](OMF_ENCNTR_ST.md) | `OTHER_ORG_PLAN_RELTN_ID` |
| [OMF_ENCNTR_ST](OMF_ENCNTR_ST.md) | `PRIM_ORG_PLAN_RELTN_ID` |
| [OMF_ENCNTR_ST](OMF_ENCNTR_ST.md) | `SEC_ORG_PLAN_RELTN_ID` |
