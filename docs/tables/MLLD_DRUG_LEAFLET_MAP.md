...
**Description:** MLLD_DRUG_LEAFLET_MAP  
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `DRUG_IDENTIFIER` | VARCHAR(6) | NOT NULL |  | Drug Identifier Multum's identification codes for generic drugs. |
