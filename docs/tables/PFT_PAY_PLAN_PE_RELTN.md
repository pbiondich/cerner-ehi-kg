...
> Profit payent plan profit encounter relation
...
| 6 | `CBOS_PE_RELTN_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to the cbos_pe_reltn for this pft_encntr. |
| 7 | `ENDING_ENCNTR_DT_TM` | DATETIME |  |  | The date/time that this encounter was removed from this payment plan |
| 8 | `ENDING_ENCNTR_STATUS_CD` | DOUBLE | NOT NULL |  | The status when the encounter was removed from this payment plan. Currently either FORMALNOPAY, PAIDINFULL, or MANUAL REMOV. |
...
| 10 | `ORIG_ENCOUNTER_BAL` | DOUBLE |  |  | The balance of the pft_encntr when it was placed in this playment plan. |
| 11 | `ORIG_ENCOUNTER_DT_TM` | DATETIME |  |  | The date/time that this encounter was placed in this payment plan. |
| 12 | `PFT_ENCNTR_ID` | DOUBLE | NOT NULL | FK→ | The corresponding pft_encntr_id for the Profit Encounter in this payment plan. |
| 13 | `PFT_PAYMENT_PLAN_ID` | DOUBLE | NOT NULL | FK→ | Foreign key to the pft_payment_plan for this pft_encntr |
| 14 | `PFT_PAY_PLAN_PE_RELTN_ID` | DOUBLE | NOT NULL |  | Unique key to this table |
