...
> Stores the relationship between charge orderables and Helix case types. The relationship between the two is many to many.
...
| 5 | `UCMR_CASE_CHARGE_ORDRBL_R_ID` | DOUBLE | NOT NULL |  | Uniquely identifies a relationship between a charge orderable and a helix case type. |
| 6 | `UCMR_CASE_TYPE_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the case type related to this relationship. |
| 7 | `UCMR_CHARGE_ORDERABLE_ID` | DOUBLE | NOT NULL | FK→ | Uniquely identifies the charge orderable associated to this relationship. |
...
| `UCMR_CHARGE_ORDERABLE_ID` | [UCMR_CHARGE_ORDERABLE](UCMR_CHARGE_ORDERABLE.md) | `UCMR_CHARGE_ORDERABLE_ID` |
