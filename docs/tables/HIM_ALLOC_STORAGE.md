...
| 6 | `ALLOCATION_DT_TM` | DATETIME |  |  | Allocation date/time for a particular document |
...
| 9 | `EVENT_ID` | DOUBLE | NOT NULL |  | Unique identifier for an event from the Clinical Event table |
| 10 | `HIM_ALLOC_STORAGE_ID` | DOUBLE | NOT NULL |  | Unique identifier for table |
| 11 | `ORDER_ID` | DOUBLE | NOT NULL |  | Unique identifier for an order from the orders table. |
| 12 | `PRSNL_ID` | DOUBLE | NOT NULL |  | Unique identifier to the PRSNL table |
