...
| 5 | `ENSURE_FLAG` | DOUBLE | NOT NULL |  | Ensure flag. |
| 6 | `OUTPUT_ID` | DOUBLE | NOT NULL |  | Output ID. |
| 7 | `PROFILE_ID` | DOUBLE | NOT NULL | FK→ | Profile ID. |
...
| 14 | `VIEW_FLAG` | DOUBLE | NOT NULL |  | View flag. |
