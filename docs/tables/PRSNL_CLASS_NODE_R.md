...
> Table used to create relationships between personal and electronic item catalog(s).
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `CLASS_NODE_ID` | DOUBLE | NOT NULL | FK→ | Key to the CLASS_NODE table indicating the item catalog |
