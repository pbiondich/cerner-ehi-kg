...
> This table stores the relationship between a Person and Ethnicity.
...
| 9 | `RC_D_ETHNICITY_BRIDGE_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the RC_D_ETHNICITY_BRIDGE table. |
| 10 | `RC_D_ETHNICITY_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the RC_D_ETHNICITY table. |
| 11 | `SHR_D_PERSON_ID` | DOUBLE | NOT NULL |  | Uniquely identifies person information related to this row. |
