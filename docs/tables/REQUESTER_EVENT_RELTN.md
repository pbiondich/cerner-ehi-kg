...
> Store the default events(i.e. documents) for a requester
...
| 7 | `EVENT_CD` | DOUBLE |  |  | Default documents the requester is requesting |
| 8 | `EVENT_CD_DISP` | VARCHAR(40) |  |  | This is the display value for the event code |
| 9 | `REQUESTER_EVENT_RELTN_ID` | DOUBLE | NOT NULL |  | Unique identifier for this table |
| 10 | `REQUESTER_ID` | DOUBLE |  |  | A unique requester identifier |
