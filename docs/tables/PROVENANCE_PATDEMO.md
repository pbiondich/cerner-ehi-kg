...
> Provenance for PATIENT DEMOGRAPHICS

**Description:** PROVENANCE PATIENT DEMOGRAPHICS  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_PATDEMO_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name ( PERSON ) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_PATDEMO_ID` | DOUBLE | NOT NULL | PK | PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_PATDEMO_ENTITY](PROV_PATDEMO_ENTITY.md) | `PROVENANCE_PATDEMO_ID` |
| [PROV_PATDEMO_PARTICIPANT](PROV_PATDEMO_PARTICIPANT.md) | `PROVENANCE_PATDEMO_ID` |
