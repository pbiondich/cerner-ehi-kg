...
> Stores a reference to a subset of changes on V500_EVENT_CODE.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `EVENT_CD` | DOUBLE | NOT NULL |  | It is the code that identifies the most basic unit of storage. |
...
| 9 | `V500_EVENT_CODE_MODS_ID` | DOUBLE | NOT NULL |  | Unique generated number that identifies a single row on the V500_EVENT_CODE_MODS table. |
