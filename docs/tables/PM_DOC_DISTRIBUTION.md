...
> Defines the distributions for PM Document routings
...
| 6 | `DISTRIBUTION_DESC` | CHAR(100) |  |  | Free-text description of the distribution |
| 7 | `DISTRIBUTION_ID` | DOUBLE | NOT NULL | PK | Primary key |
| 8 | `DISTRIBUTION_NAME` | CHAR(32) | NOT NULL |  | The name of the distribution |
...
| From table | Column |
|------------|--------|
| [PM_DOC_DESTINATION](PM_DOC_DESTINATION.md) | `DISTRIBUTION_ID` |
| [PM_DOC_DIST_FILTER](PM_DOC_DIST_FILTER.md) | `DISTRIBUTION_ID` |
