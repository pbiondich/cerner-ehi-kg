...
> Contains information about the relationship between the account type and the general ledger alias.
...
|--:|--------|------|:-----:|-------|------------|
| 1 | `ACCT_TYPE_CD` | DOUBLE | NOT NULL |  | Code value indicating the type of account. |
| 2 | `ACCT_TYPE_GL_ALIAS_RELTN_ID` | DOUBLE | NOT NULL |  | Primary Key |
...
| 9 | `GL_ALIAS_ID` | DOUBLE | NOT NULL | FK→ | FK to the gl_alias table |
