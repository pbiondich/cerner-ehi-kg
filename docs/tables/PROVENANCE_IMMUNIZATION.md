# PROVENANCE_IMMUNIZATION

> Stores provenance information for the immunizations concept

**Description:** Provenance for immunizations  
**Table type:** ACTIVITY  
**Primary key:** `PROVENANCE_IMMUNIZATION_ID`  
**Columns:** 14  
...
| 6 | `PARENT_ENTITY_NAME` | VARCHAR(30) | NOT NULL |  | Concept Table Name (CLINICAL_EVENT - IMMUNIZATION_EXT_DATA) |
| 7 | `PERSONA_TXT` | VARCHAR(40) | NOT NULL |  | Identifies the user's persona, e.g. PATIENT, PERSONNEL, SYSTEM. |
| 8 | `PROVENANCE_IMMUNIZATION_ID` | DOUBLE | NOT NULL | PK | THE PRIMARY KEY |
...
| From table | Column |
|------------|--------|
| [PROV_IMMUN_ENTITY](PROV_IMMUN_ENTITY.md) | `PROVENANCE_IMMUNIZATION_ID` |
| [PROV_IMMUN_PARTICIPANT](PROV_IMMUN_PARTICIPANT.md) | `PROVENANCE_IMMUNIZATION_ID` |
