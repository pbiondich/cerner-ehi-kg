...
| 3 | `AOAV_FACILITY_REF_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
...
| 6 | `HOSP_BEDS_CNT` | DOUBLE |  |  | Hospital beds count |
| 7 | `HOSP_TEACHING_IND` | DOUBLE | NOT NULL |  | Hospital teaching indicator |
| 8 | `LOC_FACILITY_CD` | DOUBLE | NOT NULL | FK→ | The location code of the facility |
