# PROV_CARD_PARTICIPANT

> Stores Participant information associated to the provenance CARDIOLOGY concept

**Description:** PROV_CARD_PARTICIPANT  
**Table type:** ACTIVITY  
...
| 8 | `PROVENANCE_CARDIOLOGY_ID` | DOUBLE | NOT NULL | FK→ | Pk for the Provenance_CARDIOLOGY table. |
| 9 | `PROV_CARD_PARTICIPANT_ID` | DOUBLE | NOT NULL |  | PRIMARY KEY |
